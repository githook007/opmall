...
use app\bootstrap\express\ExpressFactory;
use app\bootstrap\kdOrder\KdOrder;
use app\bootstrap\newsms\Sms;
...
trait Application
{
    ...
    protected function defineConstants()
    {
        ...
        define_once('APP_PLATFORM_APP', 'app');
