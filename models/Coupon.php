 ...
 * @property CouponMemberRelation[] $couponMember
 * @property $couponCat
...
class Coupon extends ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'type', 'total_count', 'sort', 'expire_type', 'expire_day', 'appoint_type',
                'is_member', 'is_delete', 'can_receive_count', 'use_obtain', 'mch_id'], 'integer'],
