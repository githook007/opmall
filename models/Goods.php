 ...
 * @property string $video_channel  视频号
...
class Goods extends ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['price', 'forehead_integral', 'payment_amount', 'give_balance'], 'number'],
            [['attr_groups', 'area_limit', 'param_content', 'show_goods_auth', 'buy_goods_auth',
                'send_type', 'video_channel'], 'string'],
    ...
    {
        return $this->hasOne(MchGoods::className(), ['goods_id' => 'id', 'is_delete' => 'is_delete']);
    }
    ...
    {
        return $this->hasOne(MallGoods::className(), ['goods_id' => 'id', 'is_delete' => 'is_delete']);
    }
