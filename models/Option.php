...
class Option extends ModelActiveRecord
{
    ...
    const NAME_PERMISSIONS_STATUS = 'permissions_status';// weiqing子账号权限状态
    const NAME_PERMISSIONS_LIST = 'permissions_list';// 子账号权限自定义
    ...
    const NAME_WX_MINI_PRIVACY = 'wxminiprograms_privacy'; // 小程序第三方隐私设置  @czs
    const MALL_ERP = 'mall_erp'; // 商城对接erp  @czs

    const NAME_WX_PLATFORM_WEB = 'admin_wx_platform_web';//超管平台第三方网站配置  @czs
