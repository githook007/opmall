 ...
 * @property OrderTradeManage $orderTradeManage
 */
class PaymentOrder extends ModelActiveRecord
{
    ...
    public function getOrderTradeManage()
    {
        return $this->hasOne(OrderTradeManage::className(), ['payment_order_union_id' => 'payment_order_union_id'])->andWhere(['is_delete' => 0]);
    }
}
