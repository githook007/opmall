 ...
 * @property int $attachment_group_id    -1 代表效果图的分组id，0代表全部
 * @property int $user_id
 * @property int $mall_id    0 代表超管admin页面上传和小程序和PC。 -1 代表超管素材效果图上传。 其它代表商城内部上传
 ...
 * @property AttachmentEffect $effect
 */
class Attachment extends ModelActiveRecord
{
    ...
    public function getEffect(){
        return $this->hasOne(AttachmentEffect::className(), ['pic_id' => 'id'])->andWhere(['is_delete' => 0]);
    }
}
