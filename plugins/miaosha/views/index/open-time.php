...
<div id="app" v-cloak>
    <el-card style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;" v-loading="loading" shadow="never">
        <div slot="header"><?= \Yii::t('plugins/miaosha', '开放时间');?></div>
        <div class="form-body">
        ...
        <el-button class="button-item" :loading="btnLoading" type="primary" @click="store" size="small"><?= \Yii::t('plugins/miaosha', '保存');?></el-button>
    </el-card>
</div>
<script>
    const options = [
