    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 0 0;">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'plugin/miaosha/mall/goods/index'})"><?= \Yii::t('plugins/miaosha', '秒杀活动');?></span></el-breadcrumb-item>
                <el-breadcrumb-item v-if="form.goods_id > 0"><?= \Yii::t('plugins/miaosha', '详情');?></el-breadcrumb-item>
                ...
                <el-card shadow="never" style="margin-bottom: 24px">
                    ...
                    <el-col v-if="is_add == 1" :span="24">
                        <el-form-item label="<?= \Yii::t('plugins/miaosha', '开放时间');?>">
                            ...
                            <template v-else>
                                <el-tag disable-transitions type="danger"><?= \Yii::t('plugins/miaosha', '请先设置秒杀开放时间');?></el-tag>
                            </template>
                        </el-form-item>
                    </el-col>
                    <!--                    <el-col :span="12">-->
        ...
        methods: {
            ...
            store() {
                ...
                if (!self.form.open_time.length) {
                    self.$message.error('<?= \Yii::t('plugins/miaosha', '请添加秒杀时间');?>')
                    return;
                }

                if (!self.form.open_date.length) {
                    self.$message.error('<?= \Yii::t('plugins/miaosha', '请添加秒杀日期');?>')
                    return;
                }
