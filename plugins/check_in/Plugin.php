...
class Plugin extends \app\plugins\Plugin
{
    ...
    {
        return \Yii::t('plugins/check_in', '签到插件');
    }
    ...
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/check_in', '签到设置'),
...
//            ],
            [
                'name' => \Yii::t('plugins/check_in', '自定义设置'),
                'route' => 'plugin/check_in/mall/index/customize',
                'icon' => 'el-icon-star-on',
            ],
            [
                'name' => \Yii::t('plugins/check_in', '签到记录'),
    ...
    public function getPickLink()
    {
        ...
        return [
            [
                'key' => 'check_in',
                'name' => \Yii::t('plugins/check_in', '签到'),
                'open_type' => 'navigate',
    ...
    {
        return [
            CommonInfo::TPL_NAME => CommonInfo::class,
        ];
    }
}
