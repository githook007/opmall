...
<section id="app" v-cloak>
    <el-card class="box-card" v-loading="listLoading" style="border:0" shadow="never"
        ...
        <div slot="header" class="clearfix">
            <span><?= \Yii::t('plugins/check_in', '自定义配置');?></span>
        </div>
        <div style="display: flex;justify-content: space-between">
            <div class="mobile-box">
                <div class="mobile-screen">
                    <div class="mobile-navbar"><?= \Yii::t('plugins/check_in', '签到');?></div>
                            ...
                            <div flex="dir:left box:last" style="padding-top: 30px;padding-left:10px">
                                <div flex="dir-left">
                                    <div :style="{'color': form.remind_font ? form.remind_font : '#FFFFFF'}"
                                         style="padding-right:10px"><?= \Yii::t('plugins/check_in', '签到提醒');?>
                                    </div>
                                    <app-image width="30px" height="15px" :src="defaultRemind"></app-image>
                                </div>
                                <div flex="dir:top">
                                    <div class="btn-right"><?= \Yii::t('plugins/check_in', '签到规则');?></div>
                                    <div class="btn-right"><?= \Yii::t('plugins/check_in', '回到首页');?></div>
                                </div>
                            </div>
                            <div :style="{'color': form.daily_font ? form.daily_font : '#FFFFFF'}"
                                ...
                                <div flex="dir:left main:center">
                                    <div style="margin-right:100px" flex="dir:top cross:center">
                                        <div>11</div>
                                        <div><?= \Yii::t('plugins/check_in', '连续签到天数');?></div>
                                    </div>
                                    <div flex="dir:top cross:center">
                                        <div>12</div>
                                        <div><?= \Yii::t('plugins/check_in', '累计签到天数');?></div>
                                    </div>
                                </div>
                            </div>
                            <div :style="{'color': form.daily_font ? form.daily_font : '#FFFFFF'}"
                                ...
                                <div><?= \Yii::t('plugins/check_in', '今日还未签到');?></div>
                                <div><?= \Yii::t('plugins/check_in', '已连续签到11天');?></div>
                            </div>
                        </div>
                        <div flex="dir:top" :style="{
                            ...
                            <div flex="dir:top"
                                ...
                                <div style="height:58px;margin:0 10px" flex="dir:left cross:center box:justify">
                                    ...
                                    <div style="margin-left: 15px" flex="dir:top">
                                        <div><?= \Yii::t('plugins/check_in', '连续签到6天');?></div>
                                        <div><?= \Yii::t('plugins/check_in', '赠送2.0余额红包');?></div>
                                    </div>
                                    <div class="btn-lq" :style="{
                                            background: form.not_btn_bg ? form.not_btn_bg : '#5997fc',
                                            color: form.not_prompt_font ? form.not_prompt_font : '#ffffff'
                                        }"><?= \Yii::t('plugins/check_in', '未领取');?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div flex="dir:top"
                                ...
                                <div style="height:60px;margin:0 10px;"
                                    ...
                                    <app-image height="30px" width="30px"
                                               :src="form.integral_icon ? form.integral_icon : defaultRed"></app-image>
                                    <div style="margin-left: 15px" flex="dir:top">
                                        <div><?= \Yii::t('plugins/check_in', '累计签到5天');?></div>
                                        <div><?= \Yii::t('plugins/check_in', '赠送20积分');?></div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="form-body">
                <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                    <el-row>
                        <el-col :span="10">
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '签到提醒字体颜色');?>" prop="remind_font">
                                <el-color-picker color-format="rgb" v-model="form.remind_font"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '今日签到字体颜色');?>" prop="daily_font">
                                <el-color-picker color-format="rgb" v-model="form.daily_font"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '已领取字体颜色');?>" prop="prompt_font">
                                <el-color-picker color-format="rgb" v-model="form.prompt_font"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '已领取按钮颜色');?>" prop="btn_bg">
                                <el-color-picker color-format="rgb" v-model="form.btn_bg"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '未领取字体颜色');?>" prop="not_prompt_font">
                                <el-color-picker color-format="rgb" v-model="form.not_prompt_font"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '未领取按钮颜色');?>" prop="not_btn_bg">
                                <el-color-picker color-format="rgb" v-model="form.not_btn_bg"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '分割线颜色');?>" prop="line_font">
                                <el-color-picker color-format="rgb" v-model="form.line_font"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '下半部颜色配置');?>" prop="end_style">
                                <el-select size="small" v-model="form.end_style" placeholder="<?= \Yii::t('plugins/check_in', '请选择');?>">
                                    <el-option label="<?= \Yii::t('plugins/check_in', '純色');?>" value="0"></el-option>
                                    <el-option label="<?= \Yii::t('plugins/check_in', '渐变');?>" value="1"></el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '下半部背景颜色');?>" prop="end_bg">
                                <el-color-picker color-format="rgb" v-model="form.end_bg"
                                                 show-alpha></el-color-picker>
                            </el-form-item>
                            <el-form-item v-if="form.end_style == 1" label="<?= \Yii::t('plugins/check_in', '下半部渐变颜色配置');?>" prop="end_gradient_bg">
                        ...
                        <el-col :span="14">
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '未签到图标');?>" prop="not_signed_icon">
                                <app-attachment :multiple="false" :max="1" @selected="notSignedPhoto">
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/check_in', '建议尺寸');?>: 260*260" placement="top">
                                        <el-button size="mini"><?= \Yii::t('plugins/check_in', '选择文件');?></el-button>
                                    </el-tooltip>
                                </app-attachment>
                                <app-image v-if="form.not_signed_icon" mode="aspectFill" width='80px' height='80px'
                                           :src="form.not_signed_icon"></app-image>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '已签到图标');?>" prop="signed_icon">
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '头部背景图');?>" prop="head_bg">
                                <app-attachment :multiple="false" :max="1" @selected="headBgPhoto">
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/check_in', '建议尺寸');?>:750*500" placement="top">
                                        <el-button size="mini"><?= \Yii::t('plugins/check_in', '选择文件');?></el-button>
                                    </el-tooltip>
                                </app-attachment>
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '红包图标');?>" prop="balance_icon">
                                <app-attachment :multiple="false" :max="1" @selected="balancePhoto">
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/check_in', '建议尺寸');?>:72*72" placement="top">
                                        <el-button size="mini"><?= \Yii::t('plugins/check_in', '选择文件');?></el-button>
                                    </el-tooltip>
                                </app-attachment>
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '积分图标');?>" prop="integral_icon">
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/check_in', '日历签到图标');?>" prop="calendar_icon">
                                <app-attachment :multiple="false" :max="1" @selected="calendarPhoto">
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/check_in', '建议尺寸');?>:64*64" placement="top">
                                        <el-button size="mini"><?= \Yii::t('plugins/check_in', '选择文件');?></el-button>
                                    </el-tooltip>
                                </app-attachment>
                ...
                <el-button class="button-item" type="primary" :loading="btnLoading" @click="onSubmit"><?= \Yii::t('plugins/check_in', '提交');?></el-button>
            </div>
        </div>
    </el-card>
</section>
