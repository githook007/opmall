    ...
    <el-card style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;"
        ...
        <el-form :model="form" label-width="150px" ref="form">
            <el-tabs v-model="activeName">
                <el-tab-pane label="<?= \Yii::t('plugins/flash-sale', '基本设置');?>" class="form-body" name="first">
                    <app-setting
                            v-model="form"
                            :is_coupon="true"
                            :is_payment="false"
                    ...
                    <div class="el-card" style="padding-right: 0;margin-bottom: 20px">
                        <div class="poster-form-title" style="margin-bottom: 24px;"><?= \Yii::t('plugins/flash-sale', '活动规则设置');?></div>
                        <div style="width: 50%">
                            <el-form-item label="<?= \Yii::t('plugins/flash-sale', '活动规则');?>">
