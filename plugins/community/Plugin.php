...
class Plugin extends \app\plugins\Plugin
{
    public function getMenus()
    {
        return [
            ...
            [
                'name' => \Yii::t('plugins/community', '团购订单'),
...
//            ],
    ...
    {
        return \Yii::t('plugins/community', '社区团购');
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            ...
            [
                'key' => 'community',
                'name' => \Yii::t('plugins/community', '招募令'),
                'open_type' => '',
            ...
            [
                'key' => 'community',
                'name' => \Yii::t('plugins/community', '团长端'),
                'open_type' => '',
    ...
    public function getStatisticsMenus($bool = true)
    {
        return [
            ...
            'name' => $bool ? $this->getDisplayName() : \Yii::t('plugins/community', '插件统计'),
    ...
    public function getOrderInfo($orderId, $order)
    {
        ...
        if ($order && $order->discount_price > 0) {
            $data['discount_list'][] = [
                'order_id' => $orderId,
                'label' => \Yii::t('plugins/community', '满减'),
    ...
    {
        return \Yii::t('plugins/community', '团长');
    }
    ...
    public function getOrderExportFields()
    {
        return [
            [
                'key' => 'group_name',
                'value' => \Yii::t('plugins/community', '团长姓名'),
            ],
            [
                'key' => 'group_profit',
                'value' => \Yii::t('plugins/community', '团长利润'),
            ],
            [
                'key' => 'group_mobile',
                'value' => \Yii::t('plugins/community', '团长手机号'),
            ],
        ];
    }
    ...
    {
        return [
            PickUpInfo::TPL_NAME => PickUpInfo::class,
        ];
    }
