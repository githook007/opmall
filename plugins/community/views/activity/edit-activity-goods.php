            ...
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <span style="color: #409EFF;cursor: pointer"
                        ...
                        <?= \Yii::t('plugins/community', '社区团购');?>
                    </span>
                </el-breadcrumb-item>
                <el-breadcrumb-item v-if="form.goods_id > 0"><?= \Yii::t('plugins/community', '详情');?></el-breadcrumb-item>
                <el-breadcrumb-item v-else><?= \Yii::t('plugins/community', '商品编辑');?></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <app-goods
           :is_show="0"
           ...
           price_label="<?= \Yii::t('plugins/community', '买家购买价');?>"
          ...
          <template slot-scope="item" slot="after_original_price">
              <!-- 买家购买价 -->
              <el-form-item label="<?= \Yii::t('plugins/community', '买家购买价');?>" prop="price" >
                  <el-input type="number"
                            placeholder="<?= \Yii::t('plugins/community', '请输入买家购买价');?>"
              ...
              <!-- 供货价 -->
              <el-form-item label="<?= \Yii::t('plugins/community', '团长供货价');?>" prop="supply_price" >
                  <el-input type="number"
                            placeholder="<?= \Yii::t('plugins/community', '请输入团长供货价');?>"
                            oninput="this.value = this.value.replace(/[^0-9\.]/, '');" :min="0"
              ...
              <el-form-item label="<?= \Yii::t('plugins/community', '虚拟已售');?>" prop="virtual_sales">
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                rule: {
                    price: [
                        {required: true, message: "<?= \Yii::t('plugins/community', '请输入买家购买价');?>", trigger: 'change'},
                    ],
                    supply_price: [
                        {required: true, message: "<?= \Yii::t('plugins/community', '请输入供货价');?>", trigger: 'change'},
                    ],
                },
                skip: '',
                position: '',
                form: {
                    extra: {
                        supply_price: "<?= \Yii::t('plugins/community', '团长供货价(元)');?>"
                    },
                    is_home: 1,
                },
            }
