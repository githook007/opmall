...
use app\plugins\advance\forms\common\LimitBuy;
...
class Plugin extends \app\plugins\Plugin
{
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/advance', '预售设置'),
...
//            [
            ...
            //            ],
            [
                'name' => \Yii::t('plugins/advance', '商品管理'),
            ...
            [
                'name' => \Yii::t('plugins/advance', '定金订单'),
                'route' => 'plugin/advance/mall/deposit-order/index',
                'icon' => 'el-icon-star-on',
                'action' => [
                    [
                        'name' => \Yii::t('plugins/advance', '订单详情'),
                        'route' => 'plugin/advance/mall/deposit-order/detail',
                    ],
                ],
            ],
            [
                'name' => \Yii::t('plugins/advance', '尾款订单'),
    ...
    {
        return \Yii::t('plugins/advance', '商品预售');
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            [
                'key' => 'advance',
                'name' => \Yii::t('plugins/advance', '我的预定'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-advance.png',
                'value' => '/plugins/advance/order/order',
            ],
            [
                'key' => 'advance',
                'name' => \Yii::t('plugins/advance', '预售首页'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-advance-home.png',
                'value' => '/plugins/advance/index/index',
            ],
            [
                'key' => 'advance',
                'name' => \Yii::t('plugins/advance', '预售商品详情'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-advance-goods.png',
                'value' => '/plugins/advance/detail/detail',
                'params' => [
                    [
                        'key' => 'id',
                        'value' => '',
                        'desc' => \Yii::t('plugins/advance', '请填写预售商品ID'),
                        'is_required' => true,
                        'data_type' => 'number',
                        'page_url' => 'plugin/advance/mall/goods/index',
                        'page_url_text' => \Yii::t('plugins/advance', '商品管理'),
                    ],
                ],
