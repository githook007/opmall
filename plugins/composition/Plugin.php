...
class Plugin extends AppPlugin
{
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/composition', '设置'),
                'route' => 'plugin/composition/mall/index/index',
                'icon' => 'el-icon-star-on',
            ],
            [
                'name' => \Yii::t('plugins/composition', '套餐组合'),
    ...
    {
        return \Yii::t('plugins/composition', '套餐组合');
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            ...
            [
                'key' => 'composition',
                'name' => \Yii::t('plugins/composition', '套餐详情'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-composition-detail.png',
                ...
                'params' => [
                    [
                        'key' => 'composition_id',
                        'value' => '',
                        'desc' => \Yii::t('plugins/composition', '请填写套餐组合ID'),
                        'is_required' => true,
                        'data_type' => 'number',
                        'page_url' => 'plugin/composition/mall/index/list',
                        'page_url_text' => \Yii::t('plugins/composition', '套餐组合')
                    ]
                ]
            ],
        ];
    ...
    public function getStatisticsMenus($bool = true)
    {
        return [
            ...
            'name' => $bool ? $this->getDisplayName() : \Yii::t('plugins/composition', '插件统计'),
            'key' => $this->getName(),
    ...
    public function getOrderInfo($orderId, $order)
    {
        ...
        if ($price > 0) {
            $data = [
                'discount_list' => [
                    'composition' => [
                        'label' => \Yii::t('plugins/composition', '套餐优惠'),
