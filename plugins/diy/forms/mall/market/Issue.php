...
class Issue extends Model
{
    ...
    public function init()
    {
        ...
        $this->urlPath = $hostInfo . $baseUrl . '/temp/' . $this->file . '/' . $filePath;
    }
    ...
    private function handler($list, $key = null)
    {
        if (is_array($list)) {
            ...
            return $key ? $this->handlerString($key, $list) : $list; // @czs
        }
    }
    ...
    {
        $ignore = [
            'goods', 'miaosha', 'pintuan', 'topic', 'integral-mall', 'booking', 'bargain', 'mch', 'advance',
            'composition', 'gift', 'coupon'
        ];
