...
class AuthPageEForm extends Model
{
    ...
    public function rules()
    {
        ...
        return [
            [['pic_url', 'is_open', 'hotspot', 'hotspot_cancel', 'hotspot_link'], 'trim'],
        ...
        try {
            ...
            $attributes = [
                'params' => \Yii::$app->serializer->encode([
                    ...
                    'hotspot_link' => $this->hotspot_link,
                ]),
                'type' => 'auth',
    ...
    public function search()
    {
        ...
        return [
            ...
            'data' => [
                ...
                'hotspot_link' => $model->params && isset($model->params->hotspot_link) ? $model->params->hotspot_link: '',
            ]
        ];
    }
}
