...
//            ],
            ...
            [
                'name' => \Yii::t('plugins/diy', '授权页面'),
                'route' => 'plugin/diy/mall/page/auth',
                'icon' => 'el-icon-star-on',
            ],
            [
                'name' => \Yii::t('plugins/diy', '表单提交信息'),
    ...
    {
        return \Yii::t('plugins/diy', 'DIY装修');
    }
