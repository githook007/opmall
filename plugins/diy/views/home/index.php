            ...
            <div style="display: flex;">
                <div class="mobile-box" v-loading="loading">
                    ...
                    <div class="show-box">
                        <div v-if="components.length == 0" style="text-align: center;margin-top: 70px">
                            ...
                            <div style="color: #999999;padding-top: 10px;font-size: 14px"><?= \Yii::t('plugins/diy', '暂未装修首页');?></div>
                        </div>
                                ...
                                <div v-for="(component, index) in components" :key="component.key">
                                    <?php foreach ($components as $component) : ?>
                                        <diy-<?= $component ?> v-if="component.id === '<?= $component ?>'"
                                                               ...
                                                               :style="component.id == 'modal' ? 'pointer-events: none !important;cursor: pointer;' : ''"
                ...
                <div class="form-body">
                    <div style="padding: 30px 50px">
                        <el-button type="primary" @click="navTemplate" plain size="small"><?= \Yii::t('plugins/diy', '装修首页');?></el-button>
                    </div>
                </div>
            </div>
        </el-form>
