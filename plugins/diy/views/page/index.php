...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <span><?= \Yii::t('plugins/diy', '页面管理');?></span>
            <el-button style="float: right; margin: -5px 0" type="primary" size="small"
                       @click="$navigate({r:'plugin/diy/mall/page/edit'})"><?= \Yii::t('plugins/diy', '新增页面');?>
            </el-button>
        </div>
        <div style="padding: 20px;background-color: #fff">
            <el-table v-loading="loading" border :data="list" style="margin-bottom: 15px;">
                <el-table-column prop="id" label="ID" width="100px"></el-table-column>
                <el-table-column prop="title" label="<?= \Yii::t('plugins/diy', '标题');?>"></el-table-column>
                <el-table-column prop="template" label="<?= \Yii::t('plugins/diy', '导航与模板');?>" width="750px">
                ...
                <el-table-column label="<?= \Yii::t('plugins/diy', '设为首页');?>" width="80px">
                    <template slot-scope="scope">
                ...
                <el-table-column label="<?= \Yii::t('plugins/diy', '禁用');?>" width="85px">
                    <template slot-scope="scope">
                ...
                <el-table-column label="<?= \Yii::t('plugins/diy', '操作');?>" width="180px">
                    <template slot-scope="scope">
    ...
    new Vue({
        ...
        methods: {
            ...
            deleteItem(item, index) {
                this.$confirm("<?= \Yii::t('plugins/diy', '确认删除');?>").then(() => {
                    item.loading = true;
                    item.is_delete = 1;
