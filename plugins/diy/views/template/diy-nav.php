...
<template id="diy-nav">
    <div class="diy-nav">
        <div class="diy-component-preview" :ref="ref">
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px">
                <el-form-item label="<?= \Yii::t('plugins/diy', '选择模块');?>">
                    <div flex="dir:left">
                        <div flex="dir:top cross:center main:center"
                            ...
                            <div :style="{color: `${data.modeType == 'img' ? '#409EFF':'#666666'}`}"><?= \Yii::t('plugins/diy', '图片导航');?></div>
                        </div>
                        <div flex="dir:top cross:center main:center"
                            ...
                            <div :style="{color: `${data.modeType == 'text' ? '#409EFF':'#666666'}`}"><?= \Yii::t('plugins/diy', '文字导航');?></div>
                        </div>
                    </div>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '滑动设置');?>">
                    <app-radio v-model="data.navType" label="fixed"><?= \Yii::t('plugins/diy', '固定');?></app-radio>
                    <app-radio v-model="data.navType" label="alone"><?= \Yii::t('plugins/diy', '单行滑动');?></app-radio>
                    <app-radio v-model="data.navType" label="multi"><?= \Yii::t('plugins/diy', '多行滑动');?></app-radio>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '每行个数');?>" v-if="data.navType === 'fixed' || data.navType === 'multi'">
                    <el-select v-model="data.columns" placeholder="<?= \Yii::t('plugins/diy', '请选择');?>">
                        <el-option label="<?= \Yii::t('plugins/diy', '三个导航');?>" :value="3"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '四个导航');?>" :value="4"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '五个导航');?>" :value="5"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '六个导航');?>" :value="6"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '一屏行数');?>" v-if="data.navType === 'multi'">
                    <el-select v-model="data.lineNum" placeholder="<?= \Yii::t('plugins/diy', '请选择');?>">
                        <el-option label="<?= \Yii::t('plugins/diy', '二行');?>" :value="2"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '三行');?>" :value="3"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '四行');?>" :value="4"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '分页器样式');?>" v-if="data.navType === 'multi'">
                    <div flex="dir:left">
                        <div flex="dir:top cross:center main:center"
                             style="cursor: pointer;border-radius:3px"
                            ...
                            <div :style="{color: `${data.swiperType == 'circle' ? '#409EFF':'#666666'}`}"><?= \Yii::t('plugins/diy', '圆点样式');?></div>
                        </div>
                        <div flex="dir:top cross:center main:center"
                             style="cursor: pointer;border-radius:3px;margin-left: 16px"
                            ...
                            <div :style="{color: `${data.swiperType == 'rectangle' ? '#409EFF':'#666666'}`}"><?= \Yii::t('plugins/diy', '条状样式');?>
                            </div>
                        </div>
                    </div>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '分页器主色');?>" v-if="data.navType === 'multi'">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '分页器辅色');?>" v-if="data.navType === 'multi'">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '一屏显示');?>" v-if="data.navType === 'alone'">
                    <el-select v-model="data.aloneNum" placeholder="<?= \Yii::t('plugins/diy', '请选择');?>">
                        <el-option label="<?= \Yii::t('plugins/diy', '三个导航');?>" :value="3"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '四个导航');?>" :value="4"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '五个导航');?>" :value="5"></el-option>
                        <el-option label="<?= \Yii::t('plugins/diy', '六个导航');?>" :value="6"></el-option>
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '颜色设置');?>">
                    <app-radio v-model="data.bgType" label="color"><?= \Yii::t('plugins/diy', '颜色');?></app-radio>
                    <app-radio v-model="data.bgType" label="pic"><?= \Yii::t('plugins/diy', '背景图');?></app-radio>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '背景颜色');?>" v-if="data.bgType === 'color'">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '背景图');?>" v-if="data.bgType === 'pic'" prop="backgroundPicUrl">
                    <app-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                                    @selected="selectBg">
                        <el-tooltip effect="dark"
                                    :content="refContent"
                                    placement="top">
                            <el-button size="mini"><?= \Yii::t('plugins/diy', '选择图标');?></el-button>
                        </el-tooltip>
                    </app-attachment>
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '获取商城导航');?>">
                    <diy-nav-select @change="navChange">
                        <el-button size="small"><?= \Yii::t('plugins/diy', '获取');?></el-button>
                    </diy-nav-select>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '导航图标');?>">
                        ...
                        <div v-for="(nav,index) in data.navs" class="edit-nav-item drag-drop"
                            ...
                            <div flex="dir:left box:first cross:center">
                                ...
                                <div style="flex-grow: 1;max-width: 100%">
                                    <el-input class="item-drag" v-model="nav.name" placeholder="<?= \Yii::t('plugins/diy', '请输入名称，最多输入5个字');?>"
                                              size="small"
                                    ...
                                    <div flex="dir:left cross:center" v-if="nav.url">
                                        ...
                                        <app-pick-link slot="append" @selected="linkSelected">
                                            <el-button @click="pickLinkClick(index)" style="margin-left: 9px;padding: 0"
                                                       type="text"><?= \Yii::t('plugins/diy', '修改');?>
                                            </el-button>
                                        </app-pick-link>
                                    </div>
                                    <div v-else @click="pickLinkClick(index)">
                                        <el-input v-model="nav.url" placeholder="<?= \Yii::t('plugins/diy', '点击选择链接');?>" readonly
                                                  size="small" disabled>
                                            <app-pick-link slot="append" @selected="linkSelected">
                    ...
                    <div style="color: #666666;font-size: 12px;"><?= \Yii::t('plugins/diy', '拖拽可改变顺序');?></div>
                </el-form-item>
            </el-form>
            <el-dialog title="<?= \Yii::t('plugins/diy', '导航链接');?>" :visible.sync="dialogTableVisible">
                <el-table v-loading="listLoading" :data="navList" ref="multipleTable"
                          @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55"></el-table-column>
                    <el-table-column property="name" label="<?= \Yii::t('plugins/diy', '导航名称');?>"></el-table-column>
                    <el-table-column label="<?= \Yii::t('plugins/diy', '导航链接');?>">
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button @click="dialogTableVisible = false"><?= \Yii::t('plugins/diy', '取消');?></el-button>
                    <el-button type="primary" @click="updateNav"><?= \Yii::t('plugins/diy', '确定');?></el-button>
                </div>
            </el-dialog>
        </div>
    </div>
    ...
    Vue.component('diy-nav', {
        ...
        data() {
            return {
                ...
                multiswiper: '80px',
                ref: Symbol(),
                refContent: "<?= \Yii::t('plugins/diy', '建议尺寸');?>:375 * x",
                defaultInfo: {
                    imageHeight: 88,
                    left: 32,
                    limit: 30,
        ...
        computed: {
            ...
            cContainerStyle() {
                let style = `overflow-x:${this.data.scroll ? 'auto' : 'hidden'};background-size:${this.data.backgroundWidth}% ${this.data.backgroundHeight}%;background-repeat:${this.repeat};background-position:${this.position};`;
                if (this.data.bgType === 'pic') {
                    style += `background-image:url(${this.data.backgroundPicUrl});`;
                } else {
            ...
            data: {
                ...
                handler(newVal, oldVal) {
                    ...
                    setTimeout(() => {
                        ...
                        let refHeight = this.$refs[this.ref];
                        if (height && height[0]) {
                            this.multiswiper = `${height[0].offsetHeight}px`;
                        }
                        this.$nextTick(()=>{ // 页面渲染完成后的回调
                            this.refContent = `<?= \Yii::t('plugins/diy', '建议尺寸');?>:750 * ${refHeight.offsetHeight}`;
                        })
                    })
                },
            },
        ...
        methods: {
            selectBg(e) {
                if (e.length) {
                    this.data.backgroundPicUrl = e[0].url;
                }
            },
            navChange(e) {
                if (!e || e.length === 0) {
            ...
            formatLabel(column) {
                let types = {
                    base: "<?= \Yii::t('plugins/diy', '基础');?>",
                    order: "<?= \Yii::t('plugins/diy', '订单');?>",
                    share: "<?= \Yii::t('plugins/diy', '营销');?>",
                    marketing: "<?= \Yii::t('plugins/diy', '营销');?>",
                    plugin: "<?= \Yii::t('plugins/diy', '插件');?>",
                    diy: "<?= \Yii::t('plugins/diy', '微页面');?>",
                };
                if (column.labelType === 'mall-add') {
                    ...
                    //todo 各个插件确少type字段
                    return "<?= \Yii::t('plugins/diy', '插件');?>" + ' > ' + column.labelName;
                }
            },
            updateData(e) {
                this.data = e;
