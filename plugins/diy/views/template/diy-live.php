                    ...
                    <div class="item" v-for="(item, index) in liveList">
                        <div class="live-img-box">
                            ...
                            <div class="label-box-item">
                                <div class="label-box">
                                    <div class="icon"></div>
                                    <div class="text"><?= \Yii::t('plugins/diy', '已结束');?></div>
                                </div>
                            </div>
                            <div class="user-info">
                                <div class="avatar"></div>
        ...
        <div class="diy-component-edit">
            <el-form v-loading="loading" @submit.native.prevent label-width="100px">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '卡片样式');?>">
                    <el-radio v-model="data.style_type" :label="1"><?= \Yii::t('plugins/diy', '样式1');?></el-radio>
                    <el-radio v-model="data.style_type" :label="2"><?= \Yii::t('plugins/diy', '样式2');?></el-radio>
                    <el-radio v-model="data.style_type" :label="3"><?= \Yii::t('plugins/diy', '样式3');?></el-radio>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '直播间数量');?>">
                    <div class="room-box">
                        <el-input size="small" type="number" v-model.number="data.number" placeholder="<?= \Yii::t('plugins/diy', '请输入直播间数量');?>"></el-input>
                        <span class="label"><?= \Yii::t('plugins/diy', '此组件最多支持20个直播间');?></span>
                    </div>
                </el-form-item>
    ...
    Vue.component('diy-live', {
        ...
        data() {
            return {
                ...
                liveList: [
                    {
                        title: "<?= \Yii::t('plugins/diy', '直播间名称');?>",
                        nickname: "<?= \Yii::t('plugins/diy', '主播昵称');?>",
                        text: "<?= \Yii::t('plugins/diy', '预告');?>",
                        text_time: "<?= \Yii::t('plugins/diy', '今晚19:00开播');?>",
                        goods_list: [
                            {
                                goods_name: "<?= \Yii::t('plugins/diy', '商品名称');?>",
                                goods_price: '￥469.00'
                            }, {
                                goods_name: "<?= \Yii::t('plugins/diy', '商品名称');?>",
                                goods_price: '￥469.00'
