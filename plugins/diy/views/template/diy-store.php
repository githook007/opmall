    ...
    <div class="diy-store">
            ...
            <div class="store-list">
                <div class="store-item" v-for="(item,index) in data.list" flex="box:last cross:center">
                    <div flex="box:first cross:center">
                        ...
                        <div style="line-height: 42px">
                            ...
                            <div v-if="data.showTel">
                                <span><?= \Yii::t('plugins/diy', '电话');?>: </span>
                    ...
                    <div style="text-align: center">
                        ...
                        <div><?= \Yii::t('plugins/diy', '一键导航');?></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '评分图标');?>">
                    <app-image-upload v-model="data.scorePicUrl" width="20" height="20"></app-image-upload>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示门店名称');?>">
                    <el-switch v-model="data.showName"></el-switch>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示评分');?>">
                    <el-switch v-model="data.showScore"></el-switch>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示电话');?>">
                    <el-switch v-model="data.showTel"></el-switch>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '门店列表');?>">
                    <div v-for="(item,index) in data.list" class="edit-item" style="max-width: 450px">
                        ...
                        <div flex>
                            <div style="width: 40px;"><?= \Yii::t('plugins/diy', '名称');?>:</div>
                            <div>{{item.name}}</div>
                        </div>
                        <div flex>
                            <div style="width: 40px;"><?= \Yii::t('plugins/diy', '电话');?>:</div>
                            <div>{{item.mobile}}</div>
                        </div>
                    </div>
                    <el-button size="small" @click="storeDialogVisible = true"><?= \Yii::t('plugins/diy', '添加门店');?></el-button>
                </el-form-item>
            </el-form>
        </div>
        <el-dialog title="<?= \Yii::t('plugins/diy', '选择门店');?>" :visible.sync="storeDialogVisible" @open="storeDialogOpen">
            <el-table :data="store.list" v-loading="store.loading" style="margin-bottom: 20px">
                ...
                <el-table-column prop="mobile" label="<?= \Yii::t('plugins/diy', '电话');?>"></el-table-column>
                <el-table-column label="<?= \Yii::t('plugins/diy', '操作');?>" width="100px">
                    <template slot-scope="scope">
                        <el-button @click="addStore(scope.row)" size="small"><?= \Yii::t('plugins/diy', '选择');?></el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div style="text-align: center">
