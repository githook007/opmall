    ...
    <div class="diy-vip-card">
        ...
        <div class="diy-component-edit">
            <el-form v-loading="loading" @submit.native.prevent label-width="100px">
                <el-form-item label="<?= \Yii::t('plugins/diy', '背景色');?>">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '上下间距');?>">
                    <el-input @change="chooseHeight" size="small" v-model="top_bottom_padding">
                        <template slot="append">px</template>
                    </el-input>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '使用插件配置');?>">
                    <el-switch v-model="usePluginConfig" @change="reset"></el-switch>
                </el-form-item>
                <template v-if="!usePluginConfig">
                    <el-form label-position="left">
                        <el-form-item class="diy-user-label" label="<?= \Yii::t('plugins/diy', '未购买用户');?>" prop="buy_user">
                            <el-form-item label="<?= \Yii::t('plugins/diy', '背景图');?>" prop="buy_bg">
                                <div style="position: relative">
                                    <app-attachment :multiple="false" :max="1" @selected="buyPicUrl">
                                        <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/diy', '建议尺寸');?>:702*120" placement="top">
                                            <el-button size="mini"><?= \Yii::t('plugins/diy', '选择文件');?></el-button>
                                        </el-tooltip>
                                    </app-attachment>
                                    ...
                                    <el-button size="mini" @click="resetImg(2,'buy')" class="diy-reset" type="primary"><?= \Yii::t('plugins/diy', '恢复默认');?></el-button>
                                </div>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/diy', '文字');?>" prop="buy_text">
                                <div flex="dir:left cross:center">
                                    <el-input maxlength="15" style="margin-left: 10px;width: 240px" size="small" v-model="data.buy_big" placeholder="<?= \Yii::t('plugins/diy', '大标题字符限制15');?>"></el-input>
                                ...
                                <div flex="dir:left cross:center">
                                    <el-input maxlength="10" style="margin-left: 10px;width: 240px" size="small" v-model="data.buy_small" placeholder="<?= \Yii::t('plugins/diy', '小标题字符限制10');?>"></el-input>
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/diy', '按钮颜色');?>" prop="buy_btn_bg_color">
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/diy', '按钮文字');?>" prop="buy_btn_text">
                                <div flex="dir:left cross:center">
                                    <el-input maxlength="4" style="margin-left: 10px;width: 240px" size="small" v-model="data.buy_btn_text" placeholder="<?= \Yii::t('plugins/diy', '大标题字符限制4');?>"></el-input>
                    ...
                    <el-form label-position="left">
                        <el-form-item class="diy-user-label" label="<?= \Yii::t('plugins/diy', '已购买用户');?>" prop="renew_user">
                            <el-form-item label="<?= \Yii::t('plugins/diy', '背景图');?>" prop="renew_bg">
                                <div style="position: relative">
                                    ...
                                    <el-button size="mini" @click="resetImg(2,'renew')" class="diy-reset" type="primary"><?= \Yii::t('plugins/diy', '恢复默认');?></el-button>
                                </div>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/diy', '文字');?>" prop="renew_text">
                                <div flex="dir:left cross:center">
                                    <el-input maxlength="15" style="margin-left: 10px;width: 240px" size="small" v-model="data.renew_text" placeholder="<?= \Yii::t('plugins/diy', '标题字符限制15');?>"></el-input>
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/diy', '按钮颜色');?>" prop="renew_btn_bg_color">
        ...
        data() {
            return {
                ...
                default: {
                    ...
                    buy_btn_bg_color: '',
                    buy_big: '<?= \Yii::t('plugins/diy', '开通超级会员');?>',
                    buy_small: '<?= \Yii::t('plugins/diy', '超值全场8');?>',
                    buy_btn_text: '<?= \Yii::t('plugins/diy', '立即开通');?>',
                    renew_text_color: '#D0B8A5',
                    renew_btn_bg_color: '',
                    renew_text: '<?= \Yii::t('plugins/diy', 'SVIP会员优享9');?>',
                },
                form: {},
                background: '#FFFFFF',
