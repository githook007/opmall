...
<style>
    ...
    .diy-pintuan .diy-component-preview .goods-name.goods-two {
                ...
                <div v-for="item in cList" style="padding: 10px;" :style="cItemStyle">
                    <div class="goods-item"
                        ...
                        <div :style="cGoodsInfoStyle" flex="dir:top">
                            <div class="goods-name goods-name-static" :content="item.peopleNum + '<?= \Yii::t('plugins/diy', '人团');?>'">
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: "<?= \Yii::t('plugins/diy', '去拼团');?>",
                    showGoodsTag: false,
