...
<template id="app-market">
    <div class="app-market">
        <el-dialog title="<?= \Yii::t('plugins/diy', '选择模板');?>" :visible.sync="markDialog" width="1000px">
                ...
                <div class="box" flex="dir:left">
                    <div class="box-item" flex="dir:top cross:center main:center"
                        ...
                        <img src="<?= \app\helpers\PluginHelper::getPluginBaseAssetsUrl() ?>/images/icon_add.png"
                             height="56px"
                             width="57px">
                        <span style="margin-top: 15px;font-size:16px;font-weight:400; color:rgba(102,102,102,1);"><?= \Yii::t('plugins/diy', '使用空白模板');?></span>
                    </div>
        ...
        <!-- 预览 -->
        <el-dialog title="<?= \Yii::t('plugins/diy', '手机端预览');?>" :visible.sync="tplDialog" width="30%" v-if="template">
        ...
        <el-dialog class="loading-dialog" flex="cross:center main:center" title="<?= \Yii::t('plugins/diy', '提示');?>" width="350px"
            ...
            <div style="text-align: center;font-size: 16px;">
                <i style="font-size: 20px;margin-right: 10px;color: #3399ff" class="el-icon-loading"></i><?= \Yii::t('plugins/diy', '正在加载中');?>
            </div>
        </el-dialog>
