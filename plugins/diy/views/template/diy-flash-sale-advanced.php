...
<style>
    /*-----------------设置部分--------------*/
    .diy-flash-sale-advanced .diy-component-edit .goods-list {
        flex-wrap: wrap;
    }

    .diy-flash-sale-advanced .diy-component-edit .goods-item,
    .diy-flash-sale-advanced .diy-component-edit .goods-add {
        width: 50px;
        height: 50px;
        position: relative;
        margin-right: 15px;
    ...
    .diy-flash-sale-advanced .diy-component-edit .goods-add .el-button {
        width: 100%;
        height: 100%;
        border-radius: 0;
        padding: 0;
    ...
    .diy-flash-sale-advanced .diy-component-edit .goods-pic {
        width: 100%;
        height: 100%;
    ...
    .diy-flash-sale-advanced .diy-component-edit .goods-delete {
        position: absolute;
        left: calc(100% - 13px);
        top: -13px;
        width: 25px;
    ...
    .diy-flash-sale-advanced .diy-component-edit .goods-item:hover .goods-delete {
        visibility: visible;
    }

    /*-----------------预览部分--------------*/
    .diy-flash-sale-advanced .diy-component-preview .goods-list {
        padding: 11px;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-item {
        padding: 11px;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-pic {
        background-size: cover;
        background-position: center;
        width: 99.8%;
        height: 700px;
    ...
    .diy-flash-sale-advanced .diy-component-preview .goods-list-style--1 .goods-item,
    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-1 .goods-item {
        width: 100%;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-2 .goods-item {
        width: 50%;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-3 .goods-item {
        width: 33.333333%;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-0 .goods-item {
        width: 249px;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-list-style--1 .goods-pic {
        width: 200px;
        height: 200px;
        border-radius: 10px 0 0 10px;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-2 .goods-pic {
        height: 342px;
        border-radius: 10px 10px 0 0;
    }

    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-0 .goods-pic,
    .diy-flash-sale-advanced .diy-component-preview .goods-list-style-3 .goods-pic {
        height: 200px;
        border-radius: 10px 10px 0 0;
    }


    .diy-flash-sale-advanced hr {
        border: none;
        height: 1px;
        background-color: #e2e2e2;
    }
</style>
<template id="diy-flash-sale-advanced">
    <div class="diy-flash-sale-advanced">
        <div class="diy-component-preview">
            <div>
                <?= \Yii::t('plugins/diy', '限时抢购');?>
            </div>
        </div>
        <div class="diy-component-edit">
            <el-form label-width='150px' @submit.native.prevent>
                ...
                <el-form-item v-show="data.addGoodsType == 0" label="<?= \Yii::t('plugins/diy', '商品数量');?>">
                    <el-input size="small" v-model.number="data.goodsLength" type="number"></el-input>
                </el-form-item>
                <el-form-item v-show="data.addGoodsType == 1" label="<?= \Yii::t('plugins/diy', '商品列表');?>">
                    <draggable v-model="data.list" flex class="goods-list">
                        <div class="goods-item"
                             v-for="(goods,goodsIndex) in data.list">
                            <el-tooltip effect="dark" content="<?= \Yii::t('plugins/diy', '移除商品');?>" placement="top">
                ...
                <hr>
                <!--————————————————————————————————————————————————-->
                <el-form-item label="<?= \Yii::t('plugins/diy', '抢购标题');?>">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '倒计时文字颜色');?>">
                    <div flex="dir:left cross:center">
                        <el-color-picker @change="(row) => {row == null ? data.mTimeColor = '#353535' : ''}" size="small"
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '倒计时背景颜色');?>">
                    <div flex="dir:left cross:center">
                        <el-color-picker @change="(row) => {row == null ? data.mTimeBgColor = '#FFFFFF' : ''}" size="small"
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '商品背景颜色');?>">
                    <div flex="dir:left cross:center">
                        <el-color-picker @change="(row) => {row == null ? data.mGoodsBgColor = '#FFE7E7' : ''}" size="small"
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '商品角标');?>" v-if="data.showGoodsTag">
                    <app-radio v-model="data.goodsTagPicUrl" v-for="tag in goodsTags" :label="tag.picUrl"
                               :key="tag.name"
                               @change="goodsTagChange">
                        {{tag.name}}
                    </app-radio>
                    <app-radio v-model="data.customizeGoodsTag" :label="true" @change="customizeGoodsTagChange">
                        <?= \Yii::t('plugins/diy', '自定义');?>
                    </app-radio>
                </el-form-item>
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示抢购进度条');?>">
                    <el-switch v-model="data.showProgressBar"></el-switch>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示划线价');?>">
        ...
        <el-dialog title="<?= \Yii::t('plugins/diy', '选择商品');?>" :visible.sync="goodsDialog.visible" :close-on-click-modal="false"
                   @open="loadGoodsData">
            <el-input size="mini" v-model="goodsDialog.keyword" placeholder="<?= \Yii::t('plugins/diy', '根据名称搜索');?>" :clearable="true"
                ...
                <el-button slot="append" @click="goodsDialogPageChange(1)"><?= \Yii::t('plugins/diy', '搜索');?></el-button>
            </el-input>
            <el-table :data="goodsDialog.list" v-loading="goodsDialog.loading" @selection-change="goodsSelectionChange">
                <el-table-column label="<?= \Yii::t('plugins/diy', '选择');?>" type="selection"></el-table-column>
                <el-table-column label="ID" prop="id" width="100px"></el-table-column>
                <el-table-column label="<?= \Yii::t('plugins/diy', '名称');?>" prop="name">
            ...
            <div slot="footer">
                <el-button @click="goodsDialog.visible = false"><?= \Yii::t('plugins/diy', '取消');?></el-button>
...
<script>
    Vue.component('diy-flash-sale-advanced', {
        template: '#diy-flash-sale-advanced',
        props: {
            value: Object,
        },
        data() {
            return {
                ...
                data: {
                    ...
                    goodsLength: 10,
                    /* */
                    mTitle: "<?= \Yii::t('plugins/diy', '好物限时抢');?>",
                    mColor: '#FFFFFF',
                    mBgType: 'gradient',
                    mBgColor: '#FF366F',
