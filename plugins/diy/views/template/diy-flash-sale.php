                    ...
                    <div class="goods-item"
                        ...
                        <div class="goods-pic" :style="cGoodsPicStyle(item.picUrl)">
                            <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-miaosha-timer"
                                ...
                                <div v-if="data.listStyle===1"><?= \Yii::t('plugins/diy', '限时抢购');?></div>
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name" :class="data.listStyle!==-1 ? data.listStyle == 1 ? 'goods-two' : '':'goods-name-static'">
                                <template v-if="data.showGoodsName"><span v-if="data.listStyle!=1" class="plugin-name"><?= \Yii::t('plugins/diy', '限时抢购');?></span>{{item.name}}</template>
                            </div>
                            <div v-if="data.listStyle===-1"  >
                                <div flex="dir:left main:justify">
                                    <span class="discount" v-if="item.discount_type === 1">
                                        {{item.min_discount}}<?= \Yii::t('plugins/diy', '折');?>
                                    </span>
                                    <span class="discount" v-if="item.discount_type === 2">
                                        <?= \Yii::t('plugins/diy', '减');?>{{item.min_discount}}<?= \Yii::t('plugins/diy', '元');?>
                                    </span>
                                    <span :class="data.showProgressBar ? '' : 'option'" style="margin-left: 15px;color: #909399;font-size: 24px;"><?= \Yii::t('plugins/diy', '已抢0件');?></span>
                                </div>
                            ...
                            <div v-if="data.listStyle === 1 || data.listStyle === 2">
                                <div>
                                    <span class="discount" v-if="item.discount_type === 1">
                                        {{item.min_discount}}<?= \Yii::t('plugins/diy', '折起');?>
                                    </span>
                                    <span class="discount" v-if="item.discount_type === 2">
                                        <?= \Yii::t('plugins/diy', '减');?>{{item.min_discount}}<?= \Yii::t('plugins/diy', '元');?>
                                    </span>
                            ...
                            <div flex="box:last cross:bottom">
                                <div class="goods-price" :style="cPriceStyle">
                                    <template v-if="data.listStyle === 1 || data.listStyle === 2 || (!data.showProgressBar && data.listStyle === -1)">
                                        ...
                                        <div v-if="data.isUnderLinePrice"
                                    ...
                                    <template v-else-if="data.listStyle === -1 && data.showProgressBar">
                                        ...
                                        <span v-if="data.isUnderLinePrice"
                                              style="color: #909399;text-decoration: line-through;font-size: 24px;line-height: 1">￥{{item.originalPrice}}</span>
                                    </template>
                                </div>
            ...
            <div v-if="data.addGoodsType == 0">
                <div v-if="data.addGoodsType == 0" class="m-diy-list__box" flex="dir:top">
                    <div flex="main:justify cross:center dir:left" class="m-label box-grow-0"
                         :style="{background: 'linear-gradient( to right, ' + data.mBgColor +', '+ (  data.mBgType === 'gradient' ?   data.mBgGradientColor:   data.mBgColor) + ') !important'}">
                        <div flex="dir:left cross:center" class="box-grow-0">
                            ...
                            <div class="desc"><?= \Yii::t('plugins/diy', '结束');?></div>
                        </div>
                                ...
                                <div class="goods-end"
                                    ...
                                    <template v-if="data.showProgressBar">
                                        <div flex="main:center cross:center" class="goods-fold">
                                            <span v-if="goods.discount_type === 1"> {{goods.min_discount}}<?= \Yii::t('plugins/diy', '折');?></span>
                                            <span v-if="goods.discount_type === 2"> {{goods.discount_type}}<?= \Yii::t('plugins/diy', '元');?></span>
                                        </div>
                                        <div class="goods-progress">
                                            <div class="goods-progress-view" style="width: 20%"></div>
                                        </div>
                                        <div class="goods-num"><?= \Yii::t('plugins/diy', '已抢购0件');?></div>
                                    </template>
        ...
        <div class="diy-component-edit">
            <el-form @submit.native.prevent label-width="150px">
                    ...
                    <el-form-item label="<?= \Yii::t('plugins/diy', '标题背景颜色');?>">
                        ...
                        <div flex="dir:left cross:center">
                            <div>
                                ...
                                <el-input size="small" style="width: 80px;margin-left: 5px;" v-model="data.mBgColor"></el-input>
                            </div>
                            <div style="margin-left: 24px">
                                ...
                                <el-input size="small" style="width: 80px;margin-left: 5px;"
                                          v-model="data.mBgGradientColor"></el-input>
                            </div>
                        </div>
                    </el-form-item>
                ...
                <template v-if="data.addGoodsType == 1">
                    ...
                    <el-form-item label="<?= \Yii::t('plugins/diy', '居中');?>" v-if="cShowEditBuyBtn">
                        <el-switch v-model="data.showBuyBtn"></el-switch>
                    </el-form-item>
                    <el-form-item label="<?= \Yii::t('plugins/diy', '显示抢购进度条');?>">
                        <el-switch v-model="data.showProgressBar"></el-switch>
                    </el-form-item>
                    <el-form-item v-if="data.showBuyBtn && cShowEditBuyBtn" label="<?= \Yii::t('plugins/diy', '购买按钮样式');?>">
                    ...
                    <el-form-item v-if="data.showBuyBtn && cShowEditBuyBtn" label="<?= \Yii::t('plugins/diy', '购买按钮文字');?>">
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: "<?= \Yii::t('plugins/diy', '马上抢');?>",
                    showGoodsTag: false,
