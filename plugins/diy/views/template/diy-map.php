    ...
    <div class="diy-map">
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="<?= \Yii::t('plugins/diy', '地图');?>">
                    <app-map @map-submit="mapEvent">
                        <el-button type="primary" size="small"><?= \Yii::t('plugins/diy', '地图选点');?></el-button>
                    </app-map>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '经纬度');?>">
                    <el-input size="small" v-model="data.location" placeholder="<?= \Yii::t('plugins/diy', '请使用地图选点选择经纬度');?>"></el-input>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '地图高度');?>">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '左右边距');?>">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '背景图片');?>">
