    ...
    <div class="diy-user-order">
        <div class="diy-component-preview">
            <div style="border: 1px solid #eee;border-width: 1px 0;" :style="cStyle">
                <div style="padding: 20px 30px;border-bottom: 1px solid #e2e2e2;"><?= \Yii::t('plugins/diy', '我的订单');?></div>
                <div flex="">
        ...
        <div class="diy-component-edit">
            <el-form @submit.native.prevent label-width="100px">
                <el-form-item label="<?= \Yii::t('plugins/diy', '导航菜单');?>">
                    <div class="nav-list" flex>
                        <div class="nav-item" v-for="nav in data.navs">
                            <app-attachment v-model="nav.picUrl" tag="user_order">
