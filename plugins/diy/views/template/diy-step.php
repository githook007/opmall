...
?>
<style>
    .diy-step .diy-component-edit .goods-list {
        line-height: normal;
        flex-wrap: wrap;
    }

    .diy-step .diy-component-edit .goods-item,
    .diy-step .diy-component-edit .goods-add {
        width: 50px;
        height: 50px;
    ...
    .diy-step .diy-component-edit .goods-delete {
        position: absolute;
        top: -11px;
        right: -11px;
        width: 25px;
    ...
    .diy-step .diy-component-edit .goods-item:hover .goods-delete {
        visibility: visible;
    }

    /*-------------------- 预览部分 --------------------*/
    .diy-step .diy-component-preview .goods-list {
        flex-wrap: wrap;
        padding: 10px;
    }

    .diy-step .diy-component-preview .goods-item {
        position: relative;
    }

    .diy-step .diy-component-preview .goods-tag {
        position: absolute;
        top: 0;
        left: 0;
        width: 64px;
    ...
    .diy-step .diy-component-preview .goods-pic {
        width: 100%;
        height: 706px;
    ...
    .diy-step .diy-component-preview .goods-name {
        white-space: nowrap;
        overflow: hidden;
    ...
    .diy-step .diy-component-preview .goods-name.goods-two {
    ...
    .diy-step .diy-component-preview .goods-cover-3-2 .goods-pic {
        height: 470px;
    }

    .diy-step .diy-component-preview .goods-list-2 .goods-pic {
        height: 343px;
    }

    .diy-step .diy-component-preview .goods-list--1 .goods-pic {
        width: 200px;
        height: 200px;
        margin-right: 20px;
    }

    .diy-step .diy-component-preview .goods-list--1 .goods-item {
        margin-bottom: 20px;
    }

    .diy-step .diy-component-preview .goods-list--1 .goods-item:last-child {
        margin-bottom: 0;
    }

    .diy-step .diy-component-preview .goods-name-static {
        height: 80px;
        white-space: normal;
        overflow: hidden;
        text-overflow: ellipsis;
    ...
    .diy-step .diy-component-preview .goods-price {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
        color: #ff4544;
    ...
    .diy-step .diy-component-preview .goods-advance-timer {
        position: absolute;
        left: 0;
        right: 0;
        bottom: 0;
                    ...
                    <div class="goods-item"
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name"
                                 :class="data.listStyle!==-1 ? data.listStyle == 1 ? 'goods-two' : '':'goods-name-static'">
                                <template>
                                    <span class="plugin-name"><?= \Yii::t('plugins/diy', '步数宝');?></span>
                            ...
                            <div flex="box:last cross:bottom">
                                <div class="goods-price" :style="cPriceStyle">
                                    <div style="text-overflow: ellipsis;overflow: hidden;">
                                        <template v-if="item.currency > 0">{{item.currency}}<?= \Yii::t('plugins/diy', '活力币');?>+￥{{item.price}}
                                        </template>
                                    </div>
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: '<?= \Yii::t('plugins/diy', '去兑换');?>',
                    showGoodsTag: false,
            ...
            addGoods() {
                ...
                for (let i in this.goodsDialog.selected) {
                    const item = {
                        ...
                        currency: this.goodsDialog.selected[i].currency,
