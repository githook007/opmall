...
<style>
    ...
    .app-edit .el-slider__button {
        background-color: #409EFF;
    }
    .app-edit .el-color-picker {
        height: 30px;
    }
    .app-edit .el-color-picker .el-color-picker__trigger {
        width: 55px;
        height: 30px;
        border-radius: 3px;
    ...
    .app-edit .el-color-picker .el-color-picker__color {
        width: 17px;
        height: 17px;
        border: 1px solid #E5E7EC;
        border-radius: 3px;
    }
    .app-edit .el-color-picker .el-color-picker__color .el-color-picker__color-inner {
        border-radius: 3px;
    }
    .app-edit .el-color-picker .el-color-picker__icon:before{
        content:"\e790";
    }
    .app-edit .el-color-picker .el-color-picker__icon {
        left: 70%;
        font-size: 22px;
        color: #888F9A;
    }
    .app-edit .el-color-picker+.el-input .el-input__inner {
        padding: 0 5px 0 7px;
        height: 30px;
        line-height: 30px;
        font-size: 12px;
    }
    .app-edit .el-checkbox__input.is-checked .el-checkbox__inner {
        background-color: #FFF;
    }
    .app-edit .el-checkbox__input.is-checked .el-checkbox__inner::after {
        border-color: #409EFF;
    }
    .app-edit .el-checkbox__input.is-checked+.el-checkbox__label {
        color: #606266;
    }
    .app-edit .diy-component-edit .second-label {
        font-size: 18px;
        color: #242424;
        font-weight: bold;
        margin: 55px 35px 40px 20px;
    }
    ...
    <div class="app-edit">
        <el-card shadow="never" style="margin-bottom: 10px">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item v-if="has_home == 1"><?= \Yii::t('plugins/diy', '装修首页');?></el-breadcrumb-item>
                <el-breadcrumb-item v-else-if="id > 0"><?= \Yii::t('plugins/diy', '详情');?></el-breadcrumb-item>
                <el-breadcrumb-item v-else><?= \Yii::t('plugins/diy', '新增');?></el-breadcrumb-item>
            </el-breadcrumb>
        </el-card>
        <div v-loading="loading">
            <div flex="box:first" style="margin-bottom: 10px;min-width: 1280px;height: 725px;">
                <div class="all-components">
                    <el-form v-if="labelText['title'] !== '微页面标题'" @submit.native.prevent label-width="95px" :ref="templateName">
                    ...
                    <el-form label-width="95px" v-if="type !== 'module'">
                        <el-form-item label="<?= \Yii::t('plugins/diy', '页面设置');?>" required>
                            <el-button size="small" @click="openPageSetting"><?= \Yii::t('plugins/diy', '设置');?></el-button>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('plugins/diy', '设置背景');?>">
                            <el-button size="small" @click="openBgSetting"><?= \Yii::t('plugins/diy', '设置');?></el-button>
                        </el-form-item>
                    </el-form>
                            ...
                            <div id="mobile-framework-body" class="mobile-framework-body"
                                    ...
                                    <div class="diy-component-edit">
                                        <el-form label-width="100px">
                                            <el-card shadow="never">
                                                <div slot="header">
                                                    <span><?= \Yii::t('plugins/diy', '页面设置');?></span>
                                                </div>
                                                ...
                                                <el-form-item label="<?= \Yii::t('plugins/diy', '选择风格');?>" prop="style">
                                                    <el-radio-group v-model="appNavBar.style">
                                                        <el-radio label="1"><?= \Yii::t('plugins/diy', '风格1');?></el-radio>
                                                        <el-radio label="2"><?= \Yii::t('plugins/diy', '风格2');?></el-radio>
                                                        <el-radio label="3"><?= \Yii::t('plugins/diy', '风格3');?></el-radio>
                                                        <el-radio label="4"><?= \Yii::t('plugins/diy', '风格4');?></el-radio>
                                                    </el-radio-group>
                                                </el-form-item>

                                                <el-form-item v-if="appNavBar.style == 1" label="<?= \Yii::t('plugins/diy', '展示位置');?>" prop="position">
                                                    <el-radio-group v-model="appNavBar.position">
                                                        <el-radio label="center"><?= \Yii::t('plugins/diy', '居中');?></el-radio>
                                                        <el-radio label="left"><?= \Yii::t('plugins/diy', '左对齐');?></el-radio>
                                                    </el-radio-group>
                                                </el-form-item>

                                                <template v-if="[2,3].indexOf(Number(appNavBar.style)) !== -1">
                                                    <el-form-item label="<?= \Yii::t('plugins/diy', '图片上传');?>" prop="leftIcon">
                                                        <app-attachment style="margin-bottom:10px" :multiple="false"
                                                                        :max="1"
                                                                        @selected="mallLeftIconPic">
                                                            <el-tooltip effect="dark"
                                                                        content="<?= \Yii::t('plugins/diy', '建议尺寸最大宽度100px');?>"
                                                                        placement="top">
                                                        ...
                                                        <el-button size="mini" @click="resetImg('left_icon')"
                                                                   class="reset" type="primary"><?= \Yii::t('plugins/diy', '恢复默认');?>
                                                        </el-button>
                                                    </el-form-item>
                                                </template>
                                                <el-form-item  v-if="[2,3,4].indexOf(Number(appNavBar.style)) !== -1" label="<?= \Yii::t('plugins/diy', '选择链接');?>" prop="link">
                                                ...
                                                <template v-if="[3,4].indexOf(Number(appNavBar.style)) !== -1">
                                                    <el-form-item label="<?= \Yii::t('plugins/diy', '搜索提示文字');?>" prop="placeholder">
                                                        <el-input size="small" v-model="appNavBar.placeholder"
                                                                  class="nav-input" maxlength="8"
                                                                  show-word-limit></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="<?= \Yii::t('plugins/diy', '文字颜色');?>" prop="placeholderColor">
                                            ...
                                            <el-card shadow="never" style="margin-top: 12px">
                                                <div slot="header">
                                                    <span><?= \Yii::t('plugins/diy', '顶部标题栏');?></span>
                                                </div>
                                                <el-form-item label="<?= \Yii::t('plugins/diy', '使用商城配置');?>" prop="hasMallSetting">
                                                    <el-switch v-model="appNavBar.hasMallSetting" :inactive-value="0" :active-value="1"></el-switch>
                                                </el-form-item>
                                                <template v-if="!appNavBar.hasMallSetting">
                                                    <el-form-item v-if="[1,2,4].indexOf(Number(appNavBar.style)) !== -1" label="<?= \Yii::t('plugins/diy', '文字颜色');?>" prop="color">
                                                        <el-radio-group v-model="appNavBar.color">
                                                            <el-radio label="white"><?= \Yii::t('plugins/diy', '白色');?></el-radio>
                                                            <el-radio label="black"><?= \Yii::t('plugins/diy', '黑色');?></el-radio>
                                                        </el-radio-group>
                                                    </el-form-item>
                                                    <el-form-item label="<?= \Yii::t('plugins/diy', '背景颜色');?>" prop="backgroundColor">
                                                        <el-color-picker size="small" v-model="appNavBar.backgroundColor"></el-color-picker>
                                                        <el-input size="small" style="width: 80px;margin-right: 25px;"
                                ...
                                <div v-else flex="main:center cross:center"
                                    ...
                                    <div>
                                        ...
                                        <div><?= \Yii::t('plugins/diy', '空空如也');?></div>
                                        <div><?= \Yii::t('plugins/diy', '请从左侧组件库添加组件');?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <el-dialog title="<?= \Yii::t('plugins/diy', '背景设置');?>" :visible.sync="bgVisible">
            ...
            <div slot="footer">
                <el-button size="small" @click="bgVisible = false"><?= \Yii::t('plugins/diy', '取消');?></el-button>
                <el-button size="small" @click="beSettingBg" type="primary">确定</el-button>
            </div>
        </el-dialog>
        <el-card class="bottom-menu" shadow="never">
            <div>
                <el-button size="small" @click="save(false)" type="primary" :loading="submitLoading"><?= \Yii::t('plugins/diy', '保存');?></el-button>
                <el-button v-if="has_home != 1" size="small" @click="saveAs" :loading="submitLoading"><?= \Yii::t('plugins/diy', '另存为');?></el-button>
            </div>
        </el-card>
    </div>
</template>
    ...
    Vue.component('app-edit', {
        ...
        data() {
            var validate = (rule, value, callback) => {
                if (this.templateName) {
                    ...
                    callback(new Error(this.labelText['title'] + "<?= \Yii::t('plugins/diy', '不能为空');?>"))
                }
            };
            return {
                hw_style: {},
        ...
        computed: {
            ...
            labelText() {
                if (this.has_home == 1) {
                    return {
                        'text': "<?= \Yii::t('plugins/diy', 'DIY首页');?>",
                        'page_url': 'plugin/diy/mall/home/index',
                        'title': "<?= \Yii::t('plugins/diy', '首页标题');?>",
                    }
                } else if (this.type === 'module') {
                    return {
                        'text': "<?= \Yii::t('plugins/diy', '自定义模块');?>",
                        'page_url': 'plugin/diy/mall/module/index',
                        'title': "<?= \Yii::t('plugins/diy', '模块名称');?>",
                    }
                } else {
                    return {
                        'text': "<?= \Yii::t('plugins/diy', '微页面');?>",
                        'page_url': 'plugin/diy/mall/template/index',
                        'title': "<?= \Yii::t('plugins/diy', '微页面标题');?>",
                    }
                }
            }
        }
        ...
        methods: {
            ...
            selectComponent(e) {
                if (this.overrun && !this.overrun.is_diy_module_overrun
                    ...
                    this.$message.error("<?= \Yii::t('plugins/diy', '最多添加');?>" + this.overrun.diy_module_overrun + "<?= \Yii::t('plugins/diy', '个组件');?>");
                    return;
                }
                if (e.single) {
                    for (let i in this.components) {
                        if (this.components[i].id === e.id) {
                            this.$message.error("<?= \Yii::t('plugins/diy', '该组件只允许添加一个');?>");
                            return;
                        }
                    }
                }
            ...
            copyComponent(index) {
                if (this.overrun && !this.overrun.is_diy_module_overrun
                    ...
                    this.$message({
                        message: "<?= \Yii::t('plugins/diy', '最多添加');?>" + this.overrun.diy_module_overrun + "<?= \Yii::t('plugins/diy', '个组件');?>",
                        type: 'error',
                        center: true
                    });
                    return;
                    ...
                    for (let j in this.allComponents[i].list) {
                        ...
                        if (this.allComponents[i].list[j].id === this.components[index].id) {
                            if (this.allComponents[i].list[j].single) {
                                this.$message({message: "<?= \Yii::t('plugins/diy', '该组件只允许添加一个');?>", type: 'error', center: true});
                                return;
                            }
                        }
                    }
            ...
            save(isSaveAs, saveAsName) {
                if (!this.templateName) {
                    this.$message({message: this.labelText['title'] + "<?= \Yii::t('plugins/diy', '不能为空');?>", type: 'error', center: true});
                    return;
                }
                ...
                for (let i in this.components) {
                    ...
                    if (this.components[i]['id'] === 'module' && this.components[i]['data']['list'].length > 1) {
                        ...
                        for (let j in list) {
                            if (!list[j].tabName) {
                                this.$message({message: "<?= \Yii::t('plugins/diy', '自定义模块名称不能为空');?>", type: 'error', center: true});
                                return;
                            }
                        }
                    }
                    if (this.components[i]['id'] === 'nav') {
                        ...
                        if (bgType === 'pic' && !backgroundPicUrl) {
                            this.$message({message: "<?= \Yii::t('plugins/diy', '导航图标背景图不能为空');?>", type: 'warning', center: true});
                            return;
                        }
                    }
                    if (this.components[i]['id'] === 'banner') {
                        ...
                        if (banner.length === 0) {
                            this.$message({message: "<?= \Yii::t('plugins/diy', '轮播图不能为空');?>", type: 'warning', center: true});
                            return;
                        }
                        if (banner.length < 2) {
                            this.$message({message: "<?= \Yii::t('plugins/diy', '轮播图图片不能少于2张');?>", type: 'warning', center: true});
                            return;
                        }
                        for (let i = 0; i < banner.length; i++) {
                            if (!banner[i].picUrl) {
                                this.$message({message: "<?= \Yii::t('plugins/diy', '轮播图图片不能为空');?>", type: 'warning', center: true});
                                return;
                            }
                        }
                    }
            ...
            saveAs() {
                this.$prompt("<?= \Yii::t('plugins/diy', '请输入');?>"+ this.labelText.title + ':', "<?= \Yii::t('plugins/diy', '另存为');?>").then(({value}) => {
                    if (value) {
