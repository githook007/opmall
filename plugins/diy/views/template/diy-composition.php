...
<style>
    ...
    .diy-composition .diy-component-preview .goods-name.goods-two {
    ...
    <div class="diy-composition">
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name" :class="data.listStyle!==-1 ? data.listStyle == 1 ? 'goods-two' : '':'goods-name-static'">
                                <span class="plugin-name">
                                    <template v-if="item.composition_type == 1"><?= \Yii::t('plugins/diy', '固定套餐');?></template>
                                    <template v-else><?= \Yii::t('plugins/diy', '搭配套餐');?></template>
                                </span>
        ...
        <div class="diy-component-edit">
            <el-form @submit.native.prevent label-width="150px">
                <el-form-item label="<?= \Yii::t('plugins/diy', '套餐列表');?>">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '商品封面图宽高比例');?>" v-if="false && data.listStyle==1">
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示套餐名称');?>">
        ...
        <el-dialog title="<?= \Yii::t('plugins/diy', '选择套餐');?>" :visible.sync="goodsDialog.visible" @open="goodsDialogOpened">
            ...
            <el-table :data="goodsDialog.list" v-loading="goodsDialog.loading" @selection-change="goodsSelectionChange">
                ...
                <el-table-column label="<?= \Yii::t('plugins/diy', '套餐名称');?>" prop="name"></el-table-column>
                <el-table-column label="<?= \Yii::t('plugins/diy', '创建时间');?>" prop="created_at" width="250px"></el-table-column>
            </el-table>
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: "<?= \Yii::t('plugins/diy', '去抢购');?>",
                    showGoodsTag: false,
        ...
        computed: {
            ...
            cList() {
                if (!this.data.list || !this.data.list.length) {
                    const item = {
                        id: 0,
                        name: "<?= \Yii::t('plugins/diy', '套餐名称套餐名称');?>",
                        picUrl: '',
                        price: '100.00',
