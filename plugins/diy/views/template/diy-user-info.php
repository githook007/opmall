            ...
            <div class="user-info-container" flex="cross:center"
                ...
                <div style="width: 100%;" :style="cOutBoxStyle">
                    <div style="width: 100%;" :flex="cFlexDir">
                        ...
                        <div style="color: #fff;" :style="cNameBoxStyle"><?= \Yii::t('plugins/diy', '用户昵称');?></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="<?= \Yii::t('plugins/diy', '样式');?>">
                    <app-radio v-model="data.style" :label="1"><?= \Yii::t('plugins/diy', '样式1');?></app-radio>
                    <app-radio v-model="data.style" :label="2"><?= \Yii::t('plugins/diy', '样式2');?></app-radio>
                    <app-radio v-model="data.style" :label="3"><?= \Yii::t('plugins/diy', '样式3');?></app-radio>
                </el-form-item>
