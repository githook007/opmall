    ...
    <div class="diy-check-in">
        <div class="diy-component-preview">
            <div style="height: 200px;padding: 0 50px;background-size: 100% 100%;position: relative;"
                ...
                <div v-if="data.showText" :style="cTextStyle" style="width: 100%;">
                    <div style="margin-bottom: 10px;"><?= \Yii::t('plugins/diy', '今日签到可获得5积分');?></div>
                    <div><?= \Yii::t('plugins/diy', '已连续签到10天');?></div>
                </div>
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item label="<?= \Yii::t('plugins/diy', '点击热区');?>">
                    <app-hotspot :pic-url="data.backgroundPicUrl"
                                 ...
                                 width="750px"
                                 height="200px">
                        <el-button size="small"><?= \Yii::t('plugins/diy', '设置热区');?></el-button>
                    </app-hotspot>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '显示文字');?>">
                    <el-switch v-model="data.showText"></el-switch>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '文字位置');?>">
                    <app-radio v-model="data.textPosition" label="left"><?= \Yii::t('plugins/diy', '靠左');?></app-radio>
                    <app-radio v-model="data.textPosition" label="center"><?= \Yii::t('plugins/diy', '居中');?></app-radio>
                    <app-radio v-model="data.textPosition" label="right"><?= \Yii::t('plugins/diy', '靠右');?></app-radio>
                </el-form-item>
