...
<style>
    ...
    .diy-pick .diy-component-preview .goods-name.goods-two {
                    ...
                    <div class="goods-item"
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name" :class="data.listStyle!==-1 ? data.listStyle == 1 ? 'goods-two' : '':'goods-name-static'">
                                <template>
                                    <span class="plugin-name"><?= \Yii::t('plugins/diy', 'N元任选');?></span>
                            ...
                            <div flex="box:last cross:bottom">
                                <div class="goods-price" :style="cPriceStyle">
                                    <div class="des-text">
                                        {{item.rule_price}}<?= \Yii::t('plugins/diy', '任选');?>{{item.rule_num}}<?= \Yii::t('plugins/diy', '件');?>
                                    </div>
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: "<?= \Yii::t('plugins/diy', '去凑单');?>",
                    showGoodsTag: false,
