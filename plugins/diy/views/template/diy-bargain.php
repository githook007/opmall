...
<style>
    ...
    .diy-bargain .diy-component-preview .goods-name.goods-two {
                    ...
                    <div class="goods-item"
                        ...
                        <div class="goods-pic" :style="cGoodsPicStyle(item.picUrl)">
                            <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-bargain-timer"
                                ...
                                <div v-if="data.listStyle===1"><?= \Yii::t('plugins/diy', '砍价');?></div>
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name" :class="data.listStyle!==-1 ? data.listStyle == 1 ? 'goods-two' : '':'goods-name-static'">
                                <template v-if="data.showGoodsName"><span v-if="data.listStyle!=1" class="plugin-name"><?= \Yii::t('plugins/diy', '砍价');?></span>{{item.name}}</template>
                            </div>
