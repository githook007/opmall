...
<style>
    ...
    .diy-lottery .diy-component-preview .goods-name.goods-two {
                    ...
                    <div class="goods-item"
                        ...
                        <div class="goods-pic" :style="cGoodsPicStyle(item.picUrl)">
                            <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-lottery-timer"
                                ...
                                <div v-if="data.listStyle===1"><?= \Yii::t('plugins/diy', '抽奖');?></div>
                        ...
                        <div :style="cGoodsInfoStyle">
                            ...
                            <div flex="box:last cross:bottom">
                                <div class="goods-price" :style="cPriceStyle">
                                    <div style="color: #ff4544;"><?= \Yii::t('plugins/diy', '免费');?></div>
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: "<?= \Yii::t('plugins/diy', '去参与');?>",
                    showGoodsTag: false,
