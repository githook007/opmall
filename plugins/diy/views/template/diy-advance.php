...
<style>
    ...
    .diy-advance .diy-component-preview .goods-name.goods-two {
                    ...
                    <div class="goods-item"
                        ...
                        <div class="goods-pic" :style="cGoodsPicStyle(item.picUrl)">
                            <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-advance-timer"
                                ...
                                <div v-if="data.listStyle===1"><?= \Yii::t('plugins/diy', '预售');?></div>
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name" :class="data.listStyle!==-1 ? data.listStyle == 1 ? 'goods-two' : '':'goods-name-static'">
                                <template v-if="data.showGoodsName"><span v-if="data.listStyle!=1" class="plugin-name"><?= \Yii::t('plugins/diy', '预售');?></span>{{item.name}}</template>
                            </div>
                            ...
                            <div flex="box:last cross:bottom">
                                <div class="goods-price" :style="cPriceStyle">
                                    <div class="des-text">
                                        <?= \Yii::t('plugins/diy', '定金');?>{{item.deposit}}<?= \Yii::t('plugins/diy', '抵');?>{{item.swell_deposit}}
                                    </div>
