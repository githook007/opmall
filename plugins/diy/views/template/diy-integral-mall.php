...
<style>
    ...
    .diy-integral-mall .diy-component-edit .goods-name.goods-two {
    ...
    <div class="diy-integral-mall">
                ...
                <div style="display: inline-block" v-for="item in couponList">
                    <div class="coupon-item"
                        ...
                        <div flex="dir:top box:last">
                            ...
                            <div class="coupon-condition"><?= \Yii::t('plugins/diy', '满100可用');?></div>
                        </div>
                        <div flex="cross:center"
                             style="width: 56px; padding: 0 15px;line-height: 1.15;font-size: 24px;">
                            <?= \Yii::t('plugins/diy', '立即兑换');?>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div flex="box:last cross:bottom">
                                <div class="goods-price" :style="cPriceStyle">
                                    <div style="text-overflow: ellipsis;overflow: hidden;">
                                        <template v-if="item.integral > 0">{{item.integral}}<?= \Yii::t('plugins/diy', '积分');?> + ￥{{item.price}}</template>
                                    </div>
        ...
        <div class="diy-component-edit">
            <el-form @submit.native.prevent label-width="150px">
                <template>
                    <el-form-item label="<?= \Yii::t('plugins/diy', '显示优惠券');?>">
                        <el-switch v-model="data.showCoupon"></el-switch>
                    </el-form-item>
                    <el-form-item v-if="data.showCoupon" label="<?= \Yii::t('plugins/diy', '优惠券文字颜色');?>">
                        <el-color-picker v-model="data.couponColor"></el-color-picker>
                    </el-form-item>
                    <el-form-item v-if="data.showCoupon" label="<?= \Yii::t('plugins/diy', '优惠券背景图片');?>">
                        <app-image-upload width="320" height="164" v-model="data.couponPicUrl"></app-image-upload>
                    </el-form-item>
                </template>
                <template>
                    <hr>
                    <el-form-item style="margin-top: 12px" label="<?= \Yii::t('plugins/diy', '显示商品');?>">
                        <el-switch v-model="data.showGoods"></el-switch>
                    </el-form-item>
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '商品列表');?>">
                    ...
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '购买按钮颜色');?>">
                        <el-color-picker v-model="data.buttonColor"></el-color-picker>
                    </el-form-item>
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '列表样式');?>">
                    ...
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '商品封面图宽高比例');?>" v-if="data.listStyle==1">
                    ...
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '商品封面图填充');?>">
                    ...
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '显示商品名称');?>">
                        <el-switch v-model="data.showGoodsName"></el-switch>
                    </el-form-item>
                    <template v-if="cShowEditBuyBtn && data.showGoods">
                        ...
                        <el-form-item v-if="data.showBuyBtn && data.showGoods" label="<?= \Yii::t('plugins/diy', '购买按钮样式');?>">
                        ...
                        <el-form-item v-if="data.showBuyBtn && data.showGoods" label="<?= \Yii::t('plugins/diy', '购买按钮文字');?>">
                            <el-input maxlength='4' size="small" v-model="data.buyBtnText"></el-input>
                        </el-form-item>
                    </template>
                    <el-form-item v-if="data.showGoods" label="<?= \Yii::t('plugins/diy', '显示商品角标');?>">
                    ...
                    <el-form-item label="<?= \Yii::t('plugins/diy', '自定义商品角标');?>" v-if="data.showGoodsTag&&data.customizeGoodsTag && data.showGoods">
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    showBuyBtn: true,
                    buyBtnStyle: 1,
                    buyBtnText: "<?= \Yii::t('plugins/diy', '立即兑换');?>",
                    showGoodsTag: false,
