    ...
    <div>
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="<?= \Yii::t('plugins/diy', '版权文字');?>">
                    <el-input size="small" v-model="data.text"></el-input>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('plugins/diy', '版权图标');?>">
                    <app-image-upload width="160" height="50" v-model="data.picUrl"></app-image-upload>
                </el-form-item>
                <el-form-item class="chooseLink" label="<?= \Yii::t('plugins/diy', '版权链接');?>">
                    <el-input v-model="data.link.url" placeholder="<?= \Yii::t('plugins/diy', '点击选择链接');?>" :disabled="true" size="small">
