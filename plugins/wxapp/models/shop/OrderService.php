...
class OrderService extends BaseService
{
     ...
     * @czs
     */
    public function paymentParams($args)
    {
        $api = "https://api.weixin.qq.com/shop/order/getpaymentparams?access_token={$this->accessToken}";
    ...
    {
        $api = "https://api.weixin.qq.com/shop/order/close?access_token={$this->accessToken}";
        $res = $this->getClient()->httpPost($api, [], $args);
        return $this->getResult($res);
    }
