...
class GoodsForm extends Model
{
    ...
    public function search()
    {
        ...
        try {
            ...
            if (!GoodsAuth::create($bookingGoods->goods->sign)->checkShowAuth($bookingGoods->goods)) {
            ...
            $newGoods = [
                ...
                'is_video_number' => $detail['is_video_number'],
                'param_name' => $detail['param_name'],
                'param_content' => $detail['param_content'],
                'buy_goods_auth' => $detail['buy_goods_auth'],
