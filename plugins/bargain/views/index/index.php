        ...
        <div class="text item" style="width:100%">
            <el-form :model="form" label-width="150px" :rules="rule" ref="form">
                <el-tabs v-model="activeName">
                    <el-tab-pane label="<?= \Yii::t('plugins/bargain', '基础设置');?>" class="form-body" name="first">
                        <app-setting v-model="form" :is_member_price="false" :is_territorial_limitation="true"
                                     :is_coupon="true"></app-setting>

                        <el-card style="margin-bottom: 10px">
                            <div slot="header"><?= \Yii::t('plugins/bargain', '砍价规则设置');?></div>
                            <el-form-item label="<?= \Yii::t('plugins/bargain', '活动规则');?>" prop="rule">
                                <div style="width: 458px; min-height: 458px;">
                                    <app-rich-text v-model="form.rule"></app-rich-text>
                                </div>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('plugins/bargain', '活动标题');?>" prop="title">
                                <label slot="label"><?= \Yii::t('plugins/bargain', '活动标题');?>
                                    <el-tooltip class="item" effect="dark"
                                                content="<?= \Yii::t('plugins/bargain', '多个标题请换行，多个标题随机选一个标题显示');?>"
                                                placement="top">
                                        <i class="el-icon-info"></i>
                                    </el-tooltip>
                                </label>
                                <el-input class="ml-24" style="width: 600px" type="textarea" :rows="3"
                                          placeholder="<?= \Yii::t('plugins/bargain', '请输入活动标题');?>"
                                          v-model="form.title"></el-input>
                            </el-form-item>
                        </el-card>

                    </el-tab-pane>
                    <el-tab-pane v-if="false" label="<?= \Yii::t('plugins/bargain', '自定义海报');?>" class="form-body" name="second">
                        <app-poster :rule_form="form.goods_poster"
                                    :goods_component="goodsComponent"
                                    goods_component_key_tmp="head"
                        ></app-poster>
                    </el-tab-pane>
                    <el-tab-pane label="<?= \Yii::t('plugins/bargain', '轮播图');?>" class="form-body" name="third">
                    ...
                    <el-tab-pane label="<?= \Yii::t('plugins/bargain', '背景图设置');?>" name="bg">
                        <div style="display: flex;">
                            <div class="mobile-box">
                                <div class="head-bar" flex="main:center cross:center">
                                    <div><?= \Yii::t('plugins/bargain', '砍价');?></div>
                                </div>
                            ...
                            <div style="width: 100%">
                                <div style="background: #FFFFFF;padding: 30px 0px">
                                    <el-form-item label="<?= \Yii::t('plugins/bargain', '背景图');?>" prop="bg_pic">
                                        <app-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                                                        @selected="selectBgPic">
                                            <el-tooltip effect="dark"
                                                        content="<?= \Yii::t('plugins/bargain', '建议尺寸');?>:750 * 870"
                                                        placement="top">
                                                <el-button size="mini"><?= \Yii::t('plugins/bargain', '选择图标');?></el-button>
                                            </el-tooltip>
                                        </app-attachment>
                                        ...
                                        <el-button size="mini" @click="resetImg('bg_pic')"
                                            ...
                                            <?= \Yii::t('plugins/bargain', '恢复默认');?>
                                        </el-button>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('plugins/bargain', '下半部颜色配置');?>" prop="bg_color_type">
                                        <el-radio v-model="form.bg_color_type" label="pure"><?= \Yii::t('plugins/bargain', '纯色');?></el-radio>
                                        <el-radio v-model="form.bg_color_type" label="gradient"><?= \Yii::t('plugins/bargain', '渐变');?></el-radio>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('plugins/bargain', '下半部背景颜色');?>" prop="bg_color">
                                    ...
                                    <el-form-item v-if="form.bg_color_type === 'gradient'" label="<?= \Yii::t('plugins/bargain', '下半部渐变颜色配置');?>"
                                ...
                                <el-button class="button-item" :loading="btnLoading" type="primary"
                                           @click="store('form')" size="small" v-if="activeName != 'third'"><?= \Yii::t('plugins/bargain', '保存');?>
                                </el-button>
                                <el-button class="button-item" @click="reDefault"><?= \Yii::t('plugins/bargain', '恢复默认');?></el-button>
                            </div>
                ...
                <el-button class="button-item" :loading="btnLoading" type="primary" @click="store('form')" size="small"
                           v-if="activeName != 'third' && activeName != 'bg'"><?= \Yii::t('plugins/bargain', '保存');?>
                </el-button>
            </el-form>
        </div>
    </el-card>
