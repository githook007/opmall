...
class Plugin extends \app\plugins\Plugin
{
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/bargain', '砍价设置'),
...
//            ],
            [
                'name' => \Yii::t('plugins/bargain', '砍价活动'),
            ...
            [
                'name' => \Yii::t('plugins/bargain', '活动数据'),
    ...
    {
        return \Yii::t('plugins/bargain', '砍价');
    }
    ...
    public function getAppConfig()
    {
        ...
        return [
            ...
            'config' => [
                ...
                'bg_color_type' =>  $list['bg_color_type'],
                'bg_gradient_color' =>  $list['bg_gradient_color'],
            ],
        ];
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            [
                'key' => 'bargain',
                'name' => \Yii::t('plugins/bargain', '砍价列表'),
                'open_type' => 'navigate',
            ...
            [
                'key' => 'bargain',
                'name' => \Yii::t('plugins/bargain', '我的砍价'),
                'open_type' => 'navigate',
            ...
            [
                'name' => \Yii::t('plugins/bargain', '砍价商品详情'),
                'key' => 'bargain',
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-bargain-detail.png',
                'value' => '/plugins/bargain/goods/goods',
                'params' => [
                    [
                        'key' => 'goods_id',
                        'value' => '',
                        'desc' => \Yii::t('plugins/bargain', '请填写砍价商品ID'),
                        'is_required' => true,
                        'data_type' => 'number',
                        'page_url' => 'plugin/bargain/mall/goods/index',
                        'page_url_text' => \Yii::t('plugins/bargain', '商品管理->商品列表'),
                    ],
                ],
    ...
    public function getStatisticsMenus($bool = true)
    {
        return [
            ...
            'name' => $bool ? $this->getDisplayName() : \Yii::t('plugins/bargain', '插件统计'),
            'key' => $this->getName(),
    ...
    public function install()
    {
        $sql = <<<EOF
        -- v1.0.4
ALTER TABLE `op_bargain_banner` ADD COLUMN `deleted_at` timestamp NOT NULL AFTER `created_at`;
EOF;
        sql_execute($sql);
    ...
    public function getOrderInfo($orderId, $order)
    {
        ...
        if ($bargainOrder && $bargainOrder->preferential_price > 0) {
            $data = [
                'discount_list' => [
                    'bargain' => [
                        'label' => \Yii::t('plugins/bargain', '砍价优惠'),
    ...
    {
        return [
            BargainSuccessInfo::TPL_NAME => BargainSuccessInfo::class,
            BargainFailInfo::TPL_NAME => BargainFailInfo::class,
        ];
    }
