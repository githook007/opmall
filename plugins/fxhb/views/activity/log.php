...
<div id="app" v-cloak>
    <el-card  shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('plugins/fxhb', '红包记录列表');?></span>
            </div>
        </div>
        <div v-loading="listLoading">
            <el-card>
                ...
                <el-tabs v-model="search.status" @tab-click="handleClick">
                    <el-tab-pane label="<?= \Yii::t('plugins/fxhb', '全部');?>" name="-1"></el-tab-pane>
                    <el-tab-pane label="<?= \Yii::t('plugins/fxhb', '进行中');?>" name="0"></el-tab-pane>
                    <el-tab-pane label="<?= \Yii::t('plugins/fxhb', '成功');?>" name="1"></el-tab-pane>
                    <el-tab-pane label="<?= \Yii::t('plugins/fxhb', '失败');?>" name="2"></el-tab-pane>
                </el-tabs>
                <div class="title">
                    <div style="width: 35%;"><?= \Yii::t('plugins/fxhb', '活动详情');?></div>
                    <div style="width: 15%"><?= \Yii::t('plugins/fxhb', '总金额');?></div>
                    <div style="width: 15%"><?= \Yii::t('plugins/fxhb', '所需人数');?></div>
                    <div style="width: 10%"><?= \Yii::t('plugins/fxhb', '状态');?></div>
                    <div style="width: 25%;"><?= \Yii::t('plugins/fxhb', '参与详情');?></div>
                </div>
                        ...
                        <div style="display: flex;">
                            ...
                            <div style="width: 10%;border-left: 1px #e2e2e2 solid;">
                                <div class="item-center">
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/fxhb', '进行中');?>" placement="top">
                                        <img src="statics/img/mall/ing.png" v-if="item.status == 0" alt="">
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/fxhb', '成功');?>" placement="top">
                                        <img src="statics/img/mall/already.png" v-if="item.status == 1" alt="">
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/fxhb', '失败');?>" placement="top">
                            ...
                            <div style="width: 25%;border-left: 1px #e2e2e2 solid;padding: 0 35px;">
                                <div class="item-center" style="justify-content: flex-start">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/fxhb', '参与详情');?>" v-if="item.children.length != 0" placement="top">
                ...
                <el-dialog title="<?= \Yii::t('plugins/fxhb', 'z110');?>" :visible.sync="dialogVisible" width="30%">
                    ...
                    <div @click="more" v-if="detail.length > 5 && clickMore" class="load-more"><?= \Yii::t('plugins/fxhb', '加载更多');?></div>
                </el-dialog>
            </el-card>
        </div>
    </el-card>
