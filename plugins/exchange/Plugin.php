...
class Plugin extends \app\plugins\Plugin
{
    ...
    {
        return \Yii::t('plugins/exchange', '兑换中心');
    }
    ...
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/exchange', '设置'),
                'route' => 'plugin/exchange/mall/setting/index',
                'icon' => 'el-icon-star-on'
            ],
            [
                'name' => \Yii::t('plugins/exchange', '兑换码管理'),
            ...
            [
                'name' => \Yii::t('plugins/exchange', '兑换中心'),
                'route' => 'plugin/exchange/mall/code/index',
                'icon' => 'el-icon-star-on',
            ],
            [
                'name' => \Yii::t('plugins/exchange', '礼品卡'),
            ...
            [
                'name' => \Yii::t('plugins/exchange', '订单管理'),
    ...
    public function getPickLink()
    {
        ...
        return [
            ...
            [
                'key' => 'exchange',
                'name' => \Yii::t('plugins/exchange', '礼品卡中心'),
                'open_type' => '',
            ...
            [
                'key' => 'exchange',
                'name' => \Yii::t('plugins/exchange', '礼品卡详情'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-card-detail.png',
                'value' => '/plugins/exchange/goods/goods',
                'params' => [
                    [
                        'key' => 'goods_id',
                        'value' => '',
                        'desc' => \Yii::t('plugins/exchange', 'a97'),
                        'is_required' => true,
                        'data_type' => 'number',
                        'page_url' => '/plugin/exchange/mall/card-goods/index',
                        'page_url_text' => \Yii::t('plugins/exchange', '礼品卡'),
                    ],
                ],
