...
class MchEditForm extends MchEditFormBase
{
    ...
    {
        if (!$this->is_send_template) {
            \Yii::warning('无需发送模板消息');
            return false;
        }
        try {
            ...
            $res = TemplateList::getInstance()->getTemplateClass(AudiResultInfo::TPL_NAME)->send([
