...
class MchForm extends Model
{
    ...
    public function getDetail()
    {
        ...
        try {
            ...
            $newDetail['mchUser']['username'] = $detail->mchUser->username;
            ...
            $form = new MchSettingForm();
            $res = $form->search();
            $setting['is_mch_address'] = $res['is_mch_address'];
            ...
            if($is_coupon) {
                ...
                $common->page = 10;
                $common->mall_mch_id = $this->id;
                $res = $common->getList();
                if (!empty($res)) {
                    $format = new CommonFormat();
                    $couponList = $format->coupon();
                    $couponList['coupon_list'] = $common->getIndexData($res);
                }
            }
