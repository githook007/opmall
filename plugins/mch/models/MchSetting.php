 ...
 * @property int $web_service_type  1：其它客服，2：企业微信客服  @czs
 * @property string $enterprise_wechat_id  企业微信id   @czs
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'mch_id', 'is_share', 'is_sms', 'is_mail', 'is_print',
                'is_territorial_limitation', 'is_web_service', 'web_service_type'], 'integer'],
            [['send_type', 'enterprise_wechat_id'], 'string'],
            [['created_at'], 'safe'],
