...
//            ],
            [
                'name' => \Yii::t('plugins/ttapp', '小程序发布'),
    ...
    {
        return \Yii::t('plugins/ttapp', '抖音/头条小程序');
    }
    ...
    public function decryptData($data, $iv, $code)
    {
        ...
        return json_decode(Decrypt::decrypt($data, $iv, $session_key['session_key']), true);
    }
    ...
    {
        return TtappTemplate::find()->where(['mall_id' => \Yii::$app->mall->id])->select($param)->all();
    }
    ...
    public function install()
    {
        $sql = <<<EOF
-- v1.0.5
CREATE TABLE `op_ttapp_jump_appid` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL, `appid` varchar(64) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;
EOF;
        sql_execute($sql);
