...
<style>
    ...
    .mobile .mobile-web-top {
        width: 375px;
        height: 461.5px;
    }
    .mobile .mobile-web-bottom {
        width: 375px;
        height: 145.5px;
    }
    .mobile .svip-place {
    ...
    <el-card v-loading="loading" style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;">
        <el-form size="small" :model="detail" label-width="10rem" ref="detail" :rules="rule">
            <el-tabs class="tabs" v-model="activeName">
                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '基础配置');?>" name="first">
                    <div class="form-body">
                        <el-form-item label="<?= \Yii::t('plugins/vip_card', 'SVIP会员卡开关');?>" prop="is_scan_code_pay">
                            <el-switch v-model="detail.is_vip_card" :active-value="1"
                                       :inactive-value="0"></el-switch>
                            <div class="tip"><?= \Yii::t('plugins/vip_card', '关闭后不影响已购买的用户');?></div>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('plugins/vip_card', '是否开启短信提醒');?>" prop="is_sms">
                            <el-switch v-model="form.is_sms" :active-value="1"
                                       :inactive-value="0"></el-switch>
                            <div class="red"><?= \Yii::t('plugins/vip_card', '必须在');?>
                                <el-button type="text" @click="$navigate({r:'mall/sms/setting'}, true)">
                                    <?= \Yii::t('plugins/vip_card', '系统管理');?>
                                </el-button>
                                <?= \Yii::t('plugins/vip_card', '中开启');?>
                            </div>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('plugins/vip_card', '是否开启邮件提醒');?>" prop="is_mail">
                            <el-switch v-model="detail.is_mail" :active-value="1"
                                       :inactive-value="0"></el-switch>
                            <div class="red"><?= \Yii::t('plugins/vip_card', '必须在');?>
                                <el-button type="text" @click="$navigate({r:'mall/index/mail'}, true)">
                                    <?= \Yii::t('plugins/vip_card', '邮件通知');?>
                                </el-button>
                                <?= \Yii::t('plugins/vip_card', '中开启');?>
                            </div>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('plugins/vip_card', '支付方式');?>" prop="payment_type">
                            <label slot="label"><?= \Yii::t('plugins/vip_card', '支付方式');?>
                                <el-tooltip class="item" effect="dark"
                                            content="<?= \Yii::t('plugins/vip_card', '默认支持线上支付');?>"
                                            placement="top">
                                    <i class="el-icon-info"></i>
                                </el-tooltip>
                            </label>
                            <el-checkbox-group v-model="detail.payment_type" size="mini">
                                <el-checkbox label="online_pay" size="mini"><?= \Yii::t('plugins/vip_card', '线上支付');?></el-checkbox>
                                <el-checkbox label="balance" size="mini"><?= \Yii::t('plugins/vip_card', '余额支付');?></el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                        <el-form-item class="switch" label="<?= \Yii::t('plugins/vip_card', '显示协议');?>" prop="showTreaty">
                            <el-switch v-model="showTreaty" :active-value="1" :inactive-value="0"></el-switch>
                        </el-form-item>
                        <el-form-item class="switch" v-if="showTreaty" label="<?= \Yii::t('plugins/vip_card', '开通会员卡协议名称');?>" prop="agreement_title">
                            <el-input size="small" style="width: 590px;" v-model="detail.agreement_title" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item class="switch" v-if="showTreaty" label="<?= \Yii::t('plugins/vip_card', '协议内容');?>" prop="agreement_content">
                            <app-rich-text style="width: 590px;" v-model="detail.agreement_content"></app-rich-text>
                        </el-form-item>
                    </div>
                </el-tab-pane>
                <el-tab-pane v-if="is_show_share" label="<?= \Yii::t('plugins/vip_card', '分销设置');?>" name="second">
                    <div class="form-body">
                        <el-row>
                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '是否开启分销');?>" prop="is_share">
                                <el-switch v-model="detail.is_share" :active-value="1"
                                           :inactive-value="0"></el-switch>
                                <div class="red"><?= \Yii::t('plugins/vip_card', '必须在');?>
                                    <el-button type="text" @click="$navigate({r:'mall/share/basic'}, true)">
                                        <?= \Yii::t('plugins/vip_card', '分销中心');?>
                                    </el-button>
                                    <?= \Yii::t('plugins/vip_card', '中开启');?>
                                </div>
                            </el-form-item>
                            <template v-if="detail.is_share">
                                <el-form-item label="<?= \Yii::t('plugins/vip_card', '购买成为分销商');?>" prop="is_buy_become_share">
                                    <el-switch v-model="detail.is_buy_become_share" :active-value="1"
                                               :inactive-value="0"></el-switch>
                                </el-form-item>
                                <el-form-item label="<?= \Yii::t('plugins/vip_card', '分销佣金类型');?>" prop="share_type">
                                    <el-radio v-model="detail.share_type" :label="2"><?= \Yii::t('plugins/vip_card', '固定金额');?></el-radio>
                                    <el-radio v-model="detail.share_type" :label="1"><?= \Yii::t('plugins/vip_card', '百分比');?></el-radio>
                                </el-form-item>
                ...
                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '页面设置');?>" name="third">
                    <div flex="dir:left">
                        <div class="mobile">
                            ...
                            <div v-if="activePage == 'enter'" style="height: 668px;position: absolute;overflow-x: hidden;overflow-y: auto;left: 25px">
                                <img class="mobile-web-top" src="<?= $iconBaseUrl ?>/goods-detail-top.png" alt="">
                                <div class="svip-place" v-if="!form.hidden"></div>
                                <img class="mobile-web-bottom" src="<?= $iconBaseUrl ?>/goods-detail-bottom.png" alt="">
                                <div class="buy-user-info" v-if="!form.hidden">
                            ...
                            <div v-if="activePage != 'enter'" class="mobile-foot">
                                <div :class="activePage == 'bottom'? 'bottom-border': 'bottom-no-border'">
                                    <div class="mobile-foot-button" flex="dir:left">
                                        <div :style="{'background-color': form.bottom_style_1, 'color': form.bottom_style_2}"><span>￥99</span>/<?= \Yii::t('plugins/vip_card', '有效期365天');?></div>
                                        <div :style="{'background-color': form.bottom_btn_style_1,'color': form.bottom_btn_style_2}"><?= \Yii::t('plugins/vip_card', '立即开通');?></div>
                                    </div>
                                    <div class="bottom-read" flex="main:center cross:center">
                                        ...
                                        <div :style="{'color': form.bottom_btn_style_2}"><?= \Yii::t('plugins/vip_card', '我已仔细阅读并同意');?><span :style="{'color': form.bottom_btn_style_1}"><?= \Yii::t('plugins/vip_card', '开通协议');?></span></div>
                                    </div>
                                </div>
                            </div>
                            <!-- 中间排版 -->
                                ...
                                <div v-for="(item,index) in form.sort">
                                    ...
                                    <div v-if="item == 'member'" id="member" :class="activeMiddle == 1? 'active-border': 'active-no-border'" style="position: relative">
                                        ...
                                        <div style="position: absolute;top: 24px;left: 0;width: 375px" class="mobile-title" flex="main:center cross:center">
                                            ...
                                            <div :style="{'color': form.vip_color}"><?= \Yii::t('plugins/vip_card', '会员专享');?></div>
                                    ...
                                    <div v-if="item == 'right'" id="right" :class="activeMiddle == 2? 'active-border': 'active-no-border'" style="position: relative">
                                        ...
                                        <div class="mobile-item" style="padding: 24px 16px 10px">
                                            <div class="mobile-title" flex="main:center cross:center">
                                                <img src="statics/img/app/vip_card/left.png" alt="">
                                                <div><?= \Yii::t('plugins/vip_card', '会员特权');?></div>
                                                <img src="statics/img/app/vip_card/right.png" alt="">
                                            </div>
                        ...
                        <div class="form-body" style="padding: 10px 0;margin-left: 450px;width: 100%">
                            <el-tabs v-model="activePage" @tab-click="handleClick">
                                <el-tab-pane label="商品详情页" name="enter">
                                    <template>
                                        <el-card shadow="never" class="box-card">
                                            ...
                                            <el-form label-position="left">
                                                <el-form-item label="隐藏卡片" prop="detail_show">
                                                    <el-switch v-model="form.hidden"></el-switch>
                                                </el-form-item>
                                                <el-form-item v-if="!form.hidden" class="user-label" label="未购买用户" prop="buy_user">
                                            ...
                                            <el-form v-if="!form.hidden" label-position="left">
                                ...
                                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '头部样式');?>" name="head">
                                    <el-card shadow="never" class="box-card">
                                        <div slot="header" class="clearfix">
                                            <span><?= \Yii::t('plugins/vip_card', '头部样式设置');?></span>
                                        </div>
                                        <el-form label-width="120px">
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '卡片样式');?>" prop="head_card">
                                                <div style="position: relative">
                                                    <app-attachment :multiple="false" :max="1" @selected="headPicUrl">
                                                        <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/vip_card', '建议尺寸');?>:702*360" placement="top">
                                                            <el-button size="mini"><?= \Yii::t('plugins/vip_card', '选择文件');?></el-button>
                                                        </el-tooltip>
                                                    </app-attachment>
                                                    <div style="margin: 10px 0;position: relative;width: 80px;">
                                                        <app-image width="80px"
                                                    ...
                                                    <el-button size="mini" @click="resetImg(2,'head')" class="reset" type="primary"><?= \Yii::t('plugins/vip_card', '恢复默认');?></el-button>
                                                </div>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '卡片背景颜色');?>" prop="card_bg">
                                                <el-color-picker class="color-picker" style="margin-top: 10px;" size="small" v-model="form.card_bg"></el-color-picker>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '卡片文字颜色');?>" prop="card_color">
                                                <el-color-picker class="color-picker" style="margin-top: 10px;" size="small" v-model="form.card_color"></el-color-picker>
                                            </el-form-item>
                                        </el-form>
                                    </el-card>
                                </el-tab-pane>
                                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '中间排版');?>" name="middle">
                                    <div flex="dir:left" style="margin: 30px 30px 10px;">
                                        <div :class="activeMiddle == 1 ? 'active-middle':'middle-item'" @click="chooseMiddle(1)" flex="dir:top main:center cross:center">
                                            ...
                                            <div><?= \Yii::t('plugins/vip_card', '会员专享');?></div>
                                        </div>
                                        ...
                                        <div :class="activeMiddle == 3 ? 'active-middle':'middle-item'" @click="chooseMiddle(3)" flex="dir:top main:center cross:center">
                                            ...
                                            <div><?= \Yii::t('plugins/vip_card', '开卡即赠');?></div>
                                        </div>
                                        <div :class="activeMiddle == 4 ? 'active-middle':'middle-item'" @click="chooseMiddle(4)" flex="dir:top main:center cross:center">
                                            ...
                                            <div><?= \Yii::t('plugins/vip_card', '图片广告');?></div>
                                        </div>
                                    </div>
                                    <el-card v-if="activeMiddle > 0" shadow="never" class="box-card middle-card" :style="{'width': activeMiddle == 4 ? '625px': '480px'}">
                                        <div slot="header" class="clearfix">
                                            <span v-if="activeMiddle == 1"><?= \Yii::t('plugins/vip_card', '会员专享设置');?></span>
                                            <span v-else-if="activeMiddle == 2"><?= \Yii::t('plugins/vip_card', '会员特权设置');?></span>
                                            <span v-else-if="activeMiddle == 3"><?= \Yii::t('plugins/vip_card', '开卡即赠设置');?></span>
                                            <span v-else-if="activeMiddle == 4"><?= \Yii::t('plugins/vip_card', '图片广告设置');?></span>
                                        </div>
                                        <el-form v-if="activeMiddle == 1" label-width="120px" @submit.native.prevent>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '背景颜色');?>" prop="vip_bg">
                                                <el-color-picker style="margin-top: 10px;" size="small" v-model="form.vip_bg"></el-color-picker>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '文字颜色');?>" prop="vip_color">
                                                <el-color-picker style="margin-top: 10px;" size="small" v-model="form.vip_color"></el-color-picker>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '每页行数');?>" prop="vip_line">
                                                <el-input @change="changeLine" style="width: 240px" size="small" min="1" max="100" v-model="form.vip_line" type="number"></el-input>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '每行个数');?>" prop="vip_number">
                                            ...
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '左右滑动');?>" prop="is_vip_scroll">
                                                <el-switch @change="openScroll" v-model="is_vip_scroll"></el-switch>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '会员专享图标');?>" prop="vip_icon">
                                                ...
                                                <el-button size="small" @click="addIcon"><?= \Yii::t('plugins/vip_card', '添加图标');?></el-button>
                                            </el-form-item>
                                        </el-form>
                                        <el-form v-if="activeMiddle == 2" label-width="120px" @submit.native.prevent>
                                            <div class="vip-icon-list" flex="dir:left" style="width: 410px;margin-left: 30px" v-for="(item,index) in form.right_list">
                                                ...
                                                <div>
                                                    <div style="margin-bottom: 5px;" flex="dir:left cross:center">
                                                        <el-input maxlength="4" style="margin-left: 10px;width: 240px" size="small" v-model="item.big" placeholder="<?= \Yii::t('plugins/vip_card', '大标题字符限制4');?>"></el-input>
                                                        <el-color-picker class="color-picker" size="small" v-model="item.big_color"></el-color-picker>
                                                    </div>
                                                    <div flex="dir:left cross:center">
                                                        <el-input maxlength="6" style="margin-left: 10px;width: 240px" size="small" v-model="item.small" placeholder="<?= \Yii::t('plugins/vip_card', '小标题字符限制6');?>"></el-input>
                                            ...
                                            <el-button v-if="form.right_list.length < 20" style="margin-left: 30px" size="small" @click="addRight"><?= \Yii::t('plugins/vip_card', '添加图标');?></el-button>
                                        </el-form>
                                        <el-form v-if="activeMiddle == 3" label-width="60px" @submit.native.prevent>
                                            <el-form-item label="积分" prop="integral_icon">
                                                <div style="position: relative">
                                                    ...
                                                    <el-button size="mini" @click="resetImg(2,'integral')" class="reset" type="primary"><?= \Yii::t('plugins/vip_card', '恢复默认');?></el-button>
                                                </div>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '余额');?>" prop="balance_icon">
                                                <div style="position: relative">
                                                    ...
                                                    <el-button size="mini" @click="resetImg(2,'balance')" class="reset" type="primary"><?= \Yii::t('plugins/vip_card', '恢复默认');?></el-button>
                                                </div>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '优惠券');?>" prop="coupon_icon">
                                                <div style="position: relative">
                                                    ...
                                                    <el-button size="mini" @click="resetImg(2,'coupon')" class="reset" type="primary"><?= \Yii::t('plugins/vip_card', '恢复默认');?></el-button>
                                                </div>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '卡券');?>" prop="card_icon">
                                                <div style="position: relative">
                                                    ...
                                                    <el-button size="mini" @click="resetImg(2,'card')" class="reset" type="primary"><?= \Yii::t('plugins/vip_card', '恢复默认');?></el-button>
                                                </div>
                                            </el-form-item>
                                        </el-form>
                                        <el-form v-if="activeMiddle == 4" label-width="80px" @submit.native.prevent>
                                            <el-tabs v-model="middleName" type="card">
                                                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '图片样式');?>" name="css">
                                                    <el-form-item label="<?= \Yii::t('plugins/vip_card', '样式');?>">
                                                ...
                                                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '图片上传');?>" name="upload">
                                                    <template v-if="chooseIndex != null">
                                                        <el-card shadow="never">
                                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '图片上传');?>">
                                                                <app-attachment :multiple="false" :max="1" v-model="form.rubik.list[chooseIndex].pic">
                                                                    <el-button size="mini"><?= \Yii::t('plugins/vip_card', '选择图片');?></el-button>
                                                                </app-attachment>
                                                            ...
                                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '选择链接');?>">
                                                                <app-pick-link title="<?= \Yii::t('plugins/vip_card', '选择链接');?>" @selected="selectLink">
                                                                    <el-input size="small" v-model="form.rubik.list[chooseIndex].url" :disabled="true">
                                                                        <template slot="append">
                                                                            <el-button><?= \Yii::t('plugins/vip_card', '选择链接');?></el-button>
                                                                        </template>
                                                                    </el-input>
                                                                </app-pick-link>
                                                            </el-form-item>
                                                    ...
                                                    <template v-else>
                                                        <el-form-item label="<?= \Yii::t('plugins/vip_card', '图片上传');?>">
                                                            <span><?= \Yii::t('plugins/vip_card', '请先在左边选择图片位置');?></span>
                                                        </el-form-item>
                                                    </template>
                                                </el-tab-pane>
                                            </el-tabs>
                                ...
                                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '底部样式');?>" name="bottom">
                                    <el-card shadow="never" class="box-card">
                                        <div slot="header" class="clearfix">
                                            <span><?= \Yii::t('plugins/vip_card', '底部样式设置');?></span>
                                        </div>
                                        <el-form label-width="120px">
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '文字颜色');?>" prop="bottom_style_2">
                                                <el-color-picker class="color-picker" style="margin-top: 10px;" size="small" v-model="form.bottom_style_2"></el-color-picker>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '背景颜色');?>" prop="bottom_style_1">
                                                <el-color-picker class="color-picker" style="margin-top: 10px;" size="small" v-model="form.bottom_style_1"></el-color-picker>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '按钮文字颜色');?>" prop="bottom_btn_style_2">
                                                <el-color-picker class="color-picker" style="margin-top: 10px;" size="small" v-model="form.bottom_btn_style_2"></el-color-picker>
                                            </el-form-item>
                                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '按钮背景颜色');?>" prop="bottom_btn_style_1">
                                                <el-color-picker class="color-picker" style="margin-top: 10px;" size="small" v-model="form.bottom_btn_style_1"></el-color-picker>
                                            </el-form-item>
                                        </el-form>
                                    </el-card>
                                </el-tab-pane>
                                <el-button :loading="btnLoading" class="third-button-item button-item" type="primary" @click="store('form')" size="small"><?= \Yii::t('plugins/vip_card', '保存');?></el-button>
                                <el-button v-if="hideBtn" :loading="btnLoading" class="third-button-item reset-btn button-item" @click="resetSetting" size="small"><?= \Yii::t('plugins/vip_card', '恢复默认');?></el-button>
                            </el-tabs>
                        </div>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="<?= \Yii::t('plugins/vip_card', '下单表单');?>" name="four">
                    <div class="form-body">
                        <el-row>
                            <el-form-item label="<?= \Yii::t('plugins/vip_card', '表单状态');?>">
                                <el-switch
                            ...
                            <el-form-item v-if="detail.is_order_form"  label="<?= \Yii::t('plugins/vip_card', '表单设置');?>" prop="selectedOptions">
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                form: {
                    hidden: true,
                    buy_big_color: '#492C01',
                    buy_small_color: '#FF0000',
                    buy_btn_color: '#492C01',
                    buy_btn_bg_color: '',
                    buy_big: '开通超级会员，立省更多',
                    buy_small: '超值全场8.8折！',
                    buy_btn_text: '立即开通',
                    renew_text_color: '#492C01',
                    renew_btn_bg_color: '',
                    ...
                    is_vip_scroll: 0,
                    vip_icon_list: [[
                        {img: 'statics/img/app/vip_card/icon1.png', name: '<?= \Yii::t('plugins/vip_card', '全场包邮');?>'},
                        {img: 'statics/img/app/vip_card/icon2.png', name: '<?= \Yii::t('plugins/vip_card', '专属折扣');?>'},
                        {img: 'statics/img/app/vip_card/icon3.png', name: '<?= \Yii::t('plugins/vip_card', '大额积分');?>'},
                        {img: 'statics/img/app/vip_card/icon4.png', name: '<?= \Yii::t('plugins/vip_card', '余额红包');?>'},
                        {img: 'statics/img/app/vip_card/icon5.png', name: '<?= \Yii::t('plugins/vip_card', '海量优惠券');?>'},
                        {img: 'statics/img/app/vip_card/icon6.png', name: '<?= \Yii::t('plugins/vip_card', '获赠卡券');?>'},
                        {img: 'statics/img/app/vip_card/icon7.png', name: '<?= \Yii::t('plugins/vip_card', '敬请期待');?>'}
                    ]],
                    right_list: [
                        {img: 'statics/img/app/vip_card/off.png', big: '<?= \Yii::t('plugins/vip_card', '专属折扣');?>',big_color: '#FFFFFF',small:'<?= \Yii::t('plugins/vip_card', '省上加省');?>',small_color: '#FFFFFF'},
                        {img: 'statics/img/app/vip_card/free-shipping.png', big: '<?= \Yii::t('plugins/vip_card', '全场包邮');?>',big_color: '#FFFFFF',small:'<?= \Yii::t('plugins/vip_card', '畅享购物');?>',small_color: '#FFFFFF'},
                    ],
                    rubik: {
                        height: 180,
                        list: []
                    ...
                    buy_bg: '<?=$baseUrl; ?>statics/img/app/vip_card/buy_bg_1.png',
                    renew_bg: '<?=$baseUrl; ?>statics/img/app/vip_card/buy_bg_1.png',
                ...
                style_list: [
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '1张图');?>',
                        height: 180,
                        list: [
                            {
                                w: 375,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '2张图');?>',
                        height: 180,
                        list: [
                            {
                                w: 150,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '3张图');?>',
                        height: 180,
                        list: [
                            {
                                w: 150,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '4张图');?>',
                        height: 180,
                        list: [
                            {
                                w: 150,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '2张图平分');?>',
                        height: 120,
                        list: [
                            {
                                w: 187.5,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '3张图平分');?>',
                        height: 120,
                        list: [
                            {
                                w: 125,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '4张图左右平分');?>',
                        height: 188,
                        list: [
                            {
                                w: 96,
                    ...
                    {
                        name: '<?= \Yii::t('plugins/vip_card', '4张图上下平分');?>',
                        height: 200,
                        list: [
                            {
                                w: 187.5,
        ...
        methods: {
            ...
            getShareSetting() {
                ...
                request({
                    ...
                    if (e.data.code == 0) {
                        let shareArr = [
                            {
                                label: '<?= \Yii::t('plugins/vip_card', '一级分销');?>',
                                value: 'share_commission_first'
                            },
                            {
                                label: '<?= \Yii::t('plugins/vip_card', '二级分销');?>',
                                value: 'share_commission_second'
                            },
                            {
                                label: '<?= \Yii::t('plugins/vip_card', '三级分销');?>',
            ...
            resetImg(res,position) {
                switch(position) {
                     case 'buy':
                        if(res == 2) {
                            this.buy_bg = '<?=$baseUrl; ?>statics/img/app/vip_card/buy_bg_1.png';
                            this.form.buy_bg = '<?=$baseUrl; ?>statics/img/app/vip_card/buy_bg_1.png';
                        }else {
                            this.buy_bg = '';
                            this.form.buy_bg = '';
                        }
                     ...
                     case 'renew':
                        if(res == 2) {
                            this.renew_bg = '<?=$baseUrl; ?>statics/img/app/vip_card/buy_bg_1.png';
                            this.form.renew_bg = '<?=$baseUrl; ?>statics/img/app/vip_card/buy_bg_1.png';
                        }else {
                            this.renew_bg = '';
                            this.form.renew_bg = '';
                        }
