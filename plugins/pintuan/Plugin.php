...
use app\plugins\pintuan\forms\common\LimitBuy;
use app\plugins\pintuan\forms\common\v2\PintuanFailInfo;
use app\plugins\pintuan\forms\common\v2\PintuanSuccessInfo;
...
class Plugin extends \app\plugins\Plugin
{
    ...
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/pintuan', '拼团设置'),
...
//            ],
            [
                'name' => \Yii::t('plugins/pintuan', '拼团活动'),
            ...
            [
                'name' => \Yii::t('plugins/pintuan', '活动数据'),
...
//            ],
    ...
    {
        return \Yii::t('plugins/pintuan', '拼团');
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            [
                'key' => 'pintuan',
                'name' => \Yii::t('plugins/pintuan', '拼团首页'),
                'open_type' => '',
            ...
            [
                'key' => 'pintuan',
                'name' => \Yii::t('plugins/pintuan', '我的拼团'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-pintuan-my.png',
                'value' => '/plugins/pt/order/order',
            ],
            [
                'key' => 'pintuan',
                'name' => \Yii::t('plugins/pintuan', '拼团商品详情'),
                'open_type' => '',
                'icon' => $iconBaseUrl . '/icon-pintuan-goods.png',
                'value' => '/plugins/pt/goods/goods',
                'params' => [
                    [
                        'key' => 'goods_id',
                        'value' => '',
                        'desc' => \Yii::t('plugins/pintuan', '请填写拼团商品ID'),
                        'is_required' => true,
                        'data_type' => 'number',
                        'page_url' => 'plugin/pintuan/mall/activity/index',
                        'page_url_text' => \Yii::t('plugins/pintuan', '商品列表')
                    ]
                ],
    ...
    public function getStatisticsMenus($bool = true)
    {
        return [
            ...
            'name' => $bool ? $this->getDisplayName() : \Yii::t('plugins/pintuan', '插件统计'),
            'key' => $this->getName(),
    ...
    {
        $sql = <<<EOF
alter table `op_pintuan_order_relation` add cancel_status tinyint(1) not NULL default '0' COMMENT '拼团订单取消状态:0.未取消|1.超出拼团总人数取消';
EOF;
        sql_execute($sql);
    ...
    {
        return [
            PintuanFailInfo::TPL_NAME => PintuanFailInfo::class,
            PintuanSuccessInfo::TPL_NAME => PintuanSuccessInfo::class,
        ];
    }
