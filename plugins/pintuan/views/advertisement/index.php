...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div slot="header">
            <div>
                <span><?= \Yii::t('plugins/pintuan', '拼团广告');?></span>
            </div>
        </div>
        <div class="form-body">
                    ...
                    <template v-if="ruleForm.advertisement.list.length > 0">
                        <el-row v-for="(item,index) in ruleForm.advertisement.list"
                            ...
                            <el-col :span="2" style="min-width: 100px">
                                <el-tooltip class="item" effect="dark" :content="'<?= \Yii::t('plugins/pintuan', '建议尺寸');?>'+item.size" placement="top">
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                rules: {
                    type: [
                        {required: true, message: '<?= \Yii::t('plugins/pintuan', '请选择样式');?>', trigger: 'change'},
                    ],
                },
                btnLoading: false,
                cardLoading: false,
