        ...
        <div class="text item" style="width:100%">
            <el-form :model="form" :rules="rules" label-width="150px"  ref="form">
                <el-tabs v-model="activeName">
                    ...
                    <el-tab-pane label="<?= \Yii::t('plugins/gift', '基本设置');?>"  name="first">
                        <el-card style="margin-bottom: 10px">
                            <div slot="header"><?= \Yii::t('plugins/gift', '基础设置');?></div>

                            <el-form-item label="<?= \Yii::t('plugins/gift', '页面标题');?>" prop="title">
                                <el-input
                                        v-model="form.title"
                                        class="input-len"
                                        maxlength="12"
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/gift', '自动退款');?>" prop="auto_refund">
                                <label slot="label"><?= \Yii::t('plugins/gift', '自动退款');?>
                                    <el-tooltip class="item" effect="dark"
                                                content="<?= \Yii::t('plugins/gift', '超出设置时间');?>"
                                                placement="top">
                                ...
                                <div>
                                    <el-input type="number" min="1" max="30" class="input-len-i" v-model.number="form.auto_refund">
                                        <template slot="append"><?= \Yii::t('plugins/gift', '天');?></template>
                                    </el-input>
                                    <span class="ml-24" style="margin-left: 15px;">
                                    <?= \Yii::t('plugins/gift', '未领取自动退款');?>
                                    </span>
                                </div>
                            </el-form-item>
                        </el-card>
                        <el-card style="margin-bottom: 10px">
                            <div slot="header"><?= \Yii::t('plugins/gift', '玩法设置');?></div>

                            <el-form-item label="<?= \Yii::t('plugins/gift', '选择玩法');?>" prop="type" >
                                <label slot="label"><?= \Yii::t('plugins/gift', '选择玩法');?>
                                </label>
                                <el-checkbox-group v-model="form.type" size="mini">
                                    <el-checkbox label="direct_open" size="mini"><?= \Yii::t('plugins/gift', '直接送礼');?></el-checkbox>
                                    <el-checkbox label="time_open" size="mini"><?= \Yii::t('plugins/gift', '定时开奖');?></el-checkbox>
                                    <el-checkbox label="num_open" size="mini"><?= \Yii::t('plugins/gift', '满人开奖');?></el-checkbox>
                                </el-checkbox-group>
                            </el-form-item>

                            <el-form-item label="<?= \Yii::t('plugins/gift', '送礼未成功提醒');?>" prop="auto_remind">
                                <label slot="label"><?= \Yii::t('plugins/gift', '送礼未成功提醒');?>
                                    <el-tooltip class="item" effect="dark"
                                                content="<?= \Yii::t('plugins/gift', '领取的礼物未填写地址');?>"
                                                placement="top">
                                        <i class="el-icon-info"></i>
                                    </el-tooltip>
                                </label>
                                <div>
                                    ...
                                    <span class="ml-24" style="margin-left: 15px;">
                                    <?= \Yii::t('plugins/gift', '未填写收货地址');?>
                                    </span>
                                </div>
                            </el-form-item>

                            <el-form-item label="<?= \Yii::t('plugins/gift', '送礼祝福语');?>" prop="bless_word">
                                <el-input
                                        type="text"
                                        placeholder="<?= \Yii::t('plugins/gift', '请输入内容');?>"
                            ...
                            <el-form-item label="<?= \Yii::t('plugins/gift', '求礼话术语');?>" prop="ask_gift">
                                <el-input
                                        type="text"
                                        placeholder="<?= \Yii::t('plugins/gift', '请输入内容');?>"
                        ...
                        <el-card style="margin-bottom: 10px">
                            <div slot="header"><?= \Yii::t('plugins/gift', '社交送礼规则设置');?></div>
                            <el-form-item label="<?= \Yii::t('plugins/gift', '规则说明');?>">
                    ...
                    <el-tab-pane label="<?= \Yii::t('plugins/gift', '自定义分享海报');?>" class="form-body" name="second" style="background:none;padding:0">
                        ...
                        >
                            <el-button slot="more-button" size="mini" @click="reset('poster')" style="margin-left: 10px">
                                <?= \Yii::t('plugins/gift', '恢复默认');?>
                            </el-button>
                            <div slot="step_poster">
                                <el-form-item label="<?= \Yii::t('plugins/gift', '多个商品礼包图');?>">
                                    <app-attachment :multiple="false" :max="1"
                                                    v-model="form.poster.pic.pic_url">
                                        <el-button><?= \Yii::t('plugins/gift', '选择图片');?></el-button>
                            ...
                            <span slot="desc-text-slot"
                                ...
                                <?= \Yii::t('plugins/gift', '7天内无人领取将自动退款');?>
                            </span>
                        </app-poster>
                    </el-tab-pane>

                    <el-tab-pane label="<?= \Yii::t('plugins/gift', '自定义背景');?>" name="third">
                        <div flex="">
                            <div class="iphone" :style="{backgroundImage: `url(${pic_url})`}">
                                <div class="background-iphone" :style="{backgroundImage: `url(${form.background.bg_pic})`}">
                                    ...
                                    <div class="background-text" :style="{color: form.background.color, top: `${form.background.top}px`, left: `${form.background.left}px`}">
                                        <p style="font-size: 14px;margin-bottom: 6px;line-height: 1;"><?= \Yii::t('plugins/gift', '打篮球的小明');?></p>
                                        <p style="font-size: 14px;margin-bottom: 26px;line-height: 1;"><?= \Yii::t('plugins/gift', '送你一份礼物');?></p>
                                        <p style="line-height: 1;"><?= \Yii::t('plugins/gift', '大吉大利');?></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div flex="dir:left" style="margin-bottom: 15px">
                                    <app-attachment :multiple="false" :max="1"
                                        ...
                                        <el-tooltip class="item"
                                                    ...
                                                    placement="top">
                                            <el-button size="mini">
                                                {{form.background.bg_pic ? '<?= \Yii::t('plugins/gift', '更换背景图');?>' : '<?= \Yii::t('plugins/gift', '添加背景图');?>'}}
                                            </el-button>
                                        </el-tooltip>
                                    </app-attachment>
                                    ...
                                    <el-button v-if="form.background.bg_pic" @click="removeBgPic()"
                                               ...
                                               type="danger"
                                               size="mini">
                                        <?= \Yii::t('plugins/gift', '删除背景');?>
                                    </el-button>
                                </div>
                                <el-card shadow="never" class="box-card" style="width: 100%;">
                                    <div slot="header">
                                        <span><?= \Yii::t('plugins/gift', '文本设置');?></span>
                                    </div>
                                    <div>
                                        <el-form-item label="<?= \Yii::t('plugins/gift', '上间距');?>">
                                            <el-slider
                                                    :min=0
                                                    :max=310
                                        ...
                                        <el-form-item label="<?= \Yii::t('plugins/gift', '左间距');?>">
                                            <el-slider
                                                    :min=0
                                                    :max=132
                                        ...
                                        <el-form-item label="<?= \Yii::t('plugins/gift', '颜色');?>">
                                            <el-color-picker
                    ...
                    <el-tab-pane label="<?= \Yii::t('plugins/gift', '主题色自定义');?>" name="fourth">
                ...
                <el-button class="button-item" type="primary" :loading="btnLoading" @click="onSubmit"><?= \Yii::t('plugins/gift', '提交');?></el-button>
            </el-form>
        </div>
    </el-card>
</section>
                ...
                form: {
                    ...
                    poster: {
                        ...
                        hide_desc: {
                            ...
                            top: 487,
                            left: 113,
                            text: '<?= \Yii::t('plugins/gift', '7天内无人领取将自动退款');?>',
                ...
                theme: [
                    {
                        id: 1,
                        active: true,
                        text: '<?= \Yii::t('plugins/gift', '流金色');?>',
                        pic_url: 'streamer-gold'
                    },
                    {
                        id: 2,
                        active: false,
                        text: '<?= \Yii::t('plugins/gift', '浪漫粉');?>',
                        pic_url: 'romantic-powder'
                    },
                    {
                        id: 3,
                        active: false,
                        text: '<?= \Yii::t('plugins/gift', '热情红');?>',
                        pic_url: 'taste-red'
                    },
                    {
                        id: 4,
                        active: false,
                        text: '<?= \Yii::t('plugins/gift', '优雅紫');?>',
                        pic_url: 'elegant-purple'
                    },
                    {
                        id: 5,
                        active: false,
                        text: '<?= \Yii::t('plugins/gift', '清新绿');?>',
                        pic_url: 'fresh-green'
                    },
                    {
                        id: 6,
                        active: false,
                        text: '<?= \Yii::t('plugins/gift', '商务蓝');?>',
                        pic_url: 'business-blue'
                    }
                ],
                rules: {
                    type: [
                        { required: true, message: '<?= \Yii::t('plugins/gift', '请选择玩法');?>', trigger: 'change' },
                    ],
                    auto_remind: [
                        {
                            required: true,
                            type: 'number',
                            message: '<?= \Yii::t('plugins/gift', '请输入送礼未成功提醒时间');?>',
                            trigger: 'blur' },
                        {
                            pattern: /^30$|^([1-2]\d)$|^\d?$/,
                            message: '<?= \Yii::t('plugins/gift', '最小1天');?>'
                        }

                    ],
                    auto_refund: [
                        { required: true, message: '<?= \Yii::t('plugins/gift', '请输入自动退款时间');?>', trigger: 'blur',  type: 'number',},
                        {
                            pattern: /^30$|^([1-2]\d)$|^\d?$/,
                            message: '<?= \Yii::t('plugins/gift', '最小1天');?>'
                        },
                    ...
                    payment_type: [
                        { required: true, message: '<?= \Yii::t('plugins/gift', '请选择支付方式');?>', trigger: 'change' },
                    ],
                    send_type: [
                        { required: true, message: '<?= \Yii::t('plugins/gift', '请选择发货方式');?>', trigger: 'change' },
                    ],
                    bless_word: [
                        { required: true, message: '<?= \Yii::t('plugins/gift', '请输入自动送礼祝福语');?>', trigger: 'blur' },
                    ],
                    ask_gift: [
                        { required: true, message: '<?= \Yii::t('plugins/gift', '请输入求礼话术语');?>', trigger: 'blur' },
                    ],
                    title: [
                        {required: true, message: '<?= \Yii::t('plugins/gift', '请输入标题');?>', trigger: 'change' }
                    ]
                },
                defaultObj: {},
            };
