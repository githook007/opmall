...
class Plugin extends \app\plugins\Plugin
{
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/teller', '基础设置'),
                'icon' => 'el-icon-star-on',
                'route' => 'plugin/teller/mall/index/index',
            ],
            [
                'name' => \Yii::t('plugins/teller', '收银员'),
                'icon' => 'el-icon-star-on',
            ...
            [
                'name' => \Yii::t('plugins/teller', '业绩明细'),
                'icon' => 'el-icon-star-on',
                'route' => 'plugin/teller/mall/push/index',
            ],
            [
                'name' => \Yii::t('plugins/teller', '交班记录'),
                'icon' => 'el-icon-star-on',
            ...
            [
                'name' => \Yii::t('plugins/teller', '打印设置'),
                'icon' => 'el-icon-star-on',
    ...
    {
        return \Yii::t('plugins/teller', '收银台');
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            [
                'key' => 'teller',
                'name' => \Yii::t('plugins/teller', '动态付款码'),
                'open_type' => '',
