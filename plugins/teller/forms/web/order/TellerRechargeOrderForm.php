...
class TellerRechargeOrderForm extends Model
{
    ...
    public function balanceRecharge()
    {
        ...
        try {            
            ...
            $wechatScan = \app\bootstrap\payment\Payment::PAY_TYPE_WECHAT_SCAN;
            $alipayScan = \app\bootstrap\payment\Payment::PAY_TYPE_ALIPAY_SCAN;
            $pos = \app\bootstrap\payment\Payment::PAY_TYPE_POS;
            $cash = \app\bootstrap\payment\Payment::PAY_TYPE_CASH;
