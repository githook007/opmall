    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <el-table v-loading="listLoading" :data="list" border>
                <el-table-column prop="number" label="<?= \Yii::t('plugins/teller', '收银员编号');?>" width="100"></el-table-column>
                ...
                <el-table-column prop="username" label="<?= \Yii::t('plugins/teller', '账号');?>"></el-table-column>
                ...
                <el-table-column prop="id" label="<?= \Yii::t('plugins/teller', '业绩');?>">
                ...
                <el-table-column label="<?= \Yii::t('plugins/teller', '操作');?>" width="280" fixed="right">
                    <template slot-scope="scope">
                        <el-button size="mini" type="text" @click="navTest(scope.row)" circle>
                            <el-tooltip class="item" effect="dark" content="<?= \Yii::t('plugins/teller', '修改密码');?>" placement="top">
        ...
        <el-dialog title="<?= \Yii::t('plugins/teller', '修改密码');?>" :visible.sync="pFormVisible" width="30%" :close-on-click-modal="false">
            <el-form :model="pForm" label-width="100px" :rules="pFormRules" ref="pForm">
                <el-form-item label="<?= \Yii::t('plugins/teller', '修改密码');?>" prop="password">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click.native="pFormVisible = false" :loading="btnLoading"><?= \Yii::t('plugins/teller', '取消');?></el-button>
                <el-button size="small" type="primary" @click.native="pSubmit" :loading="btnLoading"><?= \Yii::t('plugins/teller', '提交');?></el-button>
            </div>
        </el-dialog>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            destroy(params, index) {
                this.$confirm('<?= \Yii::t('plugins/teller', '是否删除该收银员');?>', '<?= \Yii::t('plugins/teller', '提示');?>', {
