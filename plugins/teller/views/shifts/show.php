...
<div id="app" v-cloak>
        ...
        <el-breadcrumb separator="/">
            <el-breadcrumb-item>
                 <span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'plugin/teller/mall/shifts/index'})">
                    <?= \Yii::t('plugins/teller', '交班记录');?>
                 </span>
            </el-breadcrumb-item>
            <el-breadcrumb-item><?= \Yii::t('plugins/teller', '交班详情');?></el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    ...
    <el-card shadow="never" class="y-card" body-style="background-color: #ffffff;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('plugins/teller', '交班详情');?></span>
                <el-button type="primary" size="small" style="float: right;margin-top: -5px" @click="showPrintDialog">
                    <?= \Yii::t('plugins/teller', '打印交班小票');?>
                </el-button>
            </div>
        </div>
        <div v-loading="detail_listLoading" class="form-body">
            <div class="d-text">
                <div><?= \Yii::t('plugins/teller', '班次');?>{{detail_list.start_time}} ~ {{detail_list.end_time}}</div>
                <div><?= \Yii::t('plugins/teller', '收银员编号');?>{{detail_list.number}}</div>
                <div><?= \Yii::t('plugins/teller', '姓名');?>{{detail_list.name}}</div>
            </div>
            <el-table :data="[detail_list.proceeds]" style="width: 80%;margin-top: 24px" border>
                <el-table-column prop="total_proceeds" label="<?= \Yii::t('plugins/teller', '收款总额');?>"></el-table-column>
                <el-table-column prop="total_order" label="<?= \Yii::t('plugins/teller', '订单数');?>"></el-table-column>
                <el-table-column prop="cash_proceeds" label="<?= \Yii::t('plugins/teller', '现金');?>"></el-table-column>
                <el-table-column prop="wechat_proceeds" label="<?= \Yii::t('plugins/teller', '微信');?>"></el-table-column>
                <el-table-column prop="alipay_proceeds" label="<?= \Yii::t('plugins/teller', '支付宝');?>"></el-table-column>
                <el-table-column prop="balance_proceeds" label="<?= \Yii::t('plugins/teller', '余额');?>"></el-table-column>
                <el-table-column prop="pos_proceeds" label="<?= \Yii::t('plugins/teller', 'POS机');?>"></el-table-column>
            </el-table>
            <el-table :data="[detail_list.recharge]" style="width: 70%;margin-top: 24px" border>
                <el-table-column prop="total_recharge" label="<?= \Yii::t('plugins/teller', '充值总额');?>"></el-table-column>
                <el-table-column prop="total_order" label="<?= \Yii::t('plugins/teller', '订单数');?>"></el-table-column>
                <el-table-column prop="cash_recharge" label="<?= \Yii::t('plugins/teller', '现金');?>"></el-table-column>
                <el-table-column prop="wechat_recharge" label="<?= \Yii::t('plugins/teller', '微信');?>"></el-table-column>
                <el-table-column prop="alipay_recharge" label="<?= \Yii::t('plugins/teller', '支付宝');?>"></el-table-column>
                <el-table-column prop="pos_recharge" label="<?= \Yii::t('plugins/teller', 'POS机');?>"></el-table-column>
            </el-table>
            <el-table :data="[detail_list.refund]" style="width: 70%;margin-top: 24px" border>
                <el-table-column prop="total_refund" label="<?= \Yii::t('plugins/teller', '退款总额');?>"></el-table-column>
                <el-table-column prop="total_order" label="<?= \Yii::t('plugins/teller', '订单数');?>"></el-table-column>
                <el-table-column prop="cash_refund" label="<?= \Yii::t('plugins/teller', '现金');?>"></el-table-column>
                <el-table-column prop="wechat_refund" label="<?= \Yii::t('plugins/teller', '微信');?>"></el-table-column>
                <el-table-column prop="alipay_refund" label="<?= \Yii::t('plugins/teller', '支付宝');?>"></el-table-column>
                <el-table-column prop="balance_refund" label="<?= \Yii::t('plugins/teller', '余额');?>"></el-table-column>
                <el-table-column prop="pos_refund" label="<?= \Yii::t('plugins/teller', 'POS机');?>"></el-table-column>
            </el-table>
        </div>
    </el-card>
    ...
    <el-card shadow="never" class="y-card" body-style="background-color: #ffffff;padding: 10px 0 0;">
        <div slot="header">
            <div style="he">
                <span><?= \Yii::t('plugins/teller', '商品汇总');?></span>
        ...
        <div class="form-body">
            <el-col :span="24" class="toolbar" style="padding-bottom: 10px">
                <div class="input-item" style="display:inline-block;margin-left: 12px">
                    <el-input @keyup.enter.native="goods_searchList"
                              size="small"
                              placeholder="<?= \Yii::t('plugins/teller', '请输入商品ID或者名称搜索');?>"
            ...
            <el-table ref="goods" @selection-change="goodsSelectionChange" v-loading="goods_listLoading" :data="goods_list" style="width: 100%" border>
                ...
                <el-table-column prop="goods_id" sortable label="<?= \Yii::t('plugins/teller', '商品ID');?>"></el-table-column>
                <el-table-column prop="id" label="<?= \Yii::t('plugins/teller', '商品名称');?>" width="700">
                    <template slot-scope="scope">
                        <div flex="dir:left">
                            ...
                            <div style="margin-left: 12px" flex="dir:top">
                                ...
                                <div>
                                    <span><?= \Yii::t('plugins/teller', '规格');?></span>
                ...
                <el-table-column prop="goods_price" :formatter="goodsPriceFormatter" label="<?= \Yii::t('plugins/teller', '售价');?>"></el-table-column>
                <el-table-column prop="num" label="<?= \Yii::t('plugins/teller', '数量');?>"></el-table-column>
                <el-table-column prop="total_price" :formatter="totalPriceFormatter" label="<?= \Yii::t('plugins/teller', '商品小计');?>"></el-table-column>
            </el-table>
        </div>
    ...
    <el-card shadow="never" class="y-card" body-style="background-color: #ffffff;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('plugins/teller', '操作明细');?></span>
                <app-new-export-dialog-2
            ...
            <el-col :span="24" class="toolbar" style="padding-bottom: 20px">
                <div class="col-li">
                    ...
                    <el-select size="small" @change="info_searchList" v-model="info_search.order_type"
                               placeholder="<?= \Yii::t('plugins/teller', '请选择类型');?>">
                        <el-option value="" label="<?= \Yii::t('plugins/teller', '全部');?>"></el-option>
                        <el-option value="order" label="<?= \Yii::t('plugins/teller', '买单');?>"></el-option>
                        <el-option value="recharge" label="<?= \Yii::t('plugins/teller', '会员充值');?>"></el-option>
                    </el-select>
                </div>
            </el-col>
            <el-table ref="info" @selection-change="infoSelectionChange" v-loading="info_listLoading" :data="info_list" style="width: 100%" border>
                <el-table-column type="selection" width="55"></el-table-column>
                <el-table-column prop="created_at" label="<?= \Yii::t('plugins/teller', '操作时间');?>"></el-table-column>
                <el-table-column prop="order_id" label="<?= \Yii::t('plugins/teller', '订单号');?>">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="total_pay_price" label="<?= \Yii::t('plugins/teller', '金额');?>"></el-table-column>
            </el-table>
        </div>
    ...
    <el-card shadow="never" class="y-card" body-style="background-color: #ffffff;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('plugins/teller', '退款明细');?></span>
                <app-new-export-dialog-2
        ...
        <div class="form-body">
            <el-table ref="re" @selection-change="reSelectionChange" v-loading="re_listLoading" :data="re_list"
                ...
                <el-table-column type="selection" width="55"></el-table-column>
                <el-table-column prop="created_at" label="<?= \Yii::t('plugins/teller', '退款时间');?>"></el-table-column>
                <el-table-column prop="order_id" label="<?= \Yii::t('plugins/teller', 'teller_z309');?>">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="refund_type" label="<?= \Yii::t('plugins/teller', '退款方式');?>"></el-table-column>
                <el-table-column prop="refund_price" label="<?= \Yii::t('plugins/teller', '金额');?>"></el-table-column>
            </el-table>
        </div>
