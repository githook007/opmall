...
class Plugin extends \app\plugins\Plugin
{
    public function getMenus()
    {
        return [
            [
                'name' => \Yii::t('plugins/scan_code_pay', '基础设置'),
                'route' => 'plugin/scan_code_pay/mall/index',
                'icon' => 'el-icon-star-on',
            ],
            [
                'name' => \Yii::t('plugins/scan_code_pay', '买单设置'),
            ...
            [
                'name' => \Yii::t('plugins/scan_code_pay', '订单列表'),
    ...
    {
        return \Yii::t('plugins/scan_code_pay', '当面付');
    }
    ...
    public function getPickLink()
    {
        ...
        return [
            [
                'key' => 'scan_code_pay',
                'name' => \Yii::t('plugins/scan_code_pay', '当面付'),
                'open_type' => '',
            ...
            $data = [
                'discount_list' => [
                    'activity_preferential_price' => [
                        'label' => \Yii::t('plugins/scan_code_pay', '活动优惠'),
    ...
    {
        return (new CommonScanCodePaySetting())->getSetting();
    }
}
