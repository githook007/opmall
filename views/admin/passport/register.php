    ...
    <el-container class="register-box">
        <el-header height="190px" :style="'background: url('+banner+') center no-repeat;background-size: cover;'">
            <div class="title" flex="dir:left cross:center">
                ...
                <div>{{ forget ? "<?= \Yii::t('admin/passport', '重置密码');?>" : "<?= \Yii::t('admin/passport', '欢迎注册');?>"}}</div>
            </div>
            <div style="color: #7d7d7d"><?= \Yii::t('admin/passport', '已有账号');?></span><span class="login" @click="login"><?= \Yii::t('admin/passport', '登录');?></div>
        </el-header>
        <el-main>
            <el-steps v-if="!forget" :active="active" style="width:900px;margin: 65px auto" align-center>
                <el-step title="<?= \Yii::t('admin/passport', '账号信息');?>"></el-step>
                <el-step title="<?= \Yii::t('admin/passport', '申请信息');?>"></el-step>
                <el-step title="<?= \Yii::t('admin/passport', '提交注册申请');?>"></el-step>
            </el-steps>
            ...
            <div class="box-card">
                <el-form v-if="!forget" style="padding: 0 50px;" v-show="active != 3"
                         ...
                         size="small">
                    <div v-show="active == 1">
                        <el-form-item label="<?= \Yii::t('admin/passport', '账户名');?>" prop="username">
                            <el-input v-model="ruleForm.username" autocomplete="off" placeholder="<?= \Yii::t('admin/passport', '请输入用户名');?>"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '设置密码');?>" prop="pass">
                            <el-input type="password" v-model="ruleForm.pass" autocomplete="off"
                                      placeholder="<?= \Yii::t('admin/passport', '请输入密码');?>"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '确认密码');?>" prop="checkPass">
                            <el-input type="password" v-model="ruleForm.checkPass" autocomplete="off"
                                      placeholder="<?= \Yii::t('admin/passport', '请再次输入密码');?>"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-checkbox v-model="read">
                                <span><?= \Yii::t('admin/passport', '我已阅读并同意');?></span>
                                <el-button type="text" @click.stop="registerProtocolDialogVisible = true">《<?= \Yii::t('admin/passport', '注册协议');?>》
                                </el-button>
                            </el-checkbox>
                        </el-form-item>
                    </div>
                    <div v-show="active == 2">
                        <el-form-item label="<?= \Yii::t('admin/passport', '姓名');?>" prop="name">
                            <el-input v-model="ruleForm.name" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '联系人手机号');?>" prop="mobile">
                            <el-input v-model="ruleForm.mobile" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '验证码');?>" prop="captcha">
                        ...
                        <el-form-item label="<?= \Yii::t('admin/passport', '微信号');?>" prop="wechat_id">
                            <el-input v-model="ruleForm.wechat_id" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '申请原因');?>" prop="remark">
                            <el-input type="textarea" :rows="5" v-model="ruleForm.remark" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '上传证件信息');?>" prop="info">
                            <div style="float: left">
                                <div class="id-card">
                                    ...
                                    <div><?= \Yii::t('admin/passport', '上传身份证正面');?></div>
                                </div>
                                <div class="id-card">
                                    ...
                                    <div><?= \Yii::t('admin/passport', '上传身份证反面');?></div>
                                </div>
                            </div>
                            <div class="business">
                                ...
                                <div><?= \Yii::t('admin/passport', '上传营业执照');?></div>
                            </div>
                        </el-form-item>
                    </div>
                    <el-form-item>
                        <template v-if="active == 2">
                            <el-button style="float: right;font-size: 16px;width: 100px;margin-left: 20px" round
                                       :loading="btnLoading" type="primary" @click="store('ruleForm')"><?= \Yii::t('admin/passport', '提交');?>
                            </el-button>
                            <el-button style="float: right;font-size: 16px;width: 100px;" round @click="prev"><?= \Yii::t('admin/passport', '上一步');?>
                            </el-button>
                        </template>
                        <el-button type="primary" style="float: right;font-size: 16px;width: 100px;" v-else
                                   @click="next('ruleForm')" round :loading="nextStepLoading"><?= \Yii::t('admin/passport', '下一步');?>
                        </el-button>
                    </el-form-item>
                </el-form>
                <div v-show="active == 3" class="audit-box" flex="main:center">
                    <div class="submit-success">
                        ...
                        <el-button style="margin-top: 25px;" type="primary" round
                                   @click="$navigate({r:'admin/passport/login'})"><?= \Yii::t('admin/passport', '我知道了');?>
                        </el-button>
                    </div>
                ...
                <div v-if="forget">
                    <el-form :model="form" size="small" label-width="150px" :rules="rules2" ref="form">
                        <el-form-item label="<?= \Yii::t('admin/passport', '手机号');?>" prop="mobile">
                            <el-input v-model="form.mobile" autocomplete="off" placeholder="<?= \Yii::t('admin/passport', '请输入手机号');?>"></el-input>
                        </el-form-item>
                        <el-form-item class="code" label="<?= \Yii::t('admin/passport', '短信验证码');?>" prop="captcha">
                            <el-input v-model="form.captcha" placeholder="<?= \Yii::t('admin/passport', '请输入短信验证码');?>">
                        ...
                        <el-form-item label="<?= \Yii::t('admin/passport', '选择账户');?>" prop="user_id">
                            <el-select v-model="form.user_id" placeholder="<?= \Yii::t('admin/passport', '选择账户');?>" style="width: 100%;">
                                <el-option
                        ...
                        <el-form-item label="<?= \Yii::t('admin/passport', '设置密码');?>" prop="pass">
                            <el-input type="password" v-model="form.pass" placeholder="<?= \Yii::t('admin/passport', '请输入密码');?>"
                                      autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('admin/passport', '确认密码');?>" prop="checkPass">
                            <el-input type="password" v-model="form.checkPass" placeholder="<?= \Yii::t('admin/passport', '请再次输入密码');?>"
                                      autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-button type="primary" class="forget-submit" round @click="resetPasswordSubmit('form')"
                                       :loading="resetPasswordLoading"><?= \Yii::t('admin/passport', '提交');?>
                            </el-button>
                        </el-form-item>
                    </el-form>
                </div>
        ...
        <el-footer class="el-footer">
            ...
            <?php else : ?>
                &copy;2019 <a href="https://www.opmall.com" target="_blank"><?= \Yii::t('admin/passport', 'hook007');?></a>
            <?php endif; ?>
        </el-footer>

        <el-dialog title="<?= \Yii::t('admin/passport', '注册协议');?>" :visible.sync="registerProtocolDialogVisible" :close-on-click-modal="false">
            <div style="width: 100%;overflow-x: auto">
                <?= ($indSetting && !empty($indSetting['register_protocol'])) ? $indSetting['register_protocol'] : '' ?>
            </div>
            <div slot="footer">
                <el-button type="primary" @click="registerProtocolDialogVisible = false; read = true;"><?= \Yii::t('admin/passport', '我已阅读并同意');?>
                </el-button>
            </div>
        </el-dialog>
    ...
    const app = new Vue({
        ...
        data() {
            var checkPhone = (rule, value, callback) => {
                if (!value) {
                    return callback(new Error("<?= \Yii::t('admin/passport', '手机号不能为空');?>"));
                } else {
                    const reg = /0?(13|14|15|16|17|18|19)[0-9]{9}/
                    if (reg.test(value)) {
                        callback();
                    } else {
                        return callback(new Error("<?= \Yii::t('admin/passport', '请输入正确的手机号');?>"));
                    }
                }
            };
            var validatePass = (rule, value, callback) => {
                if (value === '' || value === undefined) {
                    callback(new Error("<?= \Yii::t('admin/passport', '请输入密码');?>"));
                } else if (value.length < 6 || value.length > 15) {
                    callback(new Error("<?= \Yii::t('admin/passport', '密码应在6至15位之间');?>"));
                } else {
            ...
            var validatePass2 = (rule, value, callback) => {
                if (value === '' || value === undefined) {
                    callback(new Error("<?= \Yii::t('admin/passport', '请再次输入密码');?>"));
                } else if (value.length < 6 || value.length > 15) {
                    callback(new Error("<?= \Yii::t('admin/passport', '密码应在6至15位之间');?>"));
                } else if (value !== this.ruleForm.pass) {
                    callback(new Error("<?= \Yii::t('admin/passport', '两次输入密码不一致');?>!"));
                } else {
                    callback();
                }
            };
            ...
            var checkName = (rule, value, callback) => {
                ...
                console.log(value);
                if (value === '' || value === undefined) {
                    callback(new Error("<?= \Yii::t('admin/passport', '请输入用户名');?>"));
                } else if (value.length < 6 || value.length > 15) {
                    callback(new Error("<?= \Yii::t('admin/passport', '用户名长度应在6至15位之间');?>"));
                } else {
                    const reg = /^[a-zA-Z][a-zA-Z0-9_]*$/;
                    if (reg.test(value)) {
                        callback();
                    } else {
                        return callback(new Error("<?= \Yii::t('admin/passport', '账户名必须是字母开头');?>"));
                    }
                }
            };
            var checkPic = (rule, value, callback) => {
                ...
                if (this.ruleForm.id_card_front_pic === '') {
                    callback(new Error("<?= \Yii::t('admin/passport', '请上传身份证正面信息');?>"));
                } else if (this.ruleForm.id_card_back_pic === '') {
                    callback(new Error("<?= \Yii::t('admin/passport', '请上传身份证反面信息');?>"));
                } else if (this.ruleForm.business_pic === '') {
                    callback(new Error("<?= \Yii::t('admin/passport', '请上传营业执照');?>"));
                } else {
                    callback();
                }
            };
            return {
                ...
                rules2: {
                    user_id: [
                        {required: true, message: "<?= \Yii::t('admin/passport', '请选择账户');?>", trigger: 'blur'},
                    ],
                    pass: [
                    ...
                    code: [
                        {required: true, message: "<?= \Yii::t('admin/passport', '验证码不能为空');?>", trigger: 'blur'},
                    ],
                    mobile: [
                        {required: true, message: "<?= \Yii::t('admin/passport', '手机号不能为空');?>", trigger: 'blur'},
                    ],
                    captcha: [
                        {required: true, message: "<?= \Yii::t('admin/passport', '手机验证码不能为空');?>", trigger: 'blur'},
                    ],
                },
                rules: {
                    username: [
                    ...
                    name: [
                        {required: true, message: "<?= \Yii::t('admin/passport', '姓名/企业名不能为空');?>", trigger: 'blur'},
                    ],
                    mobile: [
                    ...
                    remark: [
                        {required: true, message: "<?= \Yii::t('admin/passport', '申请原因不能为空');?>", trigger: 'blur'},
                    ],
                    info: [
                ...
                sendSmsCaptchaText: "<?= \Yii::t('admin/passport', '获取短信验证码');?>",

                sendResetPasswordCaptchaLoading: false,
                sendResetPasswordCaptchaDisabled: false,
                sendResetPasswordCaptchaText: "<?= \Yii::t('admin/passport', '获取短信验证码');?>",
                user_list: [],
                resetPasswordLoading: false,
                text: "<?= \Yii::t('admin/passport', '您的注册申请已提交');?>",
            };
        },
        created() {
        ...
        methods: {
            ...
            store(formName) {
                ...
                self.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$message.success("<?= \Yii::t('admin/passport', '请完整填写表单');?>");
                        return false;
                    }
                });
            },
            ...
            next(formName) {
                ...
                if (this.read) {
                        ...
                        this.$request({
                            ...
                            if (e.data.code === 0) {
                                if (e.data.data.is_exists == 0) {
                                    ...
                                    this.$message.error("<?= \Yii::t('admin/passport', '该账户名已被使用');?>");
                                }
                            }
                        }).catch(e => {
                            this.nextStepLoading = false;
                    ...
                    this.$message.error("<?= \Yii::t('admin/passport', '请先阅读并同意');?>");
                }
            ...
            captcha() {
                ...
                if (!self.ruleForm.mobile) {
                    self.$message.error("<?= \Yii::t('admin/passport', '请先填写手机号');?>");
                    return
                }
                    ...
                    if (e.data.code === 0) {
                        ...
                        const timer = setInterval(() => {
                            if (second <= 0) {
                                ...
                                this.sendSmsCaptchaText = "<?= \Yii::t('admin/passport', '获取短信验证码');?>";
                                clearInterval(timer);
                                return;
                            }
                            second = second - 1;
                        ...
                        if (e.data.code === 0) {
                            ...
                            const timer = setInterval(() => {
                                if (second <= 0) {
                                    ...
                                    this.sendResetPasswordCaptchaText = "<?= \Yii::t('admin/passport', '获取短信验证码');?>";
                                    clearInterval(timer);
                                    return;
                                }
                                second = second - 1;
            ...
            resetPasswordSubmit(formName) {
                this.$refs[formName].validate(valid => {
                    ...
                    this.$request({
                        ...
                        if (e.data.code === 0) {
                            this.$alert(e.data.msg, "<?= \Yii::t('admin/passport', '提示');?>").then(() => {
