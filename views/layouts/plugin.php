        ...
        _aside = new Vue({
            ...
            methods: {
                ...
                getPluginMenus() {
                    ...
                    if (data && data.newMenus) {
                        this.pluginMenus = data.newMenus;
                        this.currentMenu.list = data.newMenus;
                        // this.currentMenu.opened_2 = localStorage.getItem('_OPENED_MENU_2_ID');
                    } else {
                        this.leftMenuLoading = true;
                    }
                    ...
                    request({
                        ...
                        self.leftMenuLoading = false;
                        self.pluginMenus = e.data.data.newMenus;
                        self.currentMenu.list = e.data.data.newMenus;
                        self.defaultRoute = e.data.data.currentRouteInfo.id;
                        self.currentMenu.opened_2 = localStorage.getItem('_OPENED_MENU_2_ID');
                        // self.pluginMenus.children.forEach(function (cItem) {
                        //     if (cItem.is_active) {
                        //         self.currentMenu.opened_2 = cItem.id;
                        //         let temporary = self.currentMenu.temporary_opened_1;
                        //         if (temporary) {
                        //             localStorage.setItem('_OPENED_MENU_1_ID', temporary);
                        //         }
                        //         localStorage.setItem('_OPENED_MENU_2_ID', cItem.id);
                        //         localStorage.setItem('_OPENED_MENU_3_ID', 0);
                        //     }
                        // })
                        console.log(self.pluginMenus)
                    }).catch(e => {
                        console.log(e);
                    });
                },
                ...
                mouseleaveEvent() {
                    ...
                    setTimeout(()=>{
                        if(!this.ishoverMenu){
                            ...
                            self.currentMenu.list = self.pluginMenus;
