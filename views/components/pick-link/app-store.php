...
<template id="app-store">
    <div style="display: inline-block">
        <app-pick-link-demo title="<?= \Yii::t('components/other', '门店选择');?>" placeholder="<?= \Yii::t('components/other', '根据ID、门店名称搜索');?>"
            ...
            <template #table="slotProps">
                <el-table
                    ...
                    <el-table-column label="<?= \Yii::t('components/other', '门店名称');?>" prop="name"></el-table-column>
                    <el-table-column label="<?= \Yii::t('components/other', '门店地址');?>" prop="address"></el-table-column>
                </el-table>
            </template>
        </app-pick-link-demo>
    </div>
