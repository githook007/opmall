        ...
        <app-pick-link-demo title="<?= \Yii::t('components/other', '商品选择');?>" placeholder="<?= \Yii::t('components/other', '根据商品ID、商品名称搜索');?>"
            ...
            <template #table="slotProps">
                <el-table
                    ...
                    <el-table-column label="<?= \Yii::t('components/other', '售价');?>" prop="price"></el-table-column>
                    <el-table-column prop="stepGoods.currency" width="120" label="<?= \Yii::t('components/other', '所需活力币');?>">
                        <template slot-scope="scope">
...
<script>
    Vue.component('app-link-step', {
        template: '#app-link-step',
        props: {
            value: {
                type: Object | null,
                default: null
