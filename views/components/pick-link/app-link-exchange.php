...
<template id="app-link-exchange">
    <div style="display: inline-block">
        <app-pick-link-demo title="<?= \Yii::t('components/other', '礼品卡选择');?>" placeholder="<?= \Yii::t('components/other', '根据ID、礼品卡名称搜索');?>"
            ...
            <template #table="slotProps">
                <el-table
                    ...
                    <el-table-column label="<?= \Yii::t('components/other', '礼品卡名称');?>" prop="name" width="350">
                        <template slot-scope="scope">
                            <div flex="box:first">
                    ...
                    <el-table-column label="<?= \Yii::t('components/other', '价格');?>" prop="price"></el-table-column>
                    <el-table-column prop="cardGoods.library_name" label="<?= \Yii::t('components/other', '兑换码库');?>"></el-table-column>
