...
<template id="app-article">
    <div style="display: inline-block">
        <app-pick-link-demo title="<?= \Yii::t('components/other', '文章选择');?>" placeholder="<?= \Yii::t('components/other', '根据文章id、标题搜索');?>"
            ...
            <template #table="slotProps">
                <el-table
                    ...
                    <el-table-column label="<?= \Yii::t('components/other', '标题');?>" prop="title"></el-table-column>
                </el-table>
            </template>
        </app-pick-link-demo>
    </div>
