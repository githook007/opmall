            ...
            <div class="select">
                <div style="background: #ffffff;padding: 30px 0 50px 0;">
                    <el-form :model="value" :rules="rules" size="small" ref="value" label-width="15%">
                        <el-form-item label="<?= \Yii::t('components/poster', '海报样式');?>" prop="poster_style">
                            <el-checkbox-group v-model="value.poster_style" style="max-width: 500px">
                                <div @click="changeStyle(`1`)"
                                    ...
                                    <el-checkbox class="event-step" label="1"><?= \Yii::t('components/poster', '样式一');?></el-checkbox>
                                ...
                                <div @click="changeStyle(`2`)"
                                    ...
                                    <el-checkbox class="event-step" label="2"><?= \Yii::t('components/poster', '样式二');?></el-checkbox>
                                ...
                                <div @click="changeStyle(`3`)"
                                    ...
                                    <el-checkbox class="event-step" label="3"><?= \Yii::t('components/poster', '样式三');?></el-checkbox>
                                ...
                                <div @click="changeStyle(`4`)"
                                    ...
                                    <el-checkbox class="event-step" label="4"><?= \Yii::t('components/poster', '样式四');?></el-checkbox>
                                    <img src="statics/img/mall/poster/admin/4.png" alt=""/>
                                </div>
                            </el-checkbox-group>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('components/poster', '商品图数量');?>" prop="image_style">
                            <el-checkbox-group v-model="value.image_style" style="width: 450px">
                                <div @click="changePic(`1`)"
                                    ...
                                    <el-checkbox class="event-step" label="1"><?= \Yii::t('components/poster', '一张');?></el-checkbox>
                                ...
                                <div @click="changePic(`2`)"
                                    ...
                                    <el-checkbox class="event-step" label="2"><?= \Yii::t('components/poster', '二张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                ...
                                <div @click="changePic(`3`)"
                                    ...
                                    <el-checkbox class="event-step" label="3"><?= \Yii::t('components/poster', '三张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                        <div style="height: 50%;width:100%;border-bottom: 1px solid #b8b8b8"></div>
                                ...
                                <div @click="changePic(`4`)"
                                    ...
                                    <el-checkbox class="event-step" label="4"><?= \Yii::t('components/poster', '四张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                ...
                                <div @click="changePic(`5`)"
                                    ...
                                    <el-checkbox class="event-step" label="5"><?= \Yii::t('components/poster', '五张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                        <div style="height: 50%;width:50%;border-right: 1px solid #b8b8b8;border-bottom:1px solid #b8b8b8"></div>
                    ...
                    poster_style: [
                        {
                            required: true, type: 'array', validator: (rule, value, callback) => {
                                ...
                                callback("<?= \Yii::t('components/poster', '至少选择一个海报样式');?>");
                            }
                        }
                    ],
                    image_style: [
                        {
                            required: true, type: 'array', validator: (rule, value, callback) => {
                                ...
                                callback("<?= \Yii::t('components/poster', '至少选择一个商品图数量');?>");
                            }
                        }
                    ],
                },
