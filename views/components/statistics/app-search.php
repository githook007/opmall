...
<template id="app-search">
    <div class="app-search" flex="cross:center">
        ...
        <template v-if="isShowPicker">
            <div>
                <el-date-picker
                        ...
                        range-separator="<?= \Yii::t('components/statistics', '至');?>"
            ...
            <div>
                <el-tabs v-model="activeName" @tab-click="tabTotal">
                    <el-tab-pane label="7<?= \Yii::t('components/statistics', '日');?>" name="week"></el-tab-pane>
                    <el-tab-pane label="30<?= \Yii::t('components/statistics', '日');?>" name="month"></el-tab-pane>
                </el-tabs>
            </div>
        </template>
        ...
        <div>
            <div class="clean" @click="clean"><?= \Yii::t('components/statistics', '清空筛选');?></div>
        </div>
    </div>
</template>
...
<script>
    Vue.component('app-search', {
        ...
        props: {
            ...
            placeholder: {
                type: String,
                default: "<?= \Yii::t('components/statistics', '请输入搜索内容');?>"
            }
        },
        data() {
            return {
