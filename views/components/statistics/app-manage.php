        ...
        <el-card shadow="never" style="margin-bottom: 10px">
            <div slot="header">
                ...
                <app-new-export-dialog-2
                    ...
                    text='<?= \Yii::t('components/statistics', '导出');?>'
                    :params="searchData"
            ...
            <div style="margin-top:10px;margin-bottom: 30px">
                <el-radio-group v-model="manageSearch.timeStatus" size="small" @change="changeManageRadio">
                    <el-radio-button label="today"><?= \Yii::t('components/statistics', '今日');?></el-radio-button>
                    <el-radio-button label="yesterday"><?= \Yii::t('components/statistics', '昨日');?></el-radio-button>
                    <el-radio-button label="one_week"><?= \Yii::t('components/statistics', '7日');?></el-radio-button>
                    <el-radio-button label="all"><?= \Yii::t('components/statistics', '汇总');?></el-radio-button>
                </el-radio-group>
                <el-date-picker
                        ...
                        range-separator="至"
                        start-placeholder="<?= \Yii::t('components/statistics', '开始日期');?>"
                        end-placeholder="<?= \Yii::t('components/statistics', '结束日期');?>">
                </el-date-picker>
            </div>
            <!-- 员工 -->
            <div v-if="showStatus === `operator`">
                <div v-loading="manageLoading" flex="dir:left cross:center" style="flex-grow: 1;height: 150px;width: 100%">
                    <div class="manage-head user" style="background:#FFC274">
                        <div><?= \Yii::t('components/statistics', '浏览数据');?></div>
                        <img src="statics/img/mall/statistic/browse_icon.png" alt=""/>
                    </div>
                    <div flex="dir:left" class="manage-content" style="background-color: #FFF4E6;width: 100%;height: 100%">
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '访问数（人）');?></div>
                            </div>
                            <div class="title" style="color:#FF8F00;cursor: pointer"
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '访问量（次）');?></div>
                            </div>
            ...
            <div v-else v-loading="manageLoading" flex="dir:left cross:center" style="width: 100%">
                <div :style="{'margin-right': showStatus === `store` ? `0px`: `27px`}" style="flex-grow:1">
                    <div class="manage-head" style="background:#FF9F7B">
                        <span><?= \Yii::t('components/statistics', '支付数据');?></span>
                        <img style="width: 63px;height: 51px" src="statics/img/mall/statistic/payment_icon.png" alt=""/>
                    </div>
                    <div flex="dir:left" class="manage-content" style="background-color: #FFF5F1">
                        <!-- -->
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '支付订单数（笔）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '不包含取消订单的支付订单数');?>" placement="top">
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '支付人数（人）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '不包含取消订单的支付人数');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                            <div class="title" style="color:#fd4500;">{{all_num.order_data.user_num}}</div>
                            <div v-if="rankingTitle" flex="dir:left cross:center" class="compare">
                                <span>{{rankingTitle}}</span>
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '支付金额（元）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '不包含取消订单的支付金额');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '支付商品数（件）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '不包含取消订单的支付商品数');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                ...
                <div v-if="showStatus === `super-account` || showStatus === `sub-account`" style="flex-grow:1;width:300px">
                    <div class="manage-head" style="background:#FFC274">
                        <span><?= \Yii::t('components/statistics', '浏览数据');?></span>
                        <img src="statics/img/mall/statistic/browse_icon.png" alt=""/>
                    </div>
                    <div flex="dir:left" class="manage-content" style="background-color: #FFF4E6">
                        <!-- -->
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 100%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '访客数（人）');?></div>
                            </div>
                            <div class="title"
                                 style="color:#FF8F00;cursor: pointer"
                                 @click="$navigate({r:'mall/user/index'},true)">
                                {{all_num.user_data.user_num}}
                            </div>
                            <div v-if="rankingTitle" flex="dir:left cross:center" class="compare">
                ...
                <div v-if="showStatus === `super-account` || showStatus === `mch` || showStatus === `sub-account`"
                    ...
                    <div class="manage-head" style="background:#51D0BF">
                        <span><?= \Yii::t('components/statistics', '收益数据');?></span>
                        <img style="width: 63px;height: 51px" src="statics/img/mall/statistic/profit_icon.png" alt=""/>
                    </div>
                    <div flex="dir:left" class="manage-content" style="background-color: #E5F9F2">
                        <!-- -->
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '余额收益（元）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '实际收益：扣除所有退款订单的支付金额');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                            ...
                            <div v-if="all_num.pay_data[3].refund > 0" class="refund-title"><?= \Yii::t('components/statistics', '退款');?>：
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '微信收益（元）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '实际收益：扣除所有退款订单的支付金额');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                            <div class="title" style="color:#01BEA4;">{{all_num.pay_data[1].amount}}</div>
                            <div v-if="rankingTitle" flex="dir:left cross:center" class="compare">
                                <span>{{rankingTitle}}</span>
                            ...
                            <div v-if="all_num.pay_data[1].refund > 0" class="refund-title"><?= \Yii::t('components/statistics', '退款');?>：
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '支付宝收益（元）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '实际收益：扣除所有退款订单的支付金额');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                            ...
                            <div v-if="all_num.pay_data[4].refund > 0" class="refund-title"><?= \Yii::t('components/statistics', '退款');?>：
                        ...
                        <div flex="dir:top cross:center main:center" class="manage-box" style="width: 50%">
                            <div flex="dir:left cross:center">
                                <div><?= \Yii::t('components/statistics', '货到付款收益（元）');?></div>
                                <el-tooltip class="item" effect="dark" content="<?= \Yii::t('components/statistics', '实际收益：扣除所有退款订单的支付金额');?>" placement="top">
                                    <i class="el-icon-question"></i>
                                </el-tooltip>
                            </div>
                            ...
                            <div v-if="all_num.pay_data[2].refund > 0" class="refund-title"><?= \Yii::t('components/statistics', '退款');?>：
    ...
    Vue.component('app-manage', {
        ...
        data() {
            return {
                ...
                manageLoading: false,
                timeStr: {
                    'today': "<?= \Yii::t('components/statistics', '今日');?>",
                    'yesterday': "<?= \Yii::t('components/statistics', '昨日');?>",
                    'one_week': "<?= \Yii::t('components/statistics', '7日');?>",
                    'all': "<?= \Yii::t('components/statistics', '汇总');?>",
                },
                all_num: {
                    user_data: {},
                    order_data: {},
        ...
        computed: {
            formatNumText() {
                if (this.all_num.user_data.data_num) {
                    let numberFormat = function (value) {
                        let param = {};
                        let k = 10000,
                            sizes = ['', "<?= \Yii::t('components/statistics', '万');?>", "<?= \Yii::t('components/statistics', '亿');?>", "<?= \Yii::t('components/statistics', '万亿');?>"],
                            i;
                        if (value < k) {
                            param.value = value
                            param.unit = ''
            ...
            labelTitle() {
                switch (this.showStatus) {
                    case 'operator':
                        return "<?= \Yii::t('components/statistics', '访问概况');?>";
                    default:
                        return "<?= \Yii::t('components/statistics', '经营概况');?>";
                }
            },
            rankingTitle() {
                ...
                let timeStr = {
                    '': '',
                    today: "<?= \Yii::t('components/statistics', '较昨日');?>",
                    yesterday: "<?= \Yii::t('components/statistics', '较上周');?>",
                    one_week: "<?= \Yii::t('components/statistics', '较前七日');?>",
                    all: '',
                };
