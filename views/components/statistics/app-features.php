...
<template id="app-features">
    <div class="app-features">
        <el-card shadow="never" style="margin-bottom: 10px">
            <div slot="header">
                <span><?= \Yii::t('components/statistics', '常用功能');?></span>
            </div>
    ...
    Vue.component('app-features', {
        ...
        data() {
            return {
                commonMenus: [],
                featuresList: [{
                    'image_url': 'statics/img/mall/statistic/function_icon.png',
                    'name': "<?= \Yii::t('components/statistics', '添加商品');?>",
                    'path': 'mall/goods/edit',
                    'is_show': true,
                }, {
                    'image_url': 'statics/img/mall/statistic/function_icon.png',
                    'name': "<?= \Yii::t('components/statistics', '店铺装修');?>",
                    'path': 'mall/index/setting',
                    'is_show': "<?= !$mchId?>",
                }, {
                    'image_url': 'statics/img/mall/statistic/function_icon.png',
                    'name': "<?= \Yii::t('components/statistics', '订单管理');?>",
                    'path': 'mall/order/index',
                    'is_show': true,
                }, {
                    'image_url': 'statics/img/mall/statistic/function_icon.png',
                    'name': "<?= \Yii::t('components/statistics', '插件中心');?>",
                    'path': 'mall/plugin/index',
                    'is_show': "<?= !$mchId?>",
                }, {
                    'image_url': 'statics/img/mall/statistic/function_icon.png',
                    'name': "<?= \Yii::t('components/statistics', '优惠券');?>",
        ...
        methods: {
            getData() {
                request({
                    params: {
                        r: 'mall/data-statistics/common-menus',
                    },
                }).then(e => {
                    if (e.data.code === 0) {
