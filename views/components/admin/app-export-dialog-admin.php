...
?>
<style>
    .app-export-dialog-admin .el-dialog__body .el-checkbox + .el-checkbox {
        margin-left: 0;
    }

    .app-export-dialog-admin .el-date-editor .el-range-separator {
        padding: 0;
    }

    .app-export-dialog-admin .modal-body {
        border: 1px solid #F0F2F7;
    }

    .app-export-dialog-admin .all-choose {
        height: 50px;
        line-height: 50px;
    ...
    .app-export-dialog-admin .choose-list {
        padding: 10px 25px 20px;
    }

    .app-export-dialog-admin .choose-list .export-checkbox {
        width: 135px;
        height: 30px;
        line-height: 30px;
    }
    .app-export-dialog-admin .dialog-box .el-dialog {
        min-width: 300px;
    }

    .app-export-dialog-admin .image-dialog {
        width: 294px;
        height: 212px;
        top: calc(50% - 212px / 2);
    ...
    .app-export-dialog-admin .start-animation {
        visibility: visible;
...
<template id="app-export-dialog-admin">
    <div class="app-export-dialog-admin" style="display: inline-block">
...
<script>
    Vue.component('app-export-dialog-admin', {
        template: '#app-export-dialog-admin',
        props: {
            text: {
                type: String,
                default: '批量导出'
        ...
        mounted() {
            setTimeout(function() {
                let dwonload_params = localStorage.getItem('_APP_ORDER_DOWNLOAD_PARAMS');
                dwonload_params = JSON.parse(dwonload_params);

                let left = dwonload_params.left;
                let top = dwonload_params.top + 120;
