<template id="app-select-member">
    <div class="app-select-member">
        <el-dialog title="<?= \Yii::t('components/other', '选择会员等级');?>" :visible.sync="memberDialog" top="10vh" width="750">
            <div class="input-item" style="margin-bottom: 12px">
                <el-input @keyup.enter.native="searchMember" size="small" placeholder="<?= \Yii::t('components/other', '请输入会员等级名称');?>"
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="memberDialog = false"><?= \Yii::t('components/other', '取消');?></el-button>
                <el-button size="small" type="primary" @click="memberConfirm"><?= \Yii::t('components/other', '确定');?></el-button>
            </div>
        </el-dialog>
