            ...
            <div class="select">
                <div style="background: #ffffff;padding: 30px 0;">
                    <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="20%">
                        <el-form-item label="<?= \Yii::t('components/other', '海报样式');?>" prop="poster_style">
                            <el-checkbox-group v-model="ruleForm.poster_style" style="width: 800px">
                                <div @click="changeStyle(`1`)"
                                    ...
                                    <el-checkbox class="event-step" label="1"><?= \Yii::t('components/other', '样式一');?></el-checkbox>
                                    <img src="http://t.cn/A6zsnUiE" alt=""/>
                                </div>
                                <div @click="changeStyle(`2`)"
                                     :class="[`poster-style-box`, `${ruleForm.poster_style.indexOf(`2`) === -1 ? ``:`active`}`]">
                                    <el-checkbox class="event-step" label="2"><?= \Yii::t('components/other', '样式二');?></el-checkbox>
                                    <img src="http://t.cn/A6zsnUiE" alt=""/>
                                </div>
                                <div @click="changeStyle(`3`)"
                                     :class="[`poster-style-box`, `${ruleForm.poster_style.indexOf(`3`) === -1 ? ``:`active`}`]">
                                    <el-checkbox class="event-step" label="3"><?= \Yii::t('components/other', '样式三');?></el-checkbox>
                                    <img src="http://t.cn/A6zsnUiE" alt=""/>
                                </div>
                                <div @click="changeStyle(`4`)"
                                     :class="[`poster-style-box`, `${ruleForm.poster_style.indexOf(`4`) === -1 ? ``:`active`}`]">
                                    <el-checkbox class="event-step" label="4"><?= \Yii::t('components/other', '样式四');?></el-checkbox>
                                    <img src="http://t.cn/A6zsnUiE" alt=""/>
                                </div>
                            </el-checkbox-group>
                        </el-form-item>
                        <el-form-item label="<?= \Yii::t('components/other', '商品图数量');?>" prop="image_style">
                            <el-checkbox-group v-model="ruleForm.image_style" style="width: 500px">
                                <div @click="changePic(`1`)"
                                    ...
                                    <el-checkbox class="event-step" label="1"><?= \Yii::t('components/other', '一张');?></el-checkbox>
                                ...
                                <div @click="changePic(`2`)"
                                    ...
                                    <el-checkbox class="event-step" label="2"><?= \Yii::t('components/other', '二张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                ...
                                <div @click="changePic(`3`)"
                                    ...
                                    <el-checkbox class="event-step" label="3"><?= \Yii::t('components/other', '三张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                        <div style="height: 50%;width:100%;border-bottom: 1px solid #00ffff"></div>
                                ...
                                <div @click="changePic(`4`)"
                                    ...
                                    <el-checkbox class="event-step" label="4"><?= \Yii::t('components/other', '四张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                ...
                                <div @click="changePic(`5`)"
                                    ...
                                    <el-checkbox class="event-step" label="5"><?= \Yii::t('components/other', '五张');?></el-checkbox>
                                    <div flex="dir:left" class="grid">
                                        <div style="height: 50%;width:50%;border-right: 1px solid #00ffff;border-bottom:1px solid #00ffff"></div>
