    ...
    <div>
        <div class="diy-component-preview" :style="styleA">
            <div :style="styleB" v-if="data.select_style == 1"
                ...
                <template v-if="data.wechat && data.wechat.length">
                    ...
                    <div :style="{color:data.wechat_color}" v-if="data.wechat[0].name" style="margin-top: 32px;font-size: 28px">
                        <?= \Yii::t('components/diy', '微信号');?>：{{data.wechat[0].name}}
                    </div>
                </template>
        ...
        <div v-show="!hidden" class="diy-component-edit">
            <div class="app-form-title">
                <div><?= \Yii::t('components/diy', '自定义客服');?></div>
            </div>
            <el-form label-width="120px" @submit.native.prevent style="padding: 20px 0">
                <el-form-item label="<?= \Yii::t('components/diy', '选择样式');?>">
                    <app-radio turn v-model="data.select_style" label="1"><?= \Yii::t('components/diy', '样式一');?></app-radio>
                    <app-radio turn v-model="data.select_style" label="2"><?= \Yii::t('components/diy', '样式二');?></app-radio>
                </el-form-item>
                ...
                <el-form-item label="<?= \Yii::t('components/diy', '标题文字颜色');?>">
                ...
                <template v-if="data.select_style == 2">
                    <el-form-item label="<?= \Yii::t('components/diy', '副标题');?>"
                                  :rules="[{ required: true, validator: validate, trigger: 'change'}]">
                        <el-input size="small" maxlength="15" v-model="data.sub_title" class="c-input"
                                  show-word-limit></el-input>
                    </el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '副标题文字颜色');?>">
                    ...
                    <el-form-item label="<?= \Yii::t('components/diy', '图标');?>">
                        <app-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                            ...
                            <el-tooltip effect="dark"
                                        content="<?= \Yii::t('components/diy', '建议尺寸');?>:100 * 100"
                                        placement="top">
                        ...
                        <el-button size="mini" @click="resetImg('two_icon')" class="reset" type="primary"><?= \Yii::t('components/diy', '恢复默认');?>
                        </el-button>
                    </el-form-item>
                </template>

                <el-form-item label="<?= \Yii::t('components/diy', '客服微信');?>" prop="wechat"
                              :rules="[{ required: true, validator: validate, trigger: 'change'}]">
                    <el-tooltip effect="dark"
                                content="<?= \Yii::t('components/diy', '建议尺寸');?>:200 * 200"
                                placement="top">
                        <el-button size="mini" @click="wechatAdd"
                                   :disabled="data.wechat.length >= 10"><?= \Yii::t('components/diy', '选择');?>
                        </el-button>
                    </el-tooltip>
                        ...
                        <div v-for="(item,index) of data.wechat" @click="wechatEdit(item,index)"
                            ...
                            <div>
                                <app-image mode="aspectFill"
                                           ...
                                           :src="item['qrcode']"
                                ></app-image>
                                <div class="wechat-end-box" style="padding-left: 12px" v-text="`<?= \Yii::t('components/diy', '微信号');?>： ${item.name}`">
                                </div>
                            </div>
                    ...
                    <div style="color:#909399"><?= \Yii::t('components/diy', '注意：最多允许上传10张，前端随机展示一张');?></div>
                </el-form-item>
                <el-form-item v-if="data.select_style == 1" label="<?= \Yii::t('components/diy', '微信号文字颜色');?>">
                ...
                <!-------->
                <template v-if="data.select_style == 2">
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮样式设置');?>"></el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮圆角');?>" prop="two_radius">
                        <div flex="dir:left">
                            <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                       v-model="data.two_radius"
                                       :max="40" :min="0"
                                       :show-tooltip="false"></el-slider>
                            <el-input-number size="small" v-model="data.two_radius" :min="0"
                                             :max="40" label="<?= \Yii::t('components/diy', '按钮圆角');?>"></el-input-number>
                            <div style="margin-left: 10px">px</div>
                        </div>
                    </el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮文本');?>">
                        <el-input size="small" v-model="data.two_title" class="c-input"
                                  :maxlength="5" show-word-limit
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '填充颜色');?>">
                        <div flex="dir:left main:between">
                            ...
                            <el-form-item label="<?= \Yii::t('components/diy', '边框颜色');?>">
                                ...
                                <div style="position:absolute;color:#a9a297"><?= \Yii::t('components/diy', '不填默认无边框');?></div>
                            </el-form-item>
                        </div>
                    </el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '文本颜色');?>">
                ...
                <template v-if="data.select_style == 1">
                    <!-------->
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮1样式设置');?>"></el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮圆角');?>" prop="save_radius">
                        <div flex="dir:left">
                            <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                       v-model="data.save_radius"
                                       :max="40" :min="0"
                                       :show-tooltip="false"></el-slider>
                            <el-input-number size="small" v-model="data.save_radius" :min="0"
                                             :max="40" label="<?= \Yii::t('components/diy', '按钮圆角');?>"></el-input-number>
                            <div style="margin-left: 10px">px</div>
                        </div>
                    </el-form-item>
                    ...
                    <!-------->
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮2样式设置');?>"></el-form-item>
                    <el-form-item label="<?= \Yii::t('components/diy', '按钮圆角');?>" prop="copy_radius">
                        <div flex="dir:left">
                            <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                       v-model="data.copy_radius"
                                       :max="40" :min="0"
                                       :show-tooltip="false"></el-slider>
                            <el-input-number size="small" v-model="data.copy_radius" :min="0"
                                             :max="40" label="<?= \Yii::t('components/diy', '按钮圆角');?>"></el-input-number>
                            <div style="margin-left: 10px">px</div>
                        </div>
                    </el-form-item>
                ...
                <app-padding @ss="ss" v-model="data">
                    <template slot="c-bg">
                        <el-form-item label="<?= \Yii::t('components/diy', '组件背景颜色');?>">
            ...
            <!--客服微信-->
            <el-dialog title="<?= \Yii::t('components/diy', '客服微信');?>" :visible.sync="wechatVisible" width="30%" :close-on-click-modal="false">
                <el-form :model="wechatForm" label-width="150px" :rules="wechatRules" ref="wechatForm"
                         @submit.native.prevent>
                    <el-form-item label="<?= \Yii::t('components/diy', '客服微信二维码');?>" prop="qrcode">
                        <div style="margin-bottom:10px;">
                            <app-attachment style="display:inline-block;margin-right: 10px" :multiple="false"
                                            :max="1"
                                            @selected="wechatSelect">
                                <el-tooltip effect="dark" content="<?= \Yii::t('components/diy', '建议尺寸');?>:360 * 360" placement="top">
                    ...
                    <el-form-item label="<?= \Yii::t('components/diy', '客服微信号');?>" prop="name">
                        <el-input size="small" v-model="wechatForm.name" maxlength="20"
                                  auto-complete="off"></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
                    <el-button size="small" @click="wechatVisible = false"><?= \Yii::t('components/diy', '取消');?></el-button>
                    <el-button size="small" type="primary" @click.native="wechatSubmit"><?= \Yii::t('components/diy', '提交');?></el-button>
                </div>
            </el-dialog>
        </div>
    </div>
    ...
    Vue.component('diy-customer', {
        ...
        data() {
            var validate = (rule, value, callback) => {
                if (this.templateName) {
                    ...
                    callback(new Error(this.labelText['title'] + '<?= \Yii::t('components/diy', '不能为空');?>'))
                }
            };
            return {
                defaultImage: "",
                ...
                wechatRules: {
                    qrcode: [
                        {required: true, message: '<?= \Yii::t('components/diy', '二维码不能为空');?>', trigger: 'blur'},
                    ],
                    name: [
                ...
                data: {
                    select_style: '1',
                    sub_title: '<?= \Yii::t('components/diy', '有专属福利优惠活动哦');?>~',
                    sub_title_color: '#999999',
                    two_icon: "<?= \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl ?>/statics/img/mall/diy/icon-customer-two.png",
                    two_radius: 40,
                    two_title: '<?= \Yii::t('components/diy', '复制微信号');?>',
                    two_bg: '#ff4544',
                    two_border: '#FFFFFF',
                    two_color: '#FFFFFF',

                    title: '<?= \Yii::t('components/diy', '客服标题');?>',
                    title_color: '#353535',
                    wechat: [],
                    wechat_color: '#999999',
                    save_radius: 40,
                    save_title: '<?= \Yii::t('components/diy', '保存客服二维码图片');?>',
                    save_bg: '#FFFFFF',
                    save_border: '#ff4544',
                    save_color: '#ff4544',
                    copy_radius: 40,
                    copy_title: '<?= \Yii::t('components/diy', '复制客服微信号');?>',
                    copy_bg: '#ffffff',
                    copy_border: '#ff4544',
                    copy_color: '#ff4544',
                    c_padding_top: 24,
        ...
        methods: {
            resetImg(type) {
                ...
                if (type === 'two_icon') {
                    this.data.two_icon = host + '/statics/img/mall/diy/icon-customer-two.png';
                }
            },
            ss(styleA, styleB) {
                this.styleA = styleA;
