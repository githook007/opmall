...
<template id="app-video-model">
    <div class="app-video-model">
        <el-dialog title="<?= \Yii::t('components/diy', '选择视频');?>" :visible.sync="videoDialog" top="10vh" width="750">
            <div class="input-item" style="margin-bottom: 12px">
                <el-input @keyup.enter.native="searchVideo" size="small" placeholder="<?= \Yii::t('components/diy', '根据名称搜索');?>"
                          v-model="search.keyword" clearable
                          @clear="searchVideo">
                    <el-button slot="append" @click="searchVideo"><?= \Yii::t('components/diy', '搜索');?></el-button>
                </el-input>
            </div>
            <div flex="dir:top" v-loading="listLoading">
                <el-table :data="list" stripe style="width: 100%">
                    ...
                    <el-table-column label="<?= \Yii::t('components/diy', '名称');?>">
                        <template slot-scope="scope">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="videoDialog = false"><?= \Yii::t('components/diy', '取消');?></el-button>
                <el-button size="small" type="primary" @click="videoConfirm"><?= \Yii::t('components/diy', '确定');?></el-button>
            </div>
        </el-dialog>
