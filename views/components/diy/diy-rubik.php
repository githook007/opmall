        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                    <el-tab-pane label="<?= \Yii::t('components/diy', '图片样式');?>" name="first">
                    ...
                    <el-tab-pane label="<?= \Yii::t('components/diy', '图片上传');?>" name="second">
                        <el-form-item label="<?= \Yii::t('components/diy', '图片间隙');?>" v-if="data.style > 0">
                        ...
                        <template v-if="data.style == 8">
                            <el-form-item label="<?= \Yii::t('components/diy', '魔方宽度');?>">
                                <el-input v-model="data.w" size="small" type="number" min="0" max="10">
                                </el-input>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('components/diy', '魔方高度');?>">
                                <el-input v-model="data.h" size="small" type="number" min="0" max="10">
                                </el-input>
                            </el-form-item>
                        </template>
                        <template v-if="!data.list[rubik]">
                            <el-form-item label="<?= \Yii::t('components/diy', '图片上传');?>">
                                <span><?= \Yii::t('components/diy', '请先在左边选择图片位置');?></span>
                            </el-form-item>
                        </template>
                        <template v-else>
                            <el-card shadow="never">
                                ...
                                <el-form-item label="<?= \Yii::t('components/diy', '选择链接');?>">
                                    <app-pick-link title="<?= \Yii::t('components/diy', '选择链接');?>" @selected="selectLink">
                                        <el-input size="small" v-model="rubikLink()" :disabled="true">
                                            <template slot="append">
                                                <el-button><?= \Yii::t('components/diy', '选择链接');?></el-button>
                                            </template>
                                        </el-input>
                                    </app-pick-link>
                                </el-form-item>
                        ...
                        <el-form-item label="<?= \Yii::t('components/diy', '热区划分');?>">
                            <app-hotspot :multiple="true" :pic-list="data.list" :hotspot-array="data.hotspot"
                                         ...
                                         :is-link="true">
                                <el-button size="mini"><?= \Yii::t('components/diy', '划分热区');?></el-button>
                            </app-hotspot>
                        </el-form-item>
                    </el-tab-pane>
                </el-tabs>
    ...
    Vue.component('diy-rubik', {
        ...
        data() {
            return {
                ...
                style_list: [
                    {
                        name: "1<?= \Yii::t('components/diy', '张图');?>",
                        height: 360,
                        w: 1,
                        h: 1,
                        list: [
                    ...
                    {
                        name: "2<?= \Yii::t('components/diy', '张图');?>",
                        height: 360,
                        w: 25,
                        h: 12,
                        list: [
                    ...
                    {
                        name: "3<?= \Yii::t('components/diy', '张图');?>",
                        height: 360,
                        w: 25,
                        h: 12,
                        list: [
                    ...
                    {
                        name: "4<?= \Yii::t('components/diy', '张图');?>",
                        height: 360,
                        w: 50,
                        h: 24,
                        list: [
                    ...
                    {
                        name: "2<?= \Yii::t('components/diy', '张图平分');?>",
                        height: 240,
                        w: 50,
                        h: 16,
                        list: [
                    ...
                    {
                        name: "3<?= \Yii::t('components/diy', '张图平分');?>",
                        height: 240,
                        w: 75,
                        h: 24,
                        list: [
                    ...
                    {
                        name: "4<?= \Yii::t('components/diy', '张图平分');?>",
                        height: 186,
                        w: 4,
                        h: 1,
                        list: [
                    ...
                    {
                        name: "4<?= \Yii::t('components/diy', '张图上下平分');?>",
                        height: 372,
                        w: 250,
                        h: 124,
                        list: [
                    ...
                    {
                        name: "<?= \Yii::t('components/diy', '自定义魔方');?>",
                        height: 372,
                        w: 375,
                        h: 186,
                        list: [
