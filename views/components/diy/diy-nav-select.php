    ...
    <div class="diy-nav-select">
        <el-dialog title="" :visible.sync="navDialog" top="10vh" width="45%">
            <div class="input-item">
                <el-input @keyup.enter.native="searchNav" size="small" placeholder="<?= \Yii::t('components/diy', '根据名称搜索');?>"
            ...
            <el-table ref="singleTable" v-loading="listLoading" :data="navList" height="544"
                ...
                <el-table-column prop="name" label="<?= \Yii::t('components/diy', '名称');?>" width="120"></el-table-column>
                <el-table-column prop="icon_url" label="<?= \Yii::t('components/diy', '导航图标');?>" width="80">
                    <template slot-scope="scope">
                        <app-image width="35" height="35" mode="aspectFill" :src="scope.row.icon_url"></app-image>
                    </template>
                </el-table-column>
                <el-table-column prop="url" label="<?= \Yii::t('components/diy', '导航链接');?>"></el-table-column>
            </el-table>
            <!--工具条 批量操作和分页-->
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="navDialog = false"><?= \Yii::t('components/diy', '取消');?></el-button>
                <el-button size="small" type="primary" @click="navConfirm"><?= \Yii::t('components/diy', '确定');?></el-button>
            </div>
        </el-dialog>
