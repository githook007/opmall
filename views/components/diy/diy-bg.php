...
<template id="diy-bg">
    <div class="diy-bg">
        ...
        <el-form-item v-if="background" label="<?= \Yii::t('components/diy', '背景图片');?>">
            <el-switch v-model="data.showImg" @change="showBackground"></el-switch>
            <slot name="about"></slot>
        </el-form-item>
        <el-form-item v-if="data.showImg" label="<?= \Yii::t('components/diy', '上传背景');?>">
            <app-image-upload v-model="backgroundPicUrl"></app-image-upload>
        </el-form-item>
        <el-form-item v-if="data.showImg" label="<?= \Yii::t('components/diy', '图片位置');?>">
        ...
        <el-form-item v-if="data.showImg" label="<?= \Yii::t('components/diy', '填充方式');?>">
            <el-radio-group v-model="data.mode" @change="changeMode">
                <el-radio :label="1"><?= \Yii::t('components/diy', '充满');?></el-radio>
                <el-radio :label="2"><?= \Yii::t('components/diy', '左右平铺');?></el-radio>
                <el-radio :label="3"><?= \Yii::t('components/diy', '上下平铺');?></el-radio>
                <el-radio :label="4"><?= \Yii::t('components/diy', '平铺满');?></el-radio>
            </el-radio-group>
        </el-form-item>
        <el-form-item v-if="data.showImg && data.mode != 1" label="<?= \Yii::t('components/diy', '背景图宽');?>">
        ...
        <el-form-item v-if="data.showImg && data.mode != 1" label="<?= \Yii::t('components/diy', '背景图高');?>">
