...
<template id="app-map">
    <div class="app-map">
        <el-dialog :title="title ? title : '<?= \Yii::t('components/other', '地图展示');?>'"
            ...
            <el-form label-width="80px" size="small">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="<?= \Yii::t('components/other', '地址搜索');?>">
                            <el-input placeholder="<?= \Yii::t('components/other', '请输入具体地址');?>" v-model="mapKeyword">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="<?= \Yii::t('components/other', '地址');?>">
                            <el-input v-model="newAddress"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="<?= \Yii::t('components/other', '纬度');?>">
            ...
            initMap() {
                ...
                let citylocation = new qq.maps.CityService({
                    ...
                    complete: function (results) {
                        console.log("<?= \Yii::t('components/other', '所在位置');?>" + results.detail.name);
            ...
            initSearch() {
                ...
                self.searchService = new qq.maps.SearchService({
                    ...
                    complete: function (results) {
                        ...
                        if (!pois) {
                            alert("<?= \Yii::t('components/other', '输入详细地址搜索更准确');?>");
                            return false;
                        }
                    ...
                    //若服务请求失败，则运行以下函数
                    error: function () {
                        alert("<?= \Yii::t('components/other', '出错了');?>");
                    }
                });
            },
            // 地址搜索
