...
<template id="app-invoice">
    <div class="app-invoice" style="user-select: none;">
        <!-- 打印 -->
        <el-dialog title="<?= \Yii::t('components/order', '打印发货单');?>" :visible.sync="dialogVisible" width="35%" @close="closeDialog">
            <template v-if="printStatus">
                <div class="title-box">
                    <span class="text"><?= \Yii::t('components/order', '选择打印商品');?></span>
            ...
            <div class="title-box">
                <span class="text"><?= \Yii::t('components/order', '选择发货单模板');?></span>
            </div>
            <el-form label-width="130px"
                ...
                <el-form-item class="input-1">
                    <el-input
                            ...
                            @clear="getExpress"
                            size="small"
                            placeholder="<?= \Yii::t('components/order', '请输入模板名称');?>"
        ...
        <div class="image-dialog">
            ...
            >
                ...
                <el-button type="primary" @click="imageVisible = false" size="small"><?= \Yii::t('components/order', '我知道了');?></el-button>
            </span>
            </el-dialog>
        </div>
    </div>
