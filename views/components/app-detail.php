            ...
            <el-col :xs="24" :sm="24" :md="24">
                <el-form size="small"   :rules="cRule" class="form-body">
                    <el-tabs v-model="tableName" @tab-click="tabClick">
                        <el-tab-pane label="<?= \Yii::t('components/other', '商品设置');?>" name="first">
                            <!--选择商品类型-->
                            <el-card shadow="never">
                                <el-row slot="header">
                                    <el-col><?= \Yii::t('components/other', '选择商品类型');?></el-col>
                                </el-row>
                                <el-row>
                                    <el-col>
                            ...
                            <el-card class="mt-24" shadow="never">
                                <div slot="header">
                                    <span><?= \Yii::t('components/other', '选择分类');?></span>
                                </div>
                                <el-row>
                                    <el-col :xl="12" :lg="16">
                                        <el-form-item label="<?= \Yii::t('components/other', '商品分类');?>" prop="cats">
                                            ...
                                            <el-button type="primary" @click="$refs.cats.openDialog()"><?= \Yii::t('components/other', '选择分类');?></el-button>
                                            <el-button type="text" @click="$navigate({r:'mall/cat/edit'}, true)"><?= \Yii::t('components/other', '添加分类');?>
                                            </el-button>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                        ...
                        <el-tab-pane label="<?= \Yii::t('components/other', '分销价设置');?>" name="two">

                        </el-tab-pane>

                        <el-tab-pane label="<?= \Yii::t('components/other', '会员价设置');?>" name="third">
