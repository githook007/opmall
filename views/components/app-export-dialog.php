...
<template id="app-export-dialog">
    <div class="app-export-dialog" style="display: inline-block">
        <el-button @click="confirm" type="primary" size="small"><?= \Yii::t('components/other', '批量导出');?></el-button>
        <el-dialog
            ...
            <form target="_blank" :action="action_url" method="post">
                ...
                <div flex="dir:right" style="margin-top: 20px;">
                    <button type="submit" class="el-button el-button--primary el-button--small"><?= \Yii::t('components/other', '导出');?></button>
                </div>
            </form>
        </el-dialog>
    </div>
