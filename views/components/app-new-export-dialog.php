        ...
        <el-dialog
            ...
            <el-form>
                ...
                <div flex="dir:right" style="margin-top: 20px;">
                    <el-button size="small" type="primary" @click="submit"><?= \Yii::t('components/other', '导出');?></el-button>
                </div>
            </el-form>
        </el-dialog>
        ...
        <el-dialog
            ...
            <div v-if="percentage == 100 && download_url" flex="dir:right" style="margin-top: 20px;">
                <a target="_blank" :href="download_url">
                    <input οnclick="this.parentNode.click();" type="button" value="<?= \Yii::t('components/other', '点击下载');?>" class="el-button el-button--primary el-button--small">
                </a>
            </div>
        </el-dialog>
    </div>
...
<script>
    Vue.component('app-new-export-dialog', {
        ...
        props: {
            text: {
                type: String,
                default: "<?= \Yii::t('components/other', '批量导出');?>"
            },
            title: {
                type: String,
                default: "<?= \Yii::t('components/other', '订单导出');?>"
            },
            directly: {
                type: Boolean,
                default: false
