...
<template id="app-member-auth">
    <div class="app-member-auth">
        <template v-if="!showGoodsChecked">
            ...
            <el-button type="button" size="mini" @click="showGoodsOpen"><?= \Yii::t('components/other', '选择会员等级');?>
            </el-button>
        </template>
        <el-checkbox v-model="showGoodsChecked" @change="defaultShowGoods"><?= \Yii::t('components/other', '所有用户');?>
        </el-checkbox>
        <el-dialog title="<?= \Yii::t('components/other', '选择会员等级');?>" :visible.sync="dialog" width="30%">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="close"><?= \Yii::t('components/other', '取消');?></el-button>
