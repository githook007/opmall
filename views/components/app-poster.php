        ...
        <div style="display: flex;">
            <div class="poster-mobile-box" flex="dir:top">
                <div class="poster-bg-box">
                    ...
                    <span v-if="rule_form.name && rule_form.name.is_show == 1"
                        ...
                        {{rule_form.name.text ? rule_form.name.text : "<?= \Yii::t('components/other', '商品名称');?>|<?= \Yii::t('components/other', '商品名称');?>"}}
                    </span>
                    ...
                    <span v-if="rule_form.time_str && rule_form.time_str.is_show == 1"
                          :style="{
                                          ...
                                          {{rule_form.time_str.text ? rule_form.time_str.text : '08.16 14:00<?= \Yii::t('components/other', '场');?>'}}
                    </span>
            ...
            <div class="poster-form-body" flex="dir:top">
                <div flex="dir:left" style="margin-bottom: 15px">
                    <app-attachment :multiple="false" :max="1"
                        ...
                        <el-tooltip class="item"
                                    effect="dark"
                                    content="<?= \Yii::t('components/other', '建议尺寸');?>"
                                    placement="top">
                            <el-button size="mini">
                                {{rule_form.bg_pic.url ? "<?= \Yii::t('components/other', '更换背景图');?>" : "<?= \Yii::t('components/other', '添加背景图');?>"}}
                            </el-button>
                        </el-tooltip>
                    </app-attachment>
                ...
                <el-card shadow="never" class="box-card" style="width: 100%;">
                    <div slot="header">
                        <span>{{title_desc}}<?= \Yii::t('components/other', '设置');?></span>
                    </div>
                    <div>
                        <template v-if="goods_component_key == 'head'">
                            <el-form-item label="<?= \Yii::t('components/other', '大小');?>">
                                <el-slider
                                        :min=40
                                        :max=300
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '上间距');?>">
                                <el-slider
                                        :min=0
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '左间距');?>">
                                <el-slider
                                        :min=0
                        ...
                        <template v-else-if="goods_component_key == 'nickname'">
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '左间距');?>" v-if="rule_form.nickname.left == 0 || rule_form.nickname.left">
                                <el-slider
                                        :min=0
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '颜色');?>">
                                <el-color-picker
                        ...
                        <template v-else-if="goods_component_key == 'poster_bg_two'">
                            <el-form-item label="<?= \Yii::t('components/other', '宽度');?>">
                                <el-slider
                                        :min=0
                                        :max=750
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '高度');?>">
                                <el-slider
                                        :min=0
                                        :max=1334
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '选择图片');?>">
                                <app-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                                                @selected="posterBgTwoPic">
                                    <el-button size="mini"><?= \Yii::t('components/other', '选择图标');?></el-button>
                                </app-attachment>
                        ...
                        <template v-else-if="goods_component_key == 'price'">
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '删除线');?>" v-if="rule_form.price.del_line !== undefined">
                        ...
                        <template v-else-if="goods_component_key == 'qr_code'">
                            <el-form-item label="<?= \Yii::t('components/other', '样式');?>">
                                <el-radio v-model="rule_form.qr_code.type" :label="1"><?= \Yii::t('components/other', '圆形');?></el-radio>
                                <el-radio v-model="rule_form.qr_code.type" :label="2"><?= \Yii::t('components/other', '方形');?></el-radio>
                            </el-form-item>
                            <el-form-item label="<?= \Yii::t('components/other', '大小');?>">
                                <el-slider
                                        :min=35
                        ...
                        <template v-else-if="goods_component_key == 'desc'">
                            <el-form-item label="<?= \Yii::t('components/other', '文本内容');?>">
                            ...
                            <el-form-item label="<?= \Yii::t('components/other', '文本宽度');?>" v-if="rule_form.desc.width">
                                <el-slider
                                        :min=1
                                        :max=750
