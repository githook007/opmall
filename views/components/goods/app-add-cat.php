    ...
    <div class="app-add-cat">
        ...
        <el-dialog :title="title" width="1100px" :visible.sync="dialogVisible" :append-to-body="appendToBody">
            <div class="app-add-cat">
                <el-row v-loading="dialogLoading" :gutter="20" style="margin-top: -30px;">
                    <template v-if="options.length > 0">
                        <el-col :span="8">
                            <h3><?= \Yii::t('components/goods', '一级分类');?></h3>
                    ...
                    <el-col :span="8" v-if="children.length > 0">
                        <h3><?= \Yii::t('components/goods', '二级分类');?></h3>
                    ...
                    <el-col :span="8" v-if="third.length > 0">
                        <h3><?= \Yii::t('components/goods', '三级分类');?></h3>
                        <div class="app-goods-cat-list">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button size='small' type="primary" @click="dialogSubmit"><?= \Yii::t('components/goods', '确定');?></el-button>
            </span>
        </el-dialog>
    </div>
</template>
    ...
    Vue.component('app-add-cat', {
        ...
        data() {
            return {
                ...
                cats: [], //用于前端已选的分类展示
                dialogLoading: false,
                title: "<?= \Yii::t('components/goods', '选择分类');?>",
                current1: '',
                current2: '',
                current3: '',
            }
        ...
        methods: {
            openDialog() {
                let self = this;
                this.getCats();
                self.title = self.mch_id > 0 ? "<?= \Yii::t('components/goods', '选择多商户分类');?>" : "<?= \Yii::t('components/goods', '选择分类');?>";
                this.cats = [];
                this.children = [];
                this.third = [];
