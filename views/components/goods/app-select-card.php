...
<template id="app-select-card">
    <div class="app-select-card">
        <el-dialog
                @close="dialogClose"
                title="<?= \Yii::t('components/goods', '选择卡券');?>"
                :visible.sync="card.dialog"
                width="30%">
            <div class="input-item">
                <el-input @keyup.enter.native="searchCards" size="small" placeholder="<?= \Yii::t('components/goods', '请输入卡券名称');?>"
                ...
                <div class="card-list-item"
                    ...
                    <div>
                        <el-input-number type="number" size="small" v-model="item.num" :min="1" :max="100"
                                         label="<?= \Yii::t('components/goods', '输入数量');?>"></el-input-number>
                    </div>
                </div>
            </div>
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="card.dialog = false"><?= \Yii::t('components/goods', '取消');?></el-button>
                <el-button size="small" type="primary" @click="cardConfirm"><?= \Yii::t('components/goods', '确定');?></el-button>
            </div>
        </el-dialog>
    </div>
</template>
