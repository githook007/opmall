<style>
    ...
    .app-preview .el-carousel__container {
        height: 375px;
    }
</style>
<template id="app-preview">
    <div class="app-preview">
        <el-dialog title="<?= \Yii::t('components/goods', '手机端预览');?>" :visible.sync="dialogGoodsVisible" top="5vh">
            <div class="mobile">
                <div class="screen">
                    <div class="top-bar" flex="main:center cross:center">
                        <div><?= \Yii::t('components/goods', '商品详情');?></div>
                    </div>
                    <div class="content">
                        <el-scrollbar style="height: 100%">
                                ...
                                <div flex="dir:top" class="goods">
                                    ...
                                    <div flex="dir:left" style="font-size:14px">
                                        ...
                                        <div class="share" flex="dir:top main:center cross:center">
                                            ...
                                            <div><?= \Yii::t('components/goods', '分享');?></div>
                                        </div>
                                    </div>
                                </div>
                            </template>
                            ...
                            <template v-if="previewInfo.is_services!= false">
                                <div v-if="ruleForm.services && ruleForm.services.length"
                                    ...
                                    <div class="services" flex="dir:left cross:center"
                                        ...
                                        <div style="height: 12px;width: 12px;flex-grow: 0">
                            ...
                            <template v-if="previewInfo.is_attr!= false">
                                <div class="tab" flex="dir:left cross:center">
                                    <div style="width:65px"><?= \Yii::t('components/goods', '选择');?></div>
                                    <div style="color:#666666"><?= \Yii::t('components/goods', '规格');?></div>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button size='small' @click="dialogGoodsVisible = false"><?= \Yii::t('components/goods', '继续编辑');?></el-button>
                <el-button size='small' :loading="submitLoading" type="primary" @click="dialogSubmit"><?= \Yii::t('components/goods', '保存');?></el-button>
            </span>
        </el-dialog>
    </div>
</template>
        ...
        computed: {
            actual() {
                ...
                if (max > min && min >= 0) {
                    ...
                    actualPrice = "<?= \Yii::t('components/goods', '免费');?>";
                    type = '';
                }
                return {
                    price: actualPrice,
