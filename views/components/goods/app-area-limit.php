...
<template id="app-area-limit">
    <div>
        <el-button size="small" v-if="value[0].list.length == 0" type="text" @click="openDistrict">
            <i class="el-icon-plus"><?= \Yii::t('components/goods', '添加地区');?></i>
        </el-button>
            ...
            <div flex="dir:left box:last">
                <div>
                    <div flex="dir:left" style="flex-wrap: wrap;width: 90%">
                        <div style="margin: auto 0"><?= \Yii::t('components/goods', '区域');?>：</div>
        ...
        <el-dialog title="<?= \Yii::t('components/goods', '选择地区');?>" :visible.sync="dialogVisible" width="50%">
