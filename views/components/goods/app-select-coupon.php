...
<template id="app-select-coupon">
    <div class="app-select-coupon">
        <el-dialog @close="closeCouponDialog" title="<?= \Yii::t('components/goods', '选择优惠券');?>" :visible.sync="couponDialog" top="10vh" width="30%" append-to-body>
            <div class="input-item">
                <el-input @keyup.enter.native="searchCoupon" size="small" placeholder="<?= \Yii::t('components/goods', '请输入优惠券名称');?>"
