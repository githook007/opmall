...
<template id="app-select-goods">
    <div class="app-select-goods">
        <el-dialog title="<?= \Yii::t('components/goods', '商品选择');?>" :visible.sync="dialogSelectVisible" top="5vh" width="960px">
            <el-input placeholder="<?= \Yii::t('components/goods', '根据商品ID/名称搜索');?>" v-model="search.keyword" @keyup.enter.native="searchList" prop="rr">
                <el-button slot="append" @click="searchList"><?= \Yii::t('components/goods', '搜索');?></el-button>
            </el-input>
            <el-table v-loading="listLoading" :data="list" stripe height="544"
                ...
                <el-table-column label="<?= \Yii::t('components/goods', '名称');?>" width="810">
                    <template slot-scope="scope">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button v-if="false" @click="dialogSelectVisible = false"><?= \Yii::t('components/goods', '取消');?></el-button>
...
<script>
    Vue.component('app-select-goods', {
        ...
        props: {
            ...
            submit_text: {
                type: String,
                default: '<?= \Yii::t('components/goods', '确定');?>'
            },
            status: {
                type: Number,
                default: -1,
