...
<template id="app-dialog-select">
    <div class="app-dialog-select">
        <el-dialog append-to-body :title="title" :visible.sync="visible" :close-on-click-modal="false"
            ...
            <div>
                <el-input v-model="search.keyword" placeholder="<?= \Yii::t('components/goods', '根据名称搜索');?>" @keyup.enter.native="getDetail(1)">
                    <el-button slot="append" @click="getDetail(1)"><?= \Yii::t('components/goods', '搜索');?></el-button>
                </el-input>
                <el-table border v-loading="listLoading" :data="list" style="margin-top: 24px;" height="500"
                    ...
                    <el-table-column label="<?= \Yii::t('components/goods', '名称');?>">
                        <template slot-scope="props">
            ...
            <div style="margin-top: 24px;">
                <el-row>
                    ...
                    <el-button type="primary" size="small" style="float: right" @click="confirm"><?= \Yii::t('components/goods', '选择');?></el-button>
                </el-row>
            </div>
        </el-dialog>
...
<script>
    Vue.component('app-dialog-select', {
        ...
        props: {
            ...
            title: {
                type: String,
                default: "<?= \Yii::t('components/goods', '商品选择');?>"
            },
            listKey: {
                type: String,
                default: 'name'
