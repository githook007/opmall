    ...
    <div class="app-attr-template">
        <el-dialog custom-class="custom-dialog" :visible.sync="templateDialog">
            <div slot="title" style="margin-bottom: -30px">
                <span style="font-size: 18px;color:#7a7a7a"><?= \Yii::t('components/goods', '选择规格模板');?></span>
                <span style="font-size:14px;color:#c9c9c9;margin-left: 10px"><?= \Yii::t('components/goods', '规格模板最多支持添加5组');?></span>
            </div>
            <div flex="dir:left">
                <div class="tpl-box">
                    <div class="tpl-head"><?= \Yii::t('components/goods', '规格名选择');?></div>
                ...
                <div class="tpl-box" style="margin-left: 20px">
                    <div class="tpl-head"><?= \Yii::t('components/goods', '规格值选择');?></div>
                    <el-scrollbar class="tpl-scrollbar">
        ...
        methods: {
            ...
            templateSubmit() {
                ...
                if (Object.keys(obj).length + self.value.length > this.attrGroupMaxCount) {
                    self.$message.error("<?= \Yii::t('components/goods', '规格名最多添加');?>" + this.attrGroupMaxCount + "<?= \Yii::t('components/goods', '个');?>");
                    return;
                }
            ...
            emptyModel() {
                ...
                self.$msgbox({
                    ...
                    message: h('p', {style: 'color:#666666;font-size:14px'}, [
                        h('p', null, "<?= \Yii::t('components/goods', '暂无规格模板数据');?>"),
