    ...
    <el-card shadow="never" style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;"
        ...
        <el-form v-if="ruleForm" :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="20%">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="<?= \Yii::t('mall/poster', '分销海报');?>" name="first">
                        ...
                        <div class="form-body" v-if="ruleForm.share.bg_pic.url" flex="dir:top">
                            <app-attachment style="margin-bottom: 15px" :multiple="false" :max="1"
                                ...
                                <el-tooltip class="item"
                                            effect="dark"
                                            content="<?= \Yii::t('mall/poster', '建议尺寸');?>:750 * 1334"
                                            placement="top">
                                    <el-button size="mini">
                                        {{ruleForm.share.bg_pic.url ? '<?= \Yii::t('mall/poster', '更换背景图');?>' : '<?= \Yii::t('mall/poster', '添加背景图');?>'}}
                                    </el-button>
                                </el-tooltip>
                            </app-attachment>
                            <div flex="wrap:wrap">
                            ...
                            <el-card shadow="never" class="box-card" style="width: 100%">
                                <div slot="header">
                                    <span v-if="shareComponentKey == 'head'"><?= \Yii::t('mall/poster', '头像设置');?></span>
                                    <span v-if="shareComponentKey == 'name'"><?= \Yii::t('mall/poster', '昵称设置');?></span>
                                    <span v-if="shareComponentKey == 'qr_code'"><?= \Yii::t('mall/poster', '二维码设置');?></span>
                                </div>
                                <div>
                                    <template v-if="shareComponentKey == 'head'">
                                        <el-form-item label="<?= \Yii::t('mall/poster', '大小');?>">
                                            <el-slider
                                                    :min=40
                                                    :max=300
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/poster', '上间距');?>">
                                            <el-slider
                                                    :min=0
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/poster', '左间距');?>">
                                            <el-slider
                                                    :min=0
                                    ...
                                    <template v-else-if="shareComponentKey == 'name'">
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/poster', '颜色');?>">
                                            <el-color-picker
                                    ...
                                    <template v-else-if="shareComponentKey == 'qr_code'">
                                        <el-form-item label="<?= \Yii::t('mall/poster', '样式');?>">
                                            <el-radio v-model="ruleForm.share.qr_code.type" :label="1"><?= \Yii::t('mall/poster', '圆形');?></el-radio>
                                            <el-radio v-model="ruleForm.share.qr_code.type" :label="2"><?= \Yii::t('mall/poster', '方形');?></el-radio>
                                        </el-form-item>
                                        <el-form-item label="<?= \Yii::t('mall/poster', '大小');?>">
                                            <el-slider
                                                    :min=80
                            ...
                            <el-button class="button-item" :loading="btnLoading" type="primary"
                                       @click="store('ruleForm')" size="small"><?= \Yii::t('mall/poster', '保存');?>
                            </el-button>
                        </div>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="<?= \Yii::t('mall/poster', '商品海报');?>" name="second">
                    <app-poster-new v-model="ruleFormNew.goods">
                        <el-button style="margin-left: 20px;" :loading="btnLoading" type="primary"
                                   @click="submit" size="small"><?= \Yii::t('mall/poster', '保存');?>
                        </el-button>
                    </app-poster-new>
                </el-tab-pane>
                <el-tab-pane label="<?= \Yii::t('mall/poster', '专题海报');?>" name="third">
                    <div style="display: flex;">
                            ...
                            <div class="bg-box">
                                ...
                                <span v-if="ruleForm.topic.content.is_show == 1"
                                      :style="{
                                        ...
                                        <?= \Yii::t('mall/poster', '专题内容');?>|<?= \Yii::t('mall/poster', '专题内容');?>|<?= \Yii::t('mall/poster', '专题内容');?><?= \Yii::t('mall/poster', '专题内容');?>
                                </span>
                        ...
                        <div class="form-body" flex="dir:top">
                            <div flex="dir:left" style="margin-bottom: 15px">
                                <app-attachment :multiple="false" :max="1"
                                    ...
                                    <el-tooltip class="item"
                                                ...
                                                placement="top">
                                        <el-button size="mini">
                                            {{ruleForm.topic.bg_pic.url ? '<?= \Yii::t('mall/poster', '更换背景图');?>' : '<?= \Yii::t('mall/poster', '添加背景图');?>'}}
                                        </el-button>
                                    </el-tooltip>
                                </app-attachment>
                            ...
                            <el-card shadow="never" class="box-card" style="width: 100%;">
                                <div slot="header">
                                    <span v-if="topicComponentKey == 'title'"><?= \Yii::t('mall/poster', '专题标题设置');?></span>
                                    <span v-if="topicComponentKey == 'pic'"><?= \Yii::t('mall/poster', '专题图片设置');?></span>
                                    <span v-if="topicComponentKey == 'look'"><?= \Yii::t('mall/poster', '阅读量设置');?></span>
                                    <span v-if="topicComponentKey == 'content'"><?= \Yii::t('mall/poster', '专题内容设置');?></span>
                                    <span v-if="topicComponentKey == 'open_desc'"><?= \Yii::t('mall/poster', '文章提示设置');?></span>
                                    <span v-if="topicComponentKey == 'line'"><?= \Yii::t('mall/poster', '分割线设置');?></span>
                                    <span v-if="topicComponentKey == 'desc'"><?= \Yii::t('mall/poster', '海报描述设置');?></span>
                                    <span v-if="topicComponentKey == 'qr_code'"><?= \Yii::t('mall/poster', '二维码设置');?></span>
                                </div>
                                <div>
                                    ...
                                    <template v-else-if="topicComponentKey == 'open_desc'">
                                        <el-form-item label="<?= \Yii::t('mall/poster', '文本内容');?>">
                                    ...
                                    <template v-else-if="topicComponentKey == 'qr_code'">
                                        <el-form-item label="<?= \Yii::t('mall/poster', '样式');?>">
                                            <el-radio v-model="ruleForm.topic.qr_code.type" :label="1"><?= \Yii::t('mall/poster', '圆形');?></el-radio>
                                            <el-radio v-model="ruleForm.topic.qr_code.type" :label="2"><?= \Yii::t('mall/poster', '方形');?></el-radio>
                                        </el-form-item>
                                        <el-form-item label="<?= \Yii::t('mall/poster', '大小');?>">
                                            <el-slider
                                                    :min=30
                                    ...
                                    <template v-else-if="topicComponentKey == 'desc'">
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/poster', '文本宽度');?>">
                                            <el-slider
                                                    :min=1
                                                    :max=750
                                    ...
                                    <template v-else-if="topicComponentKey == 'pic'">
                                        <el-form-item label="<?= \Yii::t('mall/poster', '宽度');?>">
                                            <el-slider
                                                    :min=0
                                                    :max=750
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/poster', '高度');?>">
                                            <el-slider
                                                    :min=0
                                                    :max=1334
            ...
            return {
                ...
                goodsComponent: [
                    ...
                    },
                    {
                        ...
                        title: '<?= \Yii::t('mall/poster', '商品图片');?>',
                        is_active: true
                    },
                    {
                        key: 'name',
                        icon_url: 'statics/img/mall/poster/icon_name.png',
                        title: '<?= \Yii::t('mall/poster', '商品名称');?>',
                        is_active: true
                    },
                    {
                        key: 'price',
                        icon_url: 'statics/img/mall/poster/icon_price.png',
                        title: '<?= \Yii::t('mall/poster', '商品价格');?>',
                        is_active: true
                    },
                    {
                        key: 'desc',
                        icon_url: 'statics/img/mall/poster/icon_desc.png',
                        title: '<?= \Yii::t('mall/poster', '海报描述');?>',
                        is_active: true
                    },
                    {
                        key: 'qr_code',
                ...
                topicComponent: [
                    {
                        key: 'title',
                        icon_url: 'statics/img/mall/poster/icon_look_name.png',
                        title: '<?= \Yii::t('mall/poster', '专题标题');?>',
                        is_active: true
                    },
                    {
                        key: 'pic',
                        icon_url: 'statics/img/mall/poster/icon_pic.png',
                        title: '<?= \Yii::t('mall/poster', '专题图片');?>',
                        is_active: true
                    },
                    {
                        key: 'look',
                        icon_url: 'statics/img/mall/poster/icon_look.png',
                        title: '<?= \Yii::t('mall/poster', '阅读量');?>',
                        is_active: true
                    },
                    {
                        key: 'content',
                        icon_url: 'statics/img/mall/poster/icon_content.png',
                        title: '<?= \Yii::t('mall/poster', '专题内容');?>',
                        is_active: true
                    },
                    {
                        key: 'open_desc',
                        icon_url: 'statics/img/mall/poster/icon_point.png',
                        title: '<?= \Yii::t('mall/poster', '文章提示');?>',
                        is_active: true
                    },
                    {
                        key: 'line',
                        icon_url: 'statics/img/mall/poster/icon_line.png',
                        title: '<?= \Yii::t('mall/poster', '分割线');?>',
                        is_active: true
                    },
                    {
                        key: 'desc',
