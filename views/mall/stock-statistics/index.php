...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)"><?= \Yii::t('mall/stock_statistic', '股东分红');?></app-header>
        </div>
        ...
        <div class="table-body" style="padding: 20px">
            <el-table v-loading="loading" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                <el-table-column width="600" prop="name" label="<?= \Yii::t('mall/stock_statistic', '等级名称');?>">
                </el-table-column>
                <el-table-column prop="bonus_price" label="<?= \Yii::t('mall/stock_statistic', '分红总额');?>">
                </el-table-column>
                <el-table-column prop="order_num" label="<?= \Yii::t('mall/stock_statistic', '分红订单总数');?>">
                </el-table-column>
                <el-table-column prop="user_num" label="<?= \Yii::t('mall/stock_statistic', '股东人数');?>">
            </el-table>
            <div style="margin-top: 10px;" flex="box:last cross:center">
                <div style="visibility: hidden">
                    <el-button plain type="primary" size="small"><?= \Yii::t('mall/stock_statistic', '批量操作');?>1</el-button>
                    <el-button plain type="primary" size="small"><?= \Yii::t('mall/stock_statistic', '批量操作');?>2</el-button>
                </div>
                <div>
                    <el-pagination
                            v-if="pagination"
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                url: 'mall/stock-statistics/index',
                loading: false,
                // 今天
                today: '',
                // 七天前
