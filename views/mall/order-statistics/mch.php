...
<div id="app" v-cloak>
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)"><?= \Yii::t('mall/order_statistics', '多商户');?></app-header>
        </div>
        <div class="table-body">
            <app-search
                ...
                <template slot="select">
                    <div>
                        <el-select size="small" popper-class="select-item" @change="tabMch" style="width: 160px" filterable v-model="search.mch_id" placeholder="<?= \Yii::t('mall/order_statistics', '请输入搜索内容');?>">
        ...
        <div class="table-area">
            ...
            <el-card shadow="never">
                <div slot="header">
                    <span><?= \Yii::t('mall/order_statistics', '今日实时成交');?></span>
                </div>
                <div class="num-info">
                    <div class="num-info-item">
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                url: 'mall/order-statistics/index',
                loading: false,
                list_loading: false,
                mch_name:'',
                // 今天
