...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('mall/role_user', '操作记录详情');?></span>
            </div>
        </div>
        <div class="table-body">
            <el-row>
                <el-col :span="12" flex="dir:top">
                    <div style="margin-bottom: 20px;"><?= \Yii::t('mall/role_user', '更新前数据');?></div>
                    <div>{{detail.before_update}}</div>
                </el-col>
                <el-col :span="12">
                    <div style="margin-bottom: 20px;"><?= \Yii::t('mall/role_user', '更新后数据');?></div>
