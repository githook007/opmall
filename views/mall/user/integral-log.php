...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('mall/user', '积分记录');?></span>
        ...
        <div class="table-body">
            ...
            <el-table :data="form" border style="width: 100%" v-loading="listLoading">
                ...
                <el-table-column label="<?= \Yii::t('mall/user', '收支情况积分');?>" width="150">
                ...
                <el-table-column prop="desc" label="<?= \Yii::t('mall/user', '说明');?>" width="400"></el-table-column>
                <el-table-column label="<?= \Yii::t('mall/user', '订单号');?>" width="250px">
