    ...
    <div class="container">
        <div class="content" flex="dir:top main:center cross:center">
            <div class="content-tip" flex="dir:top main:center cross:center">
                <div><?= \Yii::t('mall/we7_entry7', '您可创建的小程序数量已满');?>!</div>
                <div><?= \Yii::t('mall/we7_entry7', '请联系官方购买');?></div>
            </div>
            <div><?= \Yii::t('mall/we7_entry7', '您已开通小程序数量');?><?php echo $count ?><?= \Yii::t('mall/we7_entry7', '总授权小程序数量');?><?php echo $authorize_count ?><?= \Yii::t('mall/we7_entry7', '个');?></div>
        </div>
    </div>
</div>
