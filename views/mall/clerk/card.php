    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column prop="clerk_number" label="<?= \Yii::t('mall/clerk', '核销次数');?>" width="180"></el-table-column>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                export_list: [],//导出字段数据,
                selectList: [
                    {value: 'card_name', name: '<?= \Yii::t('mall/clerk', '卡券名称');?>'},
                    {value: 'card_id', name: '<?= \Yii::t('mall/clerk', '卡券ID');?>'}
                ],
                clerk_user_list: []
            };
        },
