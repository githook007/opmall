    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div flex="dir:left cross:center">
                <span><?= \Yii::t('mall/clerk', '核销订单');?></span>
        ...
        <div class="table-body">
            ...
            <el-col :span="24" class="toolbar">
                <el-form size="small" :inline="true" :model="search">
                    ...
                    <el-form-item prop="time">
                        <span style="color:#606266"><?= \Yii::t('mall/clerk', '核销时间');?></span>
                        <el-date-picker
                                v-model="search.time"
                                @change="searchList"
                                value-format="yyyy-MM-dd HH:mm:ss"
                                type="datetimerange"
                                range-separator="<?= \Yii::t('mall/clerk', '至');?>"
                                start-placeholder="<?= \Yii::t('mall/clerk', '开始日期');?>"
                                end-placeholder="<?= \Yii::t('mall/clerk', '结束日期');?>">
                        </el-date-picker>
                    </el-form-item>
                    <el-select size="small" style="width: 150px"
                               ...
                               @change="searchList"
                               placeholder="<?= \Yii::t('mall/clerk', '核销员');?>">
                        <el-option label="<?= \Yii::t('mall/clerk', '全部核销员');?>" value="0"></el-option>
                    ...
                    <el-form-item>
                        <el-input
                                ...
                                placeholder="<?= \Yii::t('mall/clerk', '请输入搜索内容');?>"
                                clearable
                                @clear="searchList"
            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                <el-table-column prop="order_no" label="<?= \Yii::t('mall/clerk', '订单号');?>" width="200">
                ...
                <el-table-column prop="user_name" label="<?= \Yii::t('mall/clerk', '核销员');?>" width="280">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="clerk_store_name" label="<?= \Yii::t('mall/clerk', '核销门店');?>"></el-table-column>
                <el-table-column prop="clerk_time" label="<?= \Yii::t('mall/clerk', '核销时间');?>" width="180"></el-table-column>
            </el-table>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                export_list: [],//导出字段数据,
                selectList: [
                    {value: 'order_no', name: '<?= \Yii::t('mall/clerk', '订单号');?>'}
                ],
                clerk_user_list: []
            };
        },
