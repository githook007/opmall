...
<div id="app" v-cloak>
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)"><?= \Yii::t('mall/integral_statistics', '积分收支');?></app-header>
        </div>
            ...
            <el-card shadow="never">
                ...
                <div class="num-info">
                    <div class="num-info-item">
                        ...
                        <div class="info-item-name"><?= \Yii::t('mall/integral_statistics', '积分收入');?></div>
                    </div>
                    <div class="num-info-item">
                        <div>{{all.out_integral}}</div>
                        <div class="info-item-name"><?= \Yii::t('mall/integral_statistics', '积分支出');?></div>
                    </div>
                </div>
            </el-card>
        </div>
        <div class="table-body" style="padding: 20px">
            <el-table :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                ...
                <el-table-column prop="in_integral" label="<?= \Yii::t('mall/integral_statistics', '积分收入');?>">
                </el-table-column>
                <el-table-column prop="out_integral" label="<?= \Yii::t('mall/integral_statistics', '积分支出');?>">
                </el-table-column>
            </el-table>
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                url: 'mall/integral-statistics/index',
                loading: false,
                list_loading: false,
                // 今天
                today: '',
