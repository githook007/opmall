...
<div id="app" v-cloak>
    <el-dialog :title="address_list.length > 0 ? '<?= \Yii::t('mall/order_send_template', '修改网点信息');?>' : '<?= \Yii::t('mall/order_send_template', '添加网点信息');?>'" :visible.sync="outletInformation">
        <el-form :model="outletform" :rules="rules" label-width="100px" ref="ruleForm">
            <div style="width: 95%" flex="main:justify">
                <el-form-item style="width: 50%" label="<?= \Yii::t('mall/order_send_template', '网点名称');?>" props="name" required>
                    <el-input v-model="outletform.name"></el-input>
                </el-form-item>
                <el-form-item style="width: 50%" label="<?= \Yii::t('mall/order_send_template', '联系人');?>" props="username" required>
                    <el-input v-model="outletform.username"></el-input>
                </el-form-item>
            </div>
            <div style="width: 95%" flex="main:justify">
                <el-form-item style="width: 50%" label="<?= \Yii::t('mall/order_send_template', '联系方式');?>" props="mobile" required>
                    <el-input v-model="outletform.mobile" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item style="width: 50%" label="<?= \Yii::t('mall/order_send_template', '网点邮编');?>" props="code" required>
                    <el-input v-model="outletform.code" autocomplete="off"></el-input>
                </el-form-item>
            </div>
            <div style="width: 95%" flex="">
                <el-form-item style="width: 50%" label="<?= \Yii::t('mall/order_send_template', '网点地址');?>" props="area" required>
                    <el-cascader
                            :options="district"
                            :props="props"
            ...
            <el-form-item style="width: 50%" label="<?= \Yii::t('mall/order_send_template', '详细地址');?>" props="address" required>
                <el-input
                        type="textarea"
                        :rows="2"
                        placeholder="<?= \Yii::t('mall/order_send_template', '请输入内容');?>"
                        v-model="outletform.address">
                </el-input>
            </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
            <el-button size="smill" @click="cancelOut()"><?= \Yii::t('mall/order_send_template', '取消');?></el-button>
            <el-button size="smill" type="primary" @click="saveOutlet('ruleForm')"><?= \Yii::t('mall/order_send_template', '确定');?></el-button>
        </div>
    </el-dialog>
    <el-dialog title="<?= \Yii::t('mall/order_send_template', '打印设置');?>" :visible.sync="settingVisible" width="30%">
        <el-form  label-width="100px" ref="ruleForm" @submit.native.prevent>
            <el-form-item  label="<?= \Yii::t('mall/order_send_template', '页面设置');?>" props="username" >
                <div>
                    <div>
                        <el-radio v-model="printSetting.page_type"  :label="1"><?= \Yii::t('mall/order_send_template', '按间距连续打印');?></el-radio>
                    </div>
                    <div>
                        <el-radio v-model="printSetting.page_type"  :label="2"><?= \Yii::t('mall/order_send_template', '每版打印一页');?></el-radio>
                    </div>
                </div>
            </el-form-item>
            <el-form-item style="width: 80%" label="<?= \Yii::t('mall/order_send_template', '发货单间距');?>" props="name" >
        ...
        <div slot="footer" class="dialog-footer">
            <el-button size="smill" @click="settingVisible = false"><?= \Yii::t('mall/order_send_template', '取消');?></el-button>
            <el-button size="smill" type="primary" @click="saveSetting"><?= \Yii::t('mall/order_send_template', '确定');?></el-button>
        </div>
    </el-dialog>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="<?= \Yii::t('mall/order_send_template', '发货单管理');?>" name="first">
                <el-card shadow="never" class="mt-24">
                    <template v-if="!edit">
                        <div flex="main:justify">
                            <span><?= \Yii::t('mall/order_send_template', '网点信息');?></span>
                            <el-button type="primary" size="small" @click="openOutlet">{{address_list.length > 0 ?
                                '<?= \Yii::t('mall/order_send_template', '修改网点信息');?>' : '<?= \Yii::t('mall/order_send_template', '添加网点信息');?>'}}
                            </el-button>
                        </div>
                        <div style="height: 40px;background-color: #f3f5f6;line-height: 40px;text-align: center;marginBottom: 15px;marginTop: 30px">
                            <?= \Yii::t('mall/order_send_template', '发货地址');?>
                        </div>
                        <el-table
                                max-height="360"
                                :data="address_list"
                            ...
                            <el-table-column
                                    prop="name"
                                    label="<?= \Yii::t('mall/order_send_template', '网点名称');?>"
                                    width="180">
                            </el-table-column>
                            <el-table-column
                                    prop="username"
                                    label="<?= \Yii::t('mall/order_send_template', '联系人');?>"
                                    width="180">
                            </el-table-column>
                            <el-table-column
                                    prop="mobile"
                                    width="180"
                                    label="<?= \Yii::t('mall/order_send_template', '联系方式');?>">
                            </el-table-column>
                            <el-table-column
                                    label="<?= \Yii::t('mall/order_send_template', '地址');?>">
                    ...
                    <template v-if="edit">
                        <div style="margin-bottom: 40px">
                            <span><?= \Yii::t('mall/order_send_template', '添加发货单模板');?></span>
                        </div>
                        <el-form label-width="125px">
                            <div class="tem-name"
                                 style="max-width:770px; height: 68px;line-height: 68px;border: 1px solid #e8eaee">
                                <el-form-item label="<?= \Yii::t('mall/order_send_template', '模板名称');?>" style="700px">
                            ...
                            <el-table
                                ...
                                <el-table-column
                                        prop="date"
                                        label="<?= \Yii::t('mall/order_send_template', '模板宽');?>"
                                        width="180">
                                    <template slot-scope="scope">
                                        <el-input
                                                size="small"
                                ...
                                <el-table-column
                                        prop="name"
                                        label="<?= \Yii::t('mall/order_send_template', '模板高');?>"
                                        width="180">
                                    <template slot-scope="scope">
                                        <el-input
                                                size="small"
                                ...
                                <el-table-column
                                        prop="address"
                                        label="<?= \Yii::t('mall/order_send_template', '左边距');?>">
                                    <template slot-scope="scope">
                                        <el-input
                                                size="small"
                                                class="input-with-select"
                                ...
                                <el-table-column
                                        prop="address"
                                        label="<?= \Yii::t('mall/order_send_template', '模板边框宽度');?>">
                                    <template slot-scope="scope">
                                        <el-input
                                                size="small"
                                                class="input-with-select"
                            ...
                            <div style="height: 140px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;margin-bottom: 25px;"
                                ...
                                <div class="template-name"
                                    ...
                                    <el-form-item label="<?= \Yii::t('mall/order_send_template', '发货单标题');?>">
                                ...
                                <el-form class="invoice-title" style="margin-top: 18px;" :inline="true" size="mini"
                                    ...
                                    <img @click="headline.underline = !headline.underline"
                                         ...
                                         style="width: 25px; height: 25px;margin-right:7px;cursor: pointer">
                                    <el-form-item label="<?= \Yii::t('mall/order_send_template', '字体');?>" style="width: 155px" flex="">
                                        <el-select v-model="headline.fimaly">
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '宋体');?>" value="<?= \Yii::t('mall/order_send_template', '宋体');?>"></el-option>
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '微软雅黑');?>" value="<?= \Yii::t('mall/order_send_template', '微软雅黑');?>"></el-option>
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '黑体');?>" value="<?= \Yii::t('mall/order_send_template', '黑体');?>"></el-option>
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '华文中宋');?>" value="<?= \Yii::t('mall/order_send_template', '华文中宋');?>"></el-option>
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '幼圆');?>" value="<?= \Yii::t('mall/order_send_template', '幼圆');?>"></el-option>
                                        </el-select>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('mall/order_send_template', '字大小');?>" flex="" style="width: 150px">
                                    ...
                                    <el-form-item label="<?= \Yii::t('mall/order_send_template', '对齐');?>" flex="" style="width: 135px">
                                        <el-select v-model="headline.align">
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '居中');?>" :value="0"></el-option>
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '靠左');?>" :value="1"></el-option>
                                            <el-option label="<?= \Yii::t('mall/order_send_template', '靠右');?>" :value="2"></el-option>
                                        </el-select>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('mall/order_send_template', '字间距');?>" flex="" style="width: 155px">
                            ...
                            <div style="height: 70px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;line-height:70px;padding-left: 18px;margin-bottom: 25px;"
                                 v-if="show === 1">
                                <el-checkbox v-model="order.orderNumber" label="<?= \Yii::t('mall/order_send_template', '订单号');?>"></el-checkbox>
                                <el-checkbox v-model="order.time" label="<?= \Yii::t('mall/order_send_template', '订单时间');?>"></el-checkbox>
                                <el-checkbox v-model="order.date" label="<?= \Yii::t('mall/order_send_template', '打印日期');?>"></el-checkbox>
                            </div>
                            <div style="margin-bottom: 25px;height: 105px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;line-height:40px;padding-left: 18px;"
                                 v-if="show === 2">
                                <el-checkbox v-model="personalInf.name" label="<?= \Yii::t('mall/order_send_template', '收货人姓名');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.nickname" label="<?= \Yii::t('mall/order_send_template', '收货人昵称');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.phone" label="<?= \Yii::t('mall/order_send_template', '联系方式');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.payMethod" label="<?= \Yii::t('mall/order_send_template', '支付方式');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.shipMethod" label="<?= \Yii::t('mall/order_send_template', '发货方式');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.address" label="<?= \Yii::t('mall/order_send_template', '收货地址');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.mention_address" label="<?= \Yii::t('mall/order_send_template', '自提门店地址');?>"></el-checkbox>
                                <el-checkbox v-model="personalInf.leaveComments" label="<?= \Yii::t('mall/order_send_template', '买家留言');?>"></el-checkbox>
                            </div>
                            <div style="margin-bottom: 25px;" class="goodsInf" v-if="show === 3">
                                <el-checkbox v-model="goodsInf.serial" label="<?= \Yii::t('mall/order_send_template', '序号');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.name" label="<?= \Yii::t('mall/order_send_template', '商品名称');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.attr" label="<?= \Yii::t('mall/order_send_template', '规格');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.unitPrice" label="<?= \Yii::t('mall/order_send_template', '单价');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.number" label="<?= \Yii::t('mall/order_send_template', '数量');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.unit" label="<?= \Yii::t('mall/order_send_template', '单位');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.univalent" label="<?= \Yii::t('mall/order_send_template', '小计');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.article_number" label="<?= \Yii::t('mall/order_send_template', '货号');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.amount" label="<?= \Yii::t('mall/order_send_template', '订单金额');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.totalAmount" label="<?= \Yii::t('mall/order_send_template', '总数量');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.fare" label="<?= \Yii::t('mall/order_send_template', '运费');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.discount" label="<?= \Yii::t('mall/order_send_template', '优惠');?>"></el-checkbox>
                                <el-checkbox v-model="goodsInf.actually_paid" label="<?= \Yii::t('mall/order_send_template', '实付');?>"></el-checkbox>
                            </div>
                            <div style="margin-bottom: 25px;height: 70px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;line-height:70px;padding-left: 18px;"
                                 v-if="show === 4">
                                <el-checkbox v-model="sellerInf.branch" label="<?= \Yii::t('mall/order_send_template', '网点名称');?>"></el-checkbox>
                                <el-checkbox v-model="sellerInf.name" label="<?= \Yii::t('mall/order_send_template', '联系人');?>"></el-checkbox>
                                <el-checkbox v-model="sellerInf.phone" label="<?= \Yii::t('mall/order_send_template', '联系方式');?>"></el-checkbox>
                                <el-checkbox v-model="sellerInf.postcode" label="<?= \Yii::t('mall/order_send_template', '网点邮编');?>"></el-checkbox>
                                <el-checkbox v-model="sellerInf.address" label="<?= \Yii::t('mall/order_send_template', '网点地址');?>"></el-checkbox>
                                <el-checkbox v-model="sellerInf.remark" label="<?= \Yii::t('mall/order_send_template', '卖家备注');?>"></el-checkbox>
                            </div>
                            <div style="margin-bottom: 25px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;"
                                ...
                                <div style="width: 100%;height: 73px;border-right: 1px solid #e4e5eb;padding-left: 15px;padding: 20px 0 0 20px;"
                                     flex="dir:top main:center ">
                                        <span style="font-size: 13px;color: #999999;margin-bottom: 5px;"
                                              flex="cross:center">
                                            <span><?= \Yii::t('mall/order_send_template', '图片上传');?></span>
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/order_send_template', '最多六张');?>" placement="top-start">
                                    ...
                                    <app-attachment @selected="upadtePic">
                                        <el-button
                                            ...
                                            <?= \Yii::t('mall/order_send_template', '选择图片');?>
                                        </el-button>
                                    </app-attachment>
                                </div>
                                ...
                                <div style="height: 95px;border-bottom: 1px solid #e4e5eb;border-top: 1px solid #e4e5eb;"
                                    ...
                                    <div class="order-template"
                                        ...
                                        <span style="font-size: 13px;color: #999999;margin-bottom: 5px;"
                                              flex="cross:center">
                                            <span><?= \Yii::t('mall/order_send_template', '图片宽度');?></span>
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/order_send_template', '最大图片宽度限制为47mm');?>" placement="top-start">
                                                <image src="statics/img/mall/order/prompt.png"
                                                       style="width:14px;height:14px;margin-left: 5px;"></image>
                                            </el-tooltip>
                                        </span>
                                    ...
                                    <div class="order-template"
                                         style="width: 33%;height: 100%;border-right: 1px solid #e4e5eb;padding-left: 15px;"
                                         flex="dir:top main:center ">
                                        <span style="font-size: 13px;color: #999999;margin-bottom: 5px;"><?= \Yii::t('mall/order_send_template', '上边距');?></span>
                                    ...
                                    <div class="order-template" style="width: 33%;height: 100%;padding-left: 15px;"
                                         flex="dir:top main:center ">
                                        <span style="font-size: 13px;color: #999999;margin-bottom: 5px;"><?= \Yii::t('mall/order_send_template', '左边距');?></span>
                                        <el-input v-model="setImage.left"
                                                  style="width: 120px; height: 30px;margin-top: 5px;"></el-input>
                                    </div>
                                </div>
                                <div style="height: 122px;padding-left:15px;" flex="cross:center">
                                    <div style="height: 88px;"><span><?= \Yii::t('mall/order_send_template', '备注');?></span></div>
                                    <div id="textarea"
                            ...
                            <div id="invoice"
                                ...
                                <div
                                    ...
                                    <div style="width: 50%;font-size:10px;line-height:1;margin-bottom: 6px"
                                         v-if="order.date"><?= \Yii::t('mall/order_send_template', '打印日期');?>
                                    </div>
                                ...
                                <div @mouseenter="mouseenter(2, true)"
                                    ...
                                    >
                                        <div style="font-size:10px;line-height:1.5;" v-if="personalInf.name"><?= \Yii::t('mall/order_send_template', '收货人信息');?>
                                        </div>
                                ...
                                <div @click="showTab(3)"
                                    ...
                                    <div style="display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;"
                                        ...
                                        <div style="width: 6%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                             v-if="goodsInf.serial"><?= \Yii::t('mall/order_send_template', '序号');?>
                                        </div>
                                        <div  style="display: flex;min-width: 0;-webkit-box-flex: 1;flex-grow: 1;flex-shrink: 1;" v-if="goodsInf.name || goodsInf.attr || goodsInf.unitPrice">
                                            <div :style="{width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '50%' : goodsInf.name && (!goodsInf.attr || !goodsInf.unitPrice) ? '75%' : '100%'}"  v-if="goodsInf.name" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"><?= \Yii::t('mall/order_send_template', '商品名称');?>
                                            </div>
                                            <div :style="
                                     {
                                         ...
                                         }" v-if="goodsInf.attr" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;"><?= \Yii::t('mall/order_send_template', '规格');?>
                                            </div>
                                    ...
                                    <div style="display: flex;border-bottom: 1px solid #000000;position: relative;left: -0.5px;"
                                        ...
                                        <div style="display: flex;min-width: 0;-webkit-box-flex: 1;flex-grow: 1;flex-shrink: 1;" v-if="goodsInf.name || goodsInf.attr || goodsInf.unitPrice">
                                            <div :style="{width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '50%' : goodsInf.name && (!goodsInf.attr || !goodsInf.unitPrice) ? '75%' : '100%'}" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                                 v-if="goodsInf.name">
                                                <span><?= \Yii::t('mall/order_send_template', '男士羊毛衫');?></span>
                                            </div>
                                            <div :style="
                                     {
                                         width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '25%' : !goodsInf.name && goodsInf.attr && goodsInf.unitPrice  ? '50%' : goodsInf.name && goodsInf.attr && !goodsInf.unitPrice ? '50%' : '100%'
                                ...
                                <div @click="showTab(4)"
                                    ...
                                    <div :style="{width:`${!sellerInf.remark ? '100%': '62%'}`,padding: '10px 10px 10px .5%', fontSize: '10px',borderRight: `${!sellerInf.remark ? 'none' : '1px solid #000000'}`}"
                                        ...
                                        <div v-if="sellerInf.branch"><?= \Yii::t('mall/order_send_template', '网点名称');?></div>
                                        <div v-if="sellerInf.name"><?= \Yii::t('mall/order_send_template', '联系人');?></div>
                                        <div v-if="sellerInf.phone"><?= \Yii::t('mall/order_send_template', '联系方式');?></div>
                                        <div v-if="sellerInf.postcode"><?= \Yii::t('mall/order_send_template', '网点邮编');?></div>
                                        <div v-if="sellerInf.address"><?= \Yii::t('mall/order_send_template', '网点地址');?></div>
                                    </div>
                                    <div :style="{width: `${!sellerInf.branch && !sellerInf.name && !sellerInf.phone && !sellerInf.postcode && !sellerInf.address ? '100%' : '38%'}`,padding: '10px 10px 10px .5%', fontSize: '10px'}"
                                        ...
                                        <?= \Yii::t('mall/order_send_template', '卖家备注');?>
                                    </div>
                                </div>
                                <div
                ...
                <el-card v-if="!edit" style="marginTop: 15px;">
                    <div flex="main:justify" style="margin-bottom: 35px;">
                        <span><?= \Yii::t('mall/order_send_template', '发货单模板');?></span>
                        <el-button type="primary" size="small" @click="addInvoiceTemplate"><?= \Yii::t('mall/order_send_template', '添加发货单模板');?></el-button>
                    </div>
                    <el-table
                            max-height="360"
                            :data="template_list"
                        ...
                        <el-table-column
                                prop="name"
                                label="<?= \Yii::t('mall/order_send_template', '模板名称');?>"
                                width="180">
                        </el-table-column>
                        <el-table-column
                                prop="username"
                                label="<?= \Yii::t('mall/order_send_template', '模板大小');?>"
                                width="180">
                            <template slot-scope="scope">
                            ...
                            <template slot-scope="scope">
                                <div class="offset">
                                    <span style="margin-right: 30px;">
                                        <?= \Yii::t('mall/order_send_template', '左');?>
                        ...
                        <el-table-column
                                prop="mobile"
                                label="<?= \Yii::t('mall/order_send_template', '设为默认');?>">
                            <template slot-scope="scope">
                        ...
                        <el-table-column
                                prop="code"
                                label="<?= \Yii::t('mall/order_send_template', '操作');?>">
                            <template slot-scope="scope">
                                <div flex="">
                                    <el-tooltip class="item" effect="dark"
                                                content="<?= \Yii::t('mall/order_send_template', '编辑');?>" placement="top">
                                        <img class="app-order-icon"
                                             @click.stop="editTemplate(scope.row)"
                                             src="statics/img/mall/edit.png" alt="">
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('mall/order_send_template', '打印测试');?>" placement="top">
                                        <img class="app-order-icon"
                                             @click.stop="printTest(scope.row)"
                                             src="statics/img/mall/order/print.png" alt="">
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="<?= \Yii::t('mall/order_send_template', '打印预览');?>" placement="top">
                                        <img class="app-order-icon"
                                             @click.stop="printPreview(scope.row)"
                                             src="statics/img/mall/order/preview.png" alt="">
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark"
                                                content="<?= \Yii::t('mall/order_send_template', '删除');?>" placement="top">
                                        <img class="app-order-icon"
                                             @click.stop="deleteTemp(scope.row)"
                                             src="statics/img/mall/del.png" alt="">
                                    </el-tooltip>
                                    <el-tooltip  class="item" effect="dark"
                                                 content="<?= \Yii::t('mall/order_send_template', '打印设置');?>" placement="top">
                                        <img class="app-order-icon"
                ...
                <el-dialog
                        title="<?= \Yii::t('mall/order_send_template', '预览');?>"
                ...
                >
                    ...
                    <span slot="footer" class="dialog-footer">
                        <el-button type="primary" @click="isPrintPreview = false"><?= \Yii::t('mall/order_send_template', '确定');?></el-button>
                    </span>
                </el-dialog>
            </el-tab-pane>
            <el-tab-pane label="<?= \Yii::t('mall/order_send_template', '批量打印');?>" name="second">
                <el-card>
                    <app-order
                            :tabs="tabs"
        ...
        <el-button type="primary" @click="save" :loading="saveloading" v-if="edit && !showList"><?= \Yii::t('mall/order_send_template', '保存');?></el-button>
        <div id="print" v-show="false" class="print-div">
            <div v-for="(item) in printData"
                ...
                <div id="invoice"
                    ...
                    >
                        <div style="width: 50%;font-size:10px;line-height:1;margin-bottom: 6px"
                             v-if="printPar.order.date"><?= \Yii::t('mall/order_send_template', '打印日期');?>{{printTime}}
                        </div>
                        <div style="width: 50%;font-size:10px;line-height:1;" v-if="printPar.order.time">
                            <?= \Yii::t('mall/order_send_template', '订单时间');?>{{item.pay_time}}
                        </div>
                        <div style="width: 50%;font-size:10px;line-height:1;" v-if="printPar.order.orderNumber">
                            <?= \Yii::t('mall/order_send_template', '订单号');?>{{item.order_no}}
                        </div>
                    </div>
                    <div :style="{display: 'flex', boxSizing: 'border-box'}"
                        ...
                        >
                            <div style="font-size:10px;line-height:1.5;" v-if="printPar.personalInf.name">
                                <?= \Yii::t('mall/order_send_template', '收货人信息');?>{{item.name}}
                            </div>
                            <div style="font-size:10px;line-height:1.5;" v-if="printPar.personalInf.nickname">
                                <?= \Yii::t('mall/order_send_template', '收货人昵称');?>{{item.nickname}}
                            </div>
                            <div style="font-size:10px;line-height:1.5;" v-if="printPar.personalInf.phone">
                                <?= \Yii::t('mall/order_send_template', '联系方式');?>{{item.mobile}}
                            </div>
                            <div style="font-size:10px;line-height:1.5;" v-if="printPar.personalInf.payMethod">
                                <?= \Yii::t('mall/order_send_template', '支付方式');?>{{item.pay_type == 1 ? '<?= \Yii::t('mall/order_send_template', '在线支付');?>' : item.pay_type == 2 ? '<?= \Yii::t('mall/order_send_template', '货到付款');?>' : item.pay_type == 3 ?
                                '<?= \Yii::t('mall/order_send_template', '余额支付');?>' : ''}}
                            </div>
                            <div style="font-size:10px;line-height:1.5;"
                                 v-if="printPar.personalInf.shipMethod && item.send_type != 1"><?= \Yii::t('mall/order_send_template', '发货方式');?>{{item.send_type ==
                                0 ? '<?= \Yii::t('mall/order_send_template', '快递配送');?>' : item.send_type == 1 ? '<?= \Yii::t('mall/order_send_template', '到店自提');?>' : item.send_type == 2 ? '<?= \Yii::t('mall/order_send_template', '同城配送');?>' : ''}}
                            </div>
                            <div style="font-size:10px;line-height:1.5;"
                                 v-if="printPar.personalInf.address && item.send_type != 1"><?= \Yii::t('mall/order_send_template', '收货地址');?>{{item.address}}
                            </div>
                            <div style="font-size:10px;line-height:1.5;"
                                 v-if="printPar.personalInf.mention_address && item.send_type == 1">
                                <?= \Yii::t('mall/order_send_template', '自提门店地址');?>{{item.store_address}}
                            </div>
                        </div>
                        <div :style="{width: `${printPar.personalInf.name || printPar.personalInf.nickname || printPar.personalInf.phone || printPar.personalInf.address  || printPar.personalInf.payMethod || printPar.personalInf.shipMethod ? '38%' : '100%'}`,borderBottom:'1px solid #000000',padding: '10px 10px 10px 0.5%', fontSize:'10px', boxSizing: 'border-box', lineHeight:'1.2', boxSizing: 'border-box'}"
                            ...
                            <?= \Yii::t('mall/order_send_template', '买家留言');?>{{item.remark}}
                        </div>
                    </div>
                    <div style="width: 100%;box-sizing:border-box;">
                        <div style="display: flex;border-bottom:1px solid #000000;width: 100%;position: relative;left: -0.5px;"
                            ...
                            <div style="width: 6%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                 v-if="printPar.goodsInf.serial"><?= \Yii::t('mall/order_send_template', '序号');?>
                            </div>
                            <div :style="tableWidth" style="display: flex;" v-if="printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.unitPrice">
                                ...
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 40%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                     ...
                                     v-if="printPar.goodsInf.attr"><?= \Yii::t('mall/order_send_template', '规格');?>
                                </div>
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 60%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                            ...
                            <div style="width: 8%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                 v-if="printPar.goodsInf.number"><?= \Yii::t('mall/order_send_template', '数量');?>
                            </div>
                            <div style="width: 12%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                 v-if="printPar.goodsInf.univalent"><?= \Yii::t('mall/order_send_template', '小计');?>
                            </div>
                            <div style="width: 18%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                 v-if="printPar.goodsInf.article_number"><?= \Yii::t('mall/order_send_template', '货号');?>
                            </div>
                            <div style="width: 8%;height: 30px;line-height: 30px;box-sizing:border-box;border-left: 1px solid #000000;padding-left: 10px;font-size:10px;"
                                 v-if="printPar.goodsInf.unit"><?= \Yii::t('mall/order_send_template', '单位');?>
                            </div>
                        </div>
                        ...
                        <div style="display: flex;height: 30px;padding-left: 0.5%;border-bottom:1px solid #000000;font-size: 10px"
                            ...
                            <div style="width: 24%;height: 30px;line-height:30px;" v-if="printPar.goodsInf.amount">
                                <?= \Yii::t('mall/order_send_template', '订单金额');?>￥{{item.total_goods_original_price}}
                            </div>
                            <div style="width: 16%;height: 30px;line-height:30px;" v-if="printPar.goodsInf.totalAmount">
                                <?= \Yii::t('mall/order_send_template', '总数量');?>{{item.goods_num}}
                            </div>
                            <div style="width: 21%;height: 30px;line-height:30px;" v-if="printPar.goodsInf.fare">
                                <?= \Yii::t('mall/order_send_template', '运费');?>￥{{item.express_price}}
                            </div>
                            <div style="width: 20%;height: 30px;line-height:30px;" v-if="printPar.goodsInf.discount">
                                <?= \Yii::t('mall/order_send_template', '优惠');?>￥{{item.send_template_discount_price}}
                            </div>
                            <div style="width: 19%;height: 30px;line-height:30px;"
                                 v-if="printPar.goodsInf.actually_paid"><?= \Yii::t('mall/order_send_template', '实付');?>￥{{item.total_pay_price}}
                            </div>
                        </div>
                    </div>
                    <div :style="{display:'flex',borderBottom:'1px solid #000000', boxSizing: 'border-box'}"
                        ...
                        <div v-if="address_list.length>0"
                            ...
                            <div v-if="printPar.sellerInf.branch"><?= \Yii::t('mall/order_send_template', '网点名称');?>{{address_list[0].name}}</div>
                            <div v-if="printPar.sellerInf.name"><?= \Yii::t('mall/order_send_template', '联系人');?>{{address_list[0].username}}</div>
                            <div v-if="printPar.sellerInf.phone"><?= \Yii::t('mall/order_send_template', '联系方式');?>{{address_list[0].mobile}}</div>
                            <div v-if="printPar.sellerInf.postcode"><?= \Yii::t('mall/order_send_template', '网点邮编');?>{{address_list[0].code}}</div>
                            <div v-if="printPar.sellerInf.address">
                                <?= \Yii::t('mall/order_send_template', '网点地址');?>{{address_list[0].province}}{{address_list[0].city}}{{address_list[0].district}}{{address_list[0].address}}
                            </div>
                        </div>
                        <div :style="{boxSizing: 'border-box',width: `${!printPar.sellerInf.branch && !printPar.sellerInf.name && !printPar.sellerInf.phone && !printPar.sellerInf.postcode && !printPar.sellerInf.address ? '100%' : '38%'}`,padding: ' 10px 10px 10px .5%', fontSize: '10px'}"
                            ...
                            <?= \Yii::t('mall/order_send_template', '卖家备注');?>{{item.seller_remark}}
                        </div>
                    </div>
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                tabs: [
                    {value: '-1', name: '<?= \Yii::t('mall/order_send_template', '全部');?>'},
                    {value: '1', name: '<?= \Yii::t('mall/order_send_template', '待发货');?>'},
                    {value: '2', name: '<?= \Yii::t('mall/order_send_template', '待收货');?>'}
                ],
                selectList: [
                    {value: '1', name: '<?= \Yii::t('mall/order_send_template', '订单号');?>'},
                    {value: '5', name: '<?= \Yii::t('mall/order_send_template', '商品名称');?>'}
                ],
                edit: false,
                showList: false,
                activeName: 'first',
                show: 0,
                template_name: '<?= \Yii::t('mall/order_send_template', '模板');?>',
                stencil_width: 204,
                stencil_high: 142,
                ...
                headline: {
                    name: '<?= \Yii::t('mall/order_send_template', '发货单');?>',
                    fimaly: "<?= \Yii::t('mall/order_send_template', '微软雅黑');?>",
                    font: 16,
                    align: 0,
                    line: 48,
                    space: 0,
                ...
                rules: {
                    name: [
                        {required: true, message: '<?= \Yii::t('mall/order_send_template', '请输入网点名称');?>', trigger: 'blur'}
                    ],
                    username: [
                        {required: true, message: '<?= \Yii::t('mall/order_send_template', '请输入网点名称');?>', trigger: 'blur'}
                    ],
                ...
                template_name_1: '<?= \Yii::t('mall/order_send_template', '默认模板');?>',
                printPar: {
                    printSetting: {
                        page_type: 1,
                        space: 10
                ...
                printData: [],
                printTime: '2020<?= \Yii::t('mall/order_send_template', '年');?>2<?= \Yii::t('mall/order_send_template', '月');?>10<?= \Yii::t('mall/order_send_template', '日');?>',
                changeOffsetId: 0,
                saveloading: false,
                setImage: {
                    width: 47,
        ...
        methods: {
            ...
            print_invoice(express_list, order_list) {
                ...
                if (order_list.length === 0) {
                    this.$message({
                        message: '<?= \Yii::t('mall/order_send_template', '请先勾选订单');?>',
                        type: 'warning'
                    });
                    return;
                }
                let date = new Date();
                let Y = date.getFullYear() + '<?= \Yii::t('mall/order_send_template', '年');?>';
                let M = (date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1) + '<?= \Yii::t('mall/order_send_template', '月');?>';
                let D = date.getDate() + '<?= \Yii::t('mall/order_send_template', '日');?>';
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        let newWindow = window.open("<?= \Yii::t('mall/order_send_template', '打印窗口');?>", "_blank");//打印窗口要换成页面的url
                ...
                this.printData = [
                    {
                        ...
                        name: '<?= \Yii::t('mall/order_send_template', '张三');?>',
                        nickname: '<?= \Yii::t('mall/order_send_template', '屋顶上的小猫咪');?>',
                        mobile: '0573-82261300',
                        address: '<?= \Yii::t('mall/order_send_template', '湖北省长沙市蔡锷北路三单元201号');?>',
                        remark: '<?= \Yii::t('mall/order_send_template', '尽快发货');?>',
                        ...
                        detail: [
                            {
                                name: '<?= \Yii::t('mall/order_send_template', '男士羊毛衫');?>',
                                num: '1',
                                unit: '<?= \Yii::t('mall/order_send_template', '件');?>',
                                unit_price: '110',
                                price: '110',
                                id: 1,
                                goods_no: 'A1',
                                attr: '<?= \Yii::t('mall/order_send_template', '规格');?>'
                            }
                        ],
                        send_type: 0,
                        pay_type: 1
            ...
            deleteTemp(e) {
                this.$confirm('<?= \Yii::t('mall/order_send_template', '此操作将永久删除该模板');?>?', '<?= \Yii::t('mall/order_send_template', '提示');?>', {
                    confirmButtonText: '<?= \Yii::t('mall/order_send_template', '确定');?>',
                    cancelButtonText: '<?= \Yii::t('mall/order_send_template', '取消');?>',
                    type: 'warning'
                }).then(() => {
                    request({
                        params: {
                        ...
                        if (res.data.code === 0) {
                            ...
                            this.template_name_1 = '<?= \Yii::t('mall/order_send_template', '默认模板');?>';
                            this.$message({
                                type: 'success',
                                message: '<?= \Yii::t('mall/order_send_template', '删除成功');?>!'
                            });
                        } else {
                    ...
                    this.$message({
                        type: 'info',
                        message: '<?= \Yii::t('mall/order_send_template', '已取消删除');?>'
                    });
                });
            },
            handleClick(e) {
            ...
            changeOffset(e) {
                ...
                request({
                    ...
                    if (e.data.code === 0) {
                        this.$message({
                            type: 'success',
                            message: '<?= \Yii::t('mall/order_send_template', '修改成功');?>!'
                        });
                    } else {
                        this.$message.error(e.data.msg);
                    }
            ...
            saveOutlet(formName) {
                ...
                if (!address) {
                    this.$message({
                        type: 'warning',
                        message: '<?= \Yii::t('mall/order_send_template', '详细地址不能为空');?>'
                    });
                    return;
                }
                if (!name) {
                    this.$message({
                        type: 'warning',
                        message: '<?= \Yii::t('mall/order_send_template', '网点名称不能为空');?>'
                    });
                    return;
                }
                if (!username) {
                    this.$message({
                        type: 'warning',
                        message: '<?= \Yii::t('mall/order_send_template', '联系人不能为空');?>'
                    });
                    return;
                }
                if (!mobile) {
                    this.$message({
                        type: 'warning',
                        message: '<?= \Yii::t('mall/order_send_template', '联系方式不能为空');?>'
                    });
                    return;
                }
                if (!code) {
                    this.$message({
                        type: 'warning',
                        message: '<?= \Yii::t('mall/order_send_template', '网点邮编不能为空');?>'
                    });
                    return;
                }
                if (area.length < 3) {
                    this.$message({
                        type: 'warning',
                        message: '<?= \Yii::t('mall/order_send_template', '网点地址不能为空');?>'
                    });
                    return;
                }
            ...
            async save() {
                ...
                if (!template_name) {
                    this.$message({
                        message: '<?= \Yii::t('mall/order_send_template', '模板名称不能为空');?>',
                        type: 'warning'
                    });
                    return;
                }
                ...
                if (e.data.code === 0) {
                    ...
                    this.template_name = '<?= \Yii::t('mall/order_send_template', '模板');?>';
                    this.$message.success('<?= \Yii::t('mall/order_send_template', '保存成功');?>');
                    this.order = {
                        orderNumber: true,
                        time: true,
                        date: true
        ...
        filters: {
            conversion(data) {
                let str = '';
                data ? str = '<?= \Yii::t('mall/order_send_template', '打印');?>' : str = '<?= \Yii::t('mall/order_send_template', '不打印');?>';
                return str;
            }
        },
        computed: {
