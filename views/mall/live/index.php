...
<div id="app" v-cloak>
    <el-card shadow="never" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span><?= \Yii::t('mall/live', '直播管理');?></span>
            </div>
        </div>
        <div class="table-body">
            <el-button :loading="buttonLoading" style="margin-bottom: 15px;" type="primary" size="small" @click="$navigate({r: 'mall/live/live-edit'})"><?= \Yii::t('mall/live', '创建直播间');?></el-button>
            <el-table
                ...
                <el-table-column
                        width="80"
                        prop="roomid"
                        label="<?= \Yii::t('mall/live', '房间ID');?>"
                        width="120">
                </el-table-column>
                <el-table-column
                        label="<?= \Yii::t('mall/live', '房间名');?>"
                        width="220">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.live_status != 103" @click="addGoods(scope.row)" type="text" circle size="mini">
                            <el-tooltip class="item" effect="dark" content="<?= \Yii::t('mall/live', '编辑直播商品');?>" placement="top">
                        ...
                        <el-button v-if="scope.row.live_status != 103" @click="getQrCode(scope.row)" type="text" circle size="mini">
                            <el-tooltip class="item" effect="dark" content="<?= \Yii::t('mall/live', '获取直播二维码');?>" placement="top">
            ...
            <el-dialog
                ...
                <el-button size="small" type="primary" @click="qrCodeData.dialogVisible = false"><?= \Yii::t('mall/live', '确定');?></el-button>
              </span>
            </el-dialog>
