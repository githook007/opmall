...
<div id="app" v-cloak>
    <el-card v-loading="loading" style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="<?= \Yii::t('mall/index', '基本信息');?>" name="first">
                    <el-row>
                        <el-col :span="24">
                            <div class="title">
                                <span><?= \Yii::t('mall/index', '基本设置');?></span>
                            </div>
                            <div class="form-body">
                                <el-form-item label="<?= \Yii::t('mall/index', '商城名称');?>" prop="name">
                                    <el-input v-model="ruleForm.name" maxlength="15" placeholder="<?= \Yii::t('mall/index', '最多输入15个字符');?>"></el-input>
                                </el-form-item>

                                <el-form-item label="<?= \Yii::t('mall/index', '店铺logo');?>" prop="mall_logo_pic">
                                    <app-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                                                    @selected="mallLogoPic">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:40 * 40"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                        </el-tooltip>
                                    </app-attachment>
                                    ...
                                    <el-button size="mini" @click="resetImg('mall_logo_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                </el-form-item>

                                <el-form-item label="<?= \Yii::t('mall/index', '营业状态');?>" prop="is_open">
                                    <el-radio v-model="ruleForm.setting.is_open" :label="1"><?= \Yii::t('mall/index', '营业');?>
                                    </el-radio>
                                    <el-radio v-model="ruleForm.setting.is_open" :label="2"><?= \Yii::t('mall/index', '打烊');?>
                                    </el-radio>
                                </el-form-item>
                                <el-form-item v-if="ruleForm.setting.is_open == 1" label="<?= \Yii::t('mall/index', '营业时间');?>" prop="open_type">
                                    <div>
                                        <el-radio v-model="ruleForm.setting.open_type" :label="1"><?= \Yii::t('mall/index', '全天24小时');?></el-radio>
                                        <el-radio v-model="ruleForm.setting.open_type" :label="2"><?= \Yii::t('mall/index', '自定义时间');?></el-radio>
                                    </div>
                                    <div v-if="ruleForm.setting.open_type == 2" style="margin-top: 10px">
                                        <el-checkbox-group v-model="ruleForm.setting.week_list" size="mini">
                                            <el-checkbox label="1" size="mini"><?= \Yii::t('mall/index', '周一');?></el-checkbox>
                                            <el-checkbox label="2" size="mini"><?= \Yii::t('mall/index', '周二');?></el-checkbox>
                                            <el-checkbox label="3" size="mini"><?= \Yii::t('mall/index', '周三');?></el-checkbox>
                                            <el-checkbox label="4" size="mini"><?= \Yii::t('mall/index', '周四');?></el-checkbox>
                                            <el-checkbox label="5" size="mini"><?= \Yii::t('mall/index', '周五');?></el-checkbox>
                                            <el-checkbox label="6" size="mini"><?= \Yii::t('mall/index', '周六');?></el-checkbox>
                                            <el-checkbox label="0" size="mini"><?= \Yii::t('mall/index', '周日');?></el-checkbox>
                                        </el-checkbox-group>
                                    </div>
                                    <div v-if="ruleForm.setting.open_type == 2" style="margin-top: 10px">
                                        <div v-for="(item,index) in ruleForm.setting.time_list" :key="index" style="margin-bttom: 6px" flex="dir:left cross:center">
                                            ...
                                            selectableRange: '00:00:00 - 23:59:59'
                                                    ...
                                                    placeholder="<?= \Yii::t('mall/index', '开始时间');?>"
                                            ...
                                            selectableRange: '00:00:00 - 23:59:59'
                                                    ...
                                                    placeholder="<?= \Yii::t('mall/index', '结束时间');?>"
                                                    value-format="HH:mm:ss">
                                            </el-time-picker>
                                            <el-button type="text" size="mini" circle @click.native="deleteTime(index)">
                                                <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '删除');?>" placement="top">
                                                    <img src="statics/img/mall/del.png" alt="">
                                                </el-tooltip>
                                            </el-button>
                                        </div>
                                        <el-button v-if="ruleForm.setting.time_list.length < 3" @click="addTime" style="border-color: #3a8ee6;color: #3a8ee6" plain>+<?= \Yii::t('mall/index', '增加时间段');?></el-button>
                                    </div>
                                </el-form-item>
                                <el-form-item v-if="ruleForm.setting.is_open == 2" label="<?= \Yii::t('mall/index', '设置自动开业');?>" prop="is_auto_open">
                                    <div>
                                        <el-radio v-model="ruleForm.setting.is_auto_open" :label="1"><?= \Yii::t('mall/index', '不设置自动开业');?>
                                        </el-radio>
                                        <el-radio v-model="ruleForm.setting.is_auto_open" :label="2"><?= \Yii::t('mall/index', '设置自动开业时间');?>
                                        </el-radio>
                                        <el-date-picker v-model="ruleForm.setting.auto_open_time" type="datetime" placeholder="<?= \Yii::t('mall/index', '选择自动开业时间');?>" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                                    </div>
                                </el-form-item>
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '外链客服链接类型');?>" prop="web_service_type">
                                    <el-radio v-model="ruleForm.setting.web_service_type" :label="1"><?= \Yii::t('mall/index', '其它客服');?>
                                    </el-radio>
                                    <el-radio v-model="ruleForm.setting.web_service_type" :label="2"><?= \Yii::t('mall/index', '企业微信客服');?>
                                    </el-radio>
                                </el-form-item>
                                <el-form-item v-if="ruleForm.setting.web_service_type == '2'" label="<?= \Yii::t('mall/index', '企业微信id');?>" prop="enterprise_wechat_id">
                                    <el-input v-model="ruleForm.setting.enterprise_wechat_id"></el-input>
                                </el-form-item>

                                <el-form-item :label="ruleForm.setting.web_service_type == '2' ? '企业微信客服链接' : '<?= \Yii::t('mall/index', '外链客服链接');?>'"
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '一键导航');?>">
                                    ...
                                    <el-form-item label-width="80px">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '经纬度');?></span>
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '点击地图,可获取经纬度');?>"
                                                        placement="top">
                                        ...
                                        <div flex="dir:left">
                                            <el-input v-model="ruleForm.setting.latitude_longitude"
                                                      placeholder="<?= \Yii::t('mall/index', '请输入经纬度,用英文逗号分离');?>">
                                            </el-input>
                                        </div>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('mall/index', '地图');?>"  label-width="80px">
                                        <div flex="dir:left">
                                ...
                                <el-form-item>
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '跳转小程序');?></span>
                                        <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '悬浮按钮跳转小程序');?>"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                                    <el-form-item label="<?= \Yii::t('mall/index', '小程序appId');?>" label-width="100px">
                                        <el-input v-model="ruleForm.setting.small_app_id"
                                                  placeholder="<?= \Yii::t('mall/index', '请输入跳转小程序AppId');?>">
                                        </el-input>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('mall/index', '小程序路径');?>" label-width="100px">
                                        <el-input v-model="ruleForm.setting.small_app_url"
                                                  placeholder="<?= \Yii::t('mall/index', '请输入跳转小程序路径');?>">
                                        </el-input>
                                    </el-form-item>
                                </el-form-item>
                            </div>
                            <div class="title">
                                <span><?= \Yii::t('mall/index', '交易设置');?></span>
                            </div>
                            <div class="form-body">
                                <el-form-item prop="over_time">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '未支付订单超时时间');?></span>
                                        <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '注意：如设置为0分，则未支付订单将不会被取消，不能超过100');?>"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                                ...
                                <el-form-item prop="delivery_time">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '自动确认收货时间');?></span>
                                        <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '从发货到自动确认收货的时间，不能超过30');?>"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                                    <el-input v-model="ruleForm.setting.delivery_time"
                                              type="number">
                                        <template slot="append"><?= \Yii::t('mall/index', '天');?></template>
                                    </el-input>
                                </el-form-item>
                                <el-form-item prop="after_sale_time">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '售后时间');?></span>
                                        <el-tooltip effect="dark" placement="top">
                                            <div slot="content"><?= \Yii::t('mall/index', '可以申请售后的时间');?><br/>
                                                <?= \Yii::t('mall/index', '注意：分销订单中的已完成订单，只有订单已确认收货，并且时间超过设置的售后天数之后才计入其中！不能超过30');?>
                                            </div>
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                                ...
                                <el-form-item prop="has_order_evaluate" label="<?= \Yii::t('mall/index', '默认好评功能');?>">
                                    ...
                                    <div v-if="ruleForm.setting.has_order_evaluate == 1" style="color:#606266">
                                        <span style="flex-grow: 1"><?= \Yii::t('mall/index', '买家购买商品过售后');?></span>
                                        ...
                                        <span style="flex-grow: 1"><?= \Yii::t('mall/index', '后，若没有主动评论，系统将自动默认好评');?></span>
                                    </div>
                                </el-form-item>
                                <el-form-item prop="payment_type">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '支付方式');?></span>
                                        <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '若都不勾选，默认选中线上支付');?>"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                                    <el-checkbox-group v-model="ruleForm.setting.payment_type" size="mini">
                                        <el-checkbox label="online_pay" size="mini"><?= \Yii::t('mall/index', '线上支付');?></el-checkbox>
                                        <el-checkbox label="huodao" size="mini"><?= \Yii::t('mall/index', '货到付款');?></el-checkbox>
                                        <el-checkbox label="balance" size="mini"><?= \Yii::t('mall/index', '余额支付');?></el-checkbox>
                                        <el-checkbox label="wechat_pay_for_another" size="mini"><?= \Yii::t('mall/index', '微信朋友代付');?></el-checkbox>
                                    </el-checkbox-group>
                                </el-form-item>
                                <el-form-item label="<?= \Yii::t('mall/index', '微信支付分账');?>" prop="status">
                                    <el-switch v-model="ruleForm.setting.profit_sharing"
                                               :active-value="1" :inactive-value="0"></el-switch>
                                    <div style="color: #CCCCCC;"><?= \Yii::t('mall/index', '注：检查微信商户是否开通分账权限，否则支付会报错');?></div>
                                </el-form-item>
                                <el-form-item prop="send_type">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '发货方式');?></span>
                                        <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '需添加门店，到店自提方可生效');?>"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                                    <div>
                                        ...
                                        <div style="color: #CCCCCC;"><?= \Yii::t('mall/index', '注：手机端显示排序');?>（<span v-for="(item, index) in send_type_list" :key="index">{{index + 1}}.{{item}} </span>）</div>
                                        <el-dialog
                                        ...
                                        >
                                            ...
                                            <span slot="footer" class="dialog-footer">
                                                <el-button @click="send_type_dialogVisible = false"><?= \Yii::t('mall/index', '取消');?></el-button>
                                                <el-button type="primary" @click="sureSendType()"><?= \Yii::t('mall/index', '确定');?></el-button>
                                              </span>
                                        </el-dialog>
                                    </div>
                                </el-form-item>
                                <el-form-item label="<?= \Yii::t('mall/index', '余额功能');?>" prop="status">
                                    <el-switch v-model="ruleForm.recharge.status"
                                               active-value="1" inactive-value="0"></el-switch>
                                </el-form-item>
                                <el-form-item label="<?= \Yii::t('mall/index', '余额支付密码开关');?>" prop="is_pay_password">
                                ...
                                <el-form-item v-if="ruleForm.recharge.is_pay_password == 1" label="修改余额密码客服" prop="list">
                                    <el-button size="mini" @click="addWechat"><?= \Yii::t('mall/index', '选择');?></el-button>
                                    <div flex="dir:left" style="flex-wrap:wrap">
                                        <div v-for="(value,index) in ruleForm.setting.customer_service_list" style="margin-right: 24px;margin-top: 12px">
                                            <div class="wechat-image" flex="dir:top"
                                                ...
                                                <el-tooltip class="v" effect="dark" :content="'<?= \Yii::t('mall/index', '微信号');?>'+ value.name" placement="top">
                                                    <div class="wechat-end-box"><?= \Yii::t('mall/index', '微信号');?>{{value.name}}</div>
                                                </el-tooltip>
                                    ...
                                    <div style="color:#909399"><?= \Yii::t('mall/index', '注意：最多允许上传10张，前端随机展示一张');?></div>
                                </el-form-item>
                            </div>

                            <div class="title">
                                <span><?= \Yii::t('mall/index', '会员等级设置');?></span>
                            </div>
                            <div class="form-body">
                                <el-form-item label="<?= \Yii::t('mall/index', '会员等级叠加');?>" prop="member_grade">
                                    <el-switch v-model="ruleForm.setting.member_grade"
                                               :active-value="1" :inactive-value="0"></el-switch>
                                </el-form-item>
                            </div>

                            <div class="title">
                                <span><?= \Yii::t('mall/index', '自定义设置');?></span>
                            </div>
                            <div flex style="background-color: #ffffff;padding: 20px 0;">
                                <div class="" style="width: 50%;">
                                    <el-form-item label="<?= \Yii::t('mall/index', '添加到我的小程序');?>" prop="is_add_app">
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('mall/index', '开关');?>" prop="is_add_app">
                                        <el-switch
                                    ...
                                    <template v-if="ruleForm.setting.is_add_app == 1">
                                        <el-form-item label="<?= \Yii::t('mall/index', '背影颜色');?>" prop="add_app_bg_color">
                                            <el-color-picker
                                                    color-format="hex"
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/index', '背影透明度');?>" prop="add_app_bg_transparency">
                                            <el-row>
                                                <el-col :span="16">
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/index', '背景框圆角');?>" prop="add_app_bg_radius">
                                            <el-row>
                                                <el-col :span="16">
                                        ...
                                        <el-form-item prop="add_app_text">
                                            <template slot='label'>
                                                <span><?= \Yii::t('mall/index', '提示文本内容');?></span>
                                                <el-tooltip effect="dark" placement="top">
                                                    <div slot="content"><?= \Yii::t('mall/index', '最多允许添加20个字');?></div>
                                                    <i class="el-icon-info"></i>
                                                </el-tooltip>
                                            </template>
                                            <el-input v-model="ruleForm.setting.add_app_text"></el-input>
                                        </el-form-item>
                                        <el-form-item label="<?= \Yii::t('mall/index', '文本颜色');?>" prop="add_app_text_color">
                                            <el-color-picker
                                                    color-format="hex"
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/index', '图标颜色');?>" prop="add_app_icon_color_type">
                                            <el-radio v-model="ruleForm.setting.add_app_icon_color_type" label="1"><?= \Yii::t('mall/index', '白色');?>
                                            </el-radio>
                                            <el-radio v-model="ruleForm.setting.add_app_icon_color_type" label="2"><?= \Yii::t('mall/index', '黑色');?>
                                            </el-radio>
                                        </el-form-item>
                                    </template>
                                </div>
                            ...
                            <div style="background-color: #ffffff;padding: 0 0 20px 0;">
                                <el-form-item prop="share_title" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '转发小程序');?></span>
                                    </template>
                                </el-form-item>

                                <el-form-item prop="share_title">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '转发标题');?></span>
                                    </template>
                                ...
                                <el-form-item prop="share_pic">
                                    <app-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                                                    @selected="sharePic">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:420 * 336"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                        </el-tooltip>
                                    </app-attachment>
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '首页购买记录框');?>" prop="is_purchase_frame" style="margin-top: 30px;padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                </el-form-item>
                                <el-form-item label="<?= \Yii::t('mall/index', '开关');?>" prop="is_purchase_frame">
                                ...
                                <el-form-item prop="purchase_num">
                                    <template slot='label'>
                                        <span><?= \Yii::t('mall/index', '轮播订单数');?></span>
                                        <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '轮播最新的N条订单');?>"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </template>
                ...
                <el-tab-pane label="<?= \Yii::t('mall/index', '显示设置');?>" name="second">
                    <el-tabs v-model="secondActiveName" @tab-click="secondHandleClick" style="margin-top: 10px;">
                        <el-tab-pane label="<?= \Yii::t('mall/index', '商品列表显示');?>" name="first">
                            <div class="form-body" style="padding: 40px;display: flex;">
                                <div class='left-setting-menu'>
                                    <el-form-item :class='active_setting == "is_show_cart" ? "active":""'
                                                  @click.native='chooseSetting("is_show_cart")' label="<?= \Yii::t('mall/index', '购物车');?>" prop="is_show_cart">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_show_sales_num" ? "active":""'
                                                  @click.native='chooseSetting("is_show_sales_num")' label="<?= \Yii::t('mall/index', '已售量');?>" prop="is_show_sales_num">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_show_goods_name" ? "active":""'
                                                  @click.native='chooseSetting("is_show_goods_name")' label="<?= \Yii::t('mall/index', '商品名称');?>" prop="is_show_goods_name">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_list_underline_price" ? "active":""'
                                                  @click.native='chooseSetting("is_list_underline_price")' label="<?= \Yii::t('mall/index', '划线价');?>" prop="is_list_underline_price">
                                        <el-switch
                        ...
                        <el-tab-pane label="<?= \Yii::t('mall/index', '商品详情显示');?>" name="second">
                            <div class="form-body" style="padding: 40px;display: flex;">
                                <div class='left-setting-menu'>
                                    <el-form-item :class='active_setting == "is_underline_price" ? "active":""'
                                                  @click.native='chooseSetting("is_underline_price")' label="<?= \Yii::t('mall/index', '划线价');?>" prop="is_underline_price">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_common_user_member_price" ? "active":""'
                                                  @click.native='chooseSetting("is_common_user_member_price")' label="<?= \Yii::t('mall/index', '普通用户会员价');?>"
                                    ...
                                    <el-form-item :class='active_setting == "is_member_user_member_price" ? "active":""'
                                                  @click.native='chooseSetting("is_member_user_member_price")' label="<?= \Yii::t('mall/index', '会员用户会员价');?>"
                                    ...
                                    <el-form-item v-if="is_svip" :class='active_setting == "is_show_normal_vip" ? "active":""' @click.native='chooseSetting("is_show_normal_vip")' prop="is_show_normal_vip">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '非SVIP用户超级会员价');?></span>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item v-if="is_svip" :class='active_setting == "is_show_super_vip" ? "active":""' @click.native='chooseSetting("is_show_super_vip")' prop="is_show_super_vip">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', 'SVIP用户超级会员价');?></span>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_express" ? "active":""'
                                                  @click.native='chooseSetting("is_express")' label="<?= \Yii::t('mall/index', '快递');?>" prop="is_express">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_sales" ? "active":""'
                                                  @click.native='chooseSetting("is_sales")' label="<?= \Yii::t('mall/index', '已售量');?>" prop="is_sales">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_share_price" ? "active":""'
                                                  @click.native='chooseSetting("is_share_price")' label="<?= \Yii::t('mall/index', '分销价');?>"
                                                  prop="is_share_price">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_goods_video" ? "active":""'
                                                  @click.native='chooseSetting("is_goods_video")' label="<?= \Yii::t('mall/index', '商品视频特色样式开关');?>"
                                                  prop="is_goods_video">
                                        <el-switch
                        ...
                        <el-tab-pane label="<?= \Yii::t('mall/index', '其他显示');?>" name="third">
                            <div class="form-body" style="padding: 40px;display: flex;">
                                <div class='left-setting-menu'>
                                    <el-form-item :class='active_setting == "is_must_login" ? "active":""'
                                                  @click.native='chooseSetting("is_must_login")' label="<?= \Yii::t('mall/index', '强制授权开关');?>"
                                                  prop="is_must_login">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_not_share_show" ? "active":""'
                                        ...
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '非分销商分销中心显示');?></span>
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '仅控制用户中心显示');?>"
                                                        placement="top">
                                                <i class="el-icon-info"></i>
                                            </el-tooltip>
                                        </template>
                                    ...
                                    <el-form-item :class='active_setting == "is_mobile_auth" ? "active":""'
                                                  @click.native='chooseSetting("is_mobile_auth")' label="<?= \Yii::t('mall/index', '登陆授权手机号');?>"
                                                  prop="is_mobile_auth">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_manual_mobile_auth" ? "active":""'
                                        ...
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '手动授权手机号');?></span>
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '开启后,绑定手机号页面会显示手机号手动授权');?>"
                                                        placement="top">
                                                <i class="el-icon-info"></i>
                                            </el-tooltip>
                                        </template>
                                    ...
                                    <el-form-item :class='active_setting == "is_official_account" ? "active":""'
                                        ...
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '关联公众号组件');?></span>
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '注意：该功能需要 ->微信小程序后台->设置->接口设置 开启并设置关联(同一主体下)的公众号');?>" placement="top">
                                                <i class="el-icon-info"></i>
                                            </el-tooltip>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_icon_members_grade" ? "active":""' @click.native='chooseSetting("is_icon_members_grade")' prop="is_icon_members_grade">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '会员等级标识');?></span>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item v-if="is_svip" :class='active_setting == "is_icon_super_vip" ? "active":""' @click.native='chooseSetting("is_icon_super_vip")' prop="is_icon_super_vip">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '超级会员标识');?></span>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_required_position" ? "active":""' @click.native='chooseSetting("is_required_position")' prop="is_required_position">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '定位地址是否必填');?></span>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_share_tip" ? "active":""' @click.native='chooseSetting("is_share_tip")' prop="is_share_tip">
                                        <template slot='label'>
                                            <span><?= \Yii::t('mall/index', '申请分销商提示弹窗');?></span>
                                        </template>
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_comment" ? "active":""'
                                                  @click.native='chooseSetting("is_comment")' label="<?= \Yii::t('mall/index', '商城评论');?>" prop="is_comment">
                                        <el-switch
                                    ...
                                    <el-form-item :class='active_setting == "is_show_hot_goods" ? "active":""'
                                                  @click.native='chooseSetting("is_show_hot_goods")' label="<?= \Yii::t('mall/index', '热搜显示开关');?>" prop="is_show_hot_goods">
                                        <el-switch
                                ...
                                <div style='background-color: #F3F5F6;padding: 30px 30px 30px 0;border-radius: 10px;' v-if="active_setting == 'is_mobile_auth' || active_setting == 'is_manual_mobile_auth'">
                                    <el-card shadow="never">
                                        ...
                                        <div>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            自8月26日起，使用小程序的手机号快速验证组件/手机号实时验证组件将需要付费使用。
                                            <span style="color: red;">标准单价为：每次组件调用成功，收费0.03元/0.04元</span>。
                                            更多套餐价格请见
                                            <el-button type="text" @click="$navigate('https://mp.weixin.qq.com/cgi-bin/loginpage?redirect_url=/wxamp/wxacharge', true)">微信公众平台-付费管理</el-button>，
                                            <el-button type="text" @click="$navigate('https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/paymentManage.html', true)">购买操作指引</el-button>。
                                        </div>
                                        <br>
                                        <div style="color: red;">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            若余额不足则用户将无法进行手机号授权登录，但微信授权仍可以正常登录。
                                        </div>
                                        <br>
                                        <div>
                                            <div>手机号快速验证组件与手机号实时验证组件的区别：</div>
                                            <div>
                                                <span>&nbsp;&nbsp;&nbsp;· 手机号实时验证组件，<span style="color: red;">在每次请求时，平台均会对用户选择的手机号进行实时验证</span>；</span>
                                                <br>
                                                <span>&nbsp;&nbsp;&nbsp;· 手机号快速验证组件，<span style="color: red;">平台会对号码进行验证，但不保证是实时验证</span> 。</span>
                                            </div>
                                        </div>
                                        <br>
                                        <div>
                                            <div>符合以下情况之一的小程序，使用此能力不收费，具体如下：</div>
                                            <div>
                                                <span>&nbsp;&nbsp;&nbsp;· 账号微信认证主体类型为政府、非营利组织的小程序；</span>
                                                <br>
                                                <span>&nbsp;&nbsp;&nbsp;· 账号微信认证主体类型为事业单位，且类目为政务民生的小程序；</span>
                                                <br>
                                                <span>&nbsp;&nbsp;&nbsp;· 账号类目为公立医疗机构、学历教育（学校）的小程序。</span>
                                            </div>
                                        </div>
                                    </el-card>
                                </div>
                ...
                <el-tab-pane label="<?= \Yii::t('mall/index', '悬浮按钮设置');?>" name="third">
                    <el-row>
                        <el-col :span="24">
                            <div class="title">
                                <span><?= \Yii::t('mall/index', '悬浮窗设置');?></span>
                            </div>
                            <div class="form-body">
                                <el-form-item label="<?= \Yii::t('mall/index', '启用悬浮按钮');?>">
                                    <el-switch
                                ...
                                <el-form-item v-if="ruleForm.setting.is_quick_navigation == '1'" label="<?= \Yii::t('mall/index', '悬浮按钮样式');?>"
                                              prop="quick_navigation_style">
                                    <el-radio v-model="ruleForm.setting.quick_navigation_style" label="1"><?= \Yii::t('mall/index', '展开收起');?>
                                    </el-radio>
                                    <el-radio v-model="ruleForm.setting.quick_navigation_style" label="2"><?= \Yii::t('mall/index', '固定展开');?>
                                    </el-radio>
                                </el-form-item>
                                <el-form-item v-if="ruleForm.setting.is_quick_navigation == '1'" label="<?= \Yii::t('mall/index', '展开图标');?>">
                                    <app-attachment :multiple="false" :max="1" @selected="quickNavigationOpenedPic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                        </el-tooltip>
                                    </app-attachment>
                                    <el-button size="mini" @click="resetImg('quick_navigation_opened_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                                               :src="ruleForm.setting.quick_navigation_opened_pic">
                                    </app-image>
                                </el-form-item>
                                <el-form-item v-if="ruleForm.setting.is_quick_navigation == '1'" label="<?= \Yii::t('mall/index', '收起图标');?>">
                                    <app-attachment :multiple="false" :max="1" @selected="quickNavigationClosedPic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('quick_navigation_closed_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'" style="background-color: #ffffff;padding: 0 0 20px 0;">
                                <el-form-item label="<?= \Yii::t('mall/index', '在线客服开关');?>" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <el-switch
                                ...
                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="customerServicesPic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('customer_services_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                <el-form-item label="<?= \Yii::t('mall/index', '返回首页导航开关');?>" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <el-switch
                                ...
                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="quickHomePic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('quick_home_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                <el-form-item label="<?= \Yii::t('mall/index', '一键拨号开关');?>" prop="is_dial" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <el-switch
                                ...
                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="dialPic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('dial_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                <el-form-item label="<?= \Yii::t('mall/index', '客服外链开关');?>" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <el-switch
                                ...
                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="webServicePic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('web_service_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                <el-form-item label="<?= \Yii::t('mall/index', '快捷导航开关');?>" prop="is_quick_map" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <el-switch
                                ...
                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="quickMapPic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('quick_map_pic')" class="reset" type="primary"><?= \Yii::t('mall/index', '恢复默认');?></el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                <el-form-item label="<?= \Yii::t('mall/index', '跳转小程序开关');?>" prop="is_small_app" style="padding-top: 20px;border-top: 1px solid #F3F3F3;">
                                    <el-switch
                                ...
                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="smallAppPic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                    ...
                                    <el-button size="mini" @click="resetImg('small_app_pic')" class="reset"
                                               type="primary"><?= \Yii::t('mall/index', '恢复默认');?>
                                    </el-button>
                                    <app-image style="width: 80px; height: 80px;"
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                <el-form-item label="<?= \Yii::t('mall/index', '自定义按钮');?>" prop="is_quick_customize"
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '跳转链接');?>" prop="quick_customize_link_url">
                                    <el-input :disabled="true" size="small"
                                        ...
                                        <app-pick-link slot="append" @selected="selectQuickCustomize">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择链接');?></el-button>
                                        </app-pick-link>
                                    </el-input>
                                </el-form-item>

                                <el-form-item>
                                    <app-attachment :multiple="false" :max="1" @selected="quickCustomizePic" tag="quick_navigation">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:100 * 100"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                            ...
                            <div class="title">
                                <span><?= \Yii::t('mall/index', '悬浮按钮设置');?></span>
                                <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '用于商品列表页');?>"
                                            placement="top">
                                    <i class="el-icon-info"></i>
                                </el-tooltip>
                            </div>
                            <div class="form-body">
                                <el-form-item label="<?= \Yii::t('mall/index', '启用回到顶部悬浮按钮');?>" prop="is_show_score_top">
                                    <el-switch
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '启用购物车悬浮按钮');?>" prop="is_show_cart_fly">
                                    <el-switch
                            ...
                            <div class="title">
                                <span><?= \Yii::t('mall/index', '商品售罄图标设置');?></span>
                            </div>
                            <div class="form-body">
                                <el-form-item label="<?= \Yii::t('mall/index', '售罄图标显示开关');?>">
                                    <el-switch
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '是否使用默认图标');?>" v-if="ruleForm.setting.is_show_stock == '1'">
                                    <el-switch
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '商品图正常尺寸');?>" v-if="ruleForm.setting.is_show_stock == '1'">
                                    <app-attachment :multiple="false" :max="1" @selected="sellOutPic">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:702 * 702"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                        </el-tooltip>
                                    </app-attachment>
                                ...
                                <el-form-item label="<?= \Yii::t('mall/index', '商品图4:3尺寸');?>" v-if="ruleForm.setting.is_show_stock == '1'">
                                    <app-attachment :multiple="false" :max="1" @selected="sellOutOtherPic">
                                        <el-tooltip effect="dark"
                                                    content="<?= \Yii::t('mall/index', '建议尺寸');?>:702 * 468"
                                                    placement="top">
                                            <el-button size="mini"><?= \Yii::t('mall/index', '选择图标');?></el-button>
                                        </el-tooltip>
                                    </app-attachment>
        ...
        <!--客服微信-->
        <el-dialog title="<?= \Yii::t('mall/index', '客服微信');?>" :visible.sync="wechatVisible" width="30%" :close-on-click-modal="false">
            <el-form :model="wechatForm" label-width="150px" :rules="wechatRules" ref="wechatForm"
                     @submit.native.prevent>
                <el-form-item label="<?= \Yii::t('mall/index', '客服微信二维码');?>" prop="qrcode_url">
                    <div style="margin-bottom:10px;">
                        <app-attachment style="display:inline-block;margin-right: 10px" :multiple="false" :max="1"
                                        @selected="wechatSelect">
                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/index', '建议尺寸');?>:360 * 360" placement="top">
                                <el-button size="mini"><?= \Yii::t('mall/index', '选择文件');?></el-button>
                            </el-tooltip>
                        </app-attachment>
                    </div>
                    <div style="margin-right: 20px;display:inline-block;position: relative;cursor: move;">
                ...
                <el-form-item label="<?= \Yii::t('mall/index', '客服微信号');?>" prop="name">
                    <el-input size="small" v-model="wechatForm.name" maxlength="20" auto-complete="off"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="wechatVisible = false"><?= \Yii::t('mall/index', '取消');?></el-button>
                <el-button size="small" type="primary" @click.native="wechatSubmit"><?= \Yii::t('mall/index', '提交');?></el-button>
            </div>
        </el-dialog>
    </el-card>
</div>
        ...
        data() {
            let noPay = (rule, value, callback) => {
                ...
                if (!reg.test(this.ruleForm.setting.over_time) && this.ruleForm.setting.over_time != 0) {
                    callback(new Error('<?= \Yii::t('mall/index', '未支付订单超时时间必须为整数');?>'))
                } else if (this.ruleForm.setting.over_time > 100) {
                    callback(new Error('<?= \Yii::t('mall/index', '未支付订单超时时间不能大于100');?>'))
                } else {
                    callback()
                }
            };
            let after_sale = (rule, value, callback) => {
                ...
                if (!reg.test(this.ruleForm.setting.after_sale_time) && this.ruleForm.setting.after_sale_time != 0) {
                    callback(new Error('<?= \Yii::t('mall/index', '售后时间时间必须为整数');?>'))
                } else if (this.ruleForm.setting.after_sale_time > 30) {
                    callback(new Error('<?= \Yii::t('mall/index', '售后时间不能大于30天');?>'))
                } else {
                    callback()
                }
            };
            let delivery = (rule, value, callback) => {
                ...
                if (!reg.test(this.ruleForm.setting.delivery_time) && this.ruleForm.setting.delivery_time != 0) {
                    callback(new Error('<?= \Yii::t('mall/index', '收货时间必须为整数');?>'))
                } else if (this.ruleForm.setting.delivery_time > 30) {
                    callback(new Error('<?= \Yii::t('mall/index', '收货时间不能大于30天');?>'))
                } else {
                    callback()
                }
            };
            let integral = (rule, value, callback) => {
                ...
                if (!reg.test(this.ruleForm.setting.member_integral) && this.ruleForm.setting.member_integral != 0) {
                    callback(new Error('<?= \Yii::t('mall/index', '用户积分必须为整数');?>'))
                } else {
                    callback()
                }
            };
            let purchase = (rule, value, callback) => {
                if (this.ruleForm.setting.purchase_num > 50 || this.ruleForm.setting.purchase_num < 0) {
                    callback(new Error('<?= \Yii::t('mall/index', '轮播订单数范围为');?>0-50'))
                } else {
                    callback()
                }
            };
            ...
            return {
                ...
                wechatRules: {
                    qrcode_url: [
                        {required: true, message: '<?= \Yii::t('mall/index', '图片不能为空');?>', trigger: 'blur'},
                    ]
                },
                index: -1,
                loading: false,
                ...
                rules: {
                    name: [
                        {required: true, message: '<?= \Yii::t('mall/index', '请填写商城名称');?>'},
                        {max: 64, message: '<?= \Yii::t('mall/index', '最多64个字');?>'},
                    ],
                    contact_tel: [
            ...
            send_type_list() {
                ...
                for (let i in this.ruleForm.setting.send_type) {
                    if (this.ruleForm.setting.send_type[i] == 'express') {
                        list.push('<?= \Yii::t('mall/index', '快递配送');?>');
                    }
                    if (this.ruleForm.setting.send_type[i] == 'offline') {
                        list.push('<?= \Yii::t('mall/index', '到店自提');?>');
                    }
                    if (this.ruleForm.setting.send_type[i] == 'city') {
                        list.push('<?= \Yii::t('mall/index', '同城配送');?>');
                    }
                }
                return list;
            }
