...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 0 0;" v-loading="listLoading">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="<?= \Yii::t('mall/share', '分销申请');?>" name="five">
                <div style="display: flex;">
                                    ...
                                    <div v-if="apply">
                                        ...
                                        <div style="background:#FFFFFF;height:40px;padding:0 14px">
                                            <div flex="cross:center"
                                                ...
                                                <span><?= \Yii::t('mall/share', '欢迎加入');?></span>
                                                <span style="color:#ff4544"><?= \Yii::t('mall/share', 'XX商城');?></span>
                                                <span><?= \Yii::t('mall/share', 'a3725');?></span>
                                            </div>
                                        </div>
                                        <div class="apply-form">
                                            <div flex="dir:left cross:center" class="apply-form-info">
                                                <div style="width: 100px"><?= \Yii::t('mall/share', '邀请人');?></div>
                                                <div style="color:#ff4544"><?= \Yii::t('mall/share', '雪人');?></div>
                                                <div>(<?= \Yii::t('mall/share', '请核对');?>)</div>
                                            </div>
                                        </div>
                                        <div class="apply-form">
                                            <div flex="dir:left cross:center" class="apply-form-info">
                                                <div class="apply-after" style="width: 100px"><?= \Yii::t('mall/share', '姓名');?></div>
                                                <div style="color:#CCCCCC"><?= \Yii::t('mall/share', '请填写真实姓名');?></div>
                                            </div>
                                        </div>
                                        <div class="apply-form">
                                            <div flex="dir:left cross:center" class="apply-form-info">
                                                <div class="apply-after" style="width: 100px"><?= \Yii::t('mall/share', '手机号码');?></div>
                                                <div style="color:#CCCCCC"><?= \Yii::t('mall/share', '请填写手机号码');?></div>
                                            </div>
                                        </div>
                                        <div class="apply-form">
                                            <div flex="dir:left cross:center" class="apply-form-info"
                                                ...
                                                <div style="margin-left:10px"><?= \Yii::t('mall/share', '我已阅读并同意');?></div>
                    ...
                    <div style="width: 100%;">
                        <div class="title"><?= \Yii::t('mall/share', '图片');?></div>
                        <el-row class='form-body'>
                            <el-form :model="form" label-width="100px">
                                <el-form-item label="<?= \Yii::t('mall/share', '头部图片');?>" prop="apply_head_pic">
                                    <div style="margin-bottom:10px;">
                                        <app-attachment style="display:inline-block;margin-right: 10px"
                                                        :multiple="false"
                                                        :max="1" @selected="applyHeadSelect">
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/share', '建议尺寸');?>:750 * 300" placement="top">
                                                <el-button size="mini"><?= \Yii::t('mall/share', '选择文件');?></el-button>
                                            </el-tooltip>
                                        </app-attachment>
                                        <el-button type="primary" @click="applyHeadDefault" size="mini"><?= \Yii::t('mall/share', '恢复默认');?>
                                        </el-button>
                                    </div>
                                ...
                                <el-form-item label="<?= \Yii::t('mall/share', '底部图片');?>" prop="apply_end_pic">
                                    <div style="margin-bottom:10px;">
                                        <app-attachment style="display:inline-block;margin-right: 10px"
                                                        :multiple="false"
                                                        :max="1" @selected="applyEndSelect">
                                            <el-tooltip effect="dark" content="<?= \Yii::t('mall/share', '建议尺寸');?>:750 * ∞" placement="top">
                                                <el-button size="mini"><?= \Yii::t('mall/share', '选择文件');?></el-button>
                                            </el-tooltip>
                                        </app-attachment>
                                        <el-button type="primary" @click="applyEndDefault" size="mini"><?= \Yii::t('mall/share', '恢复默认');?>
                                        </el-button>
                                    </div>
                                    <div style="margin-right: 20px;display:inline-block;position: relative;cursor: move;">
                        ...
                        <div style="width: 100%;">
                            <div class="title"><?= \Yii::t('mall/share', '文字');?></div>
                            <div class='form-body'>
                        ...
                        <div style="width: 100%;">
                            <div class="title"><?= \Yii::t('mall/share', '按钮');?></div>
                            <div class='form-body'>
                                <el-form :model="form" label-width="100px">
                                    <el-form-item label="<?= \Yii::t('mall/share', '按钮圆角');?>" prop="apply_btn_round">
                                        <div flex="dir:left">
                                            ...
                                            <el-input-number v-model="apply.apply_btn_round" :min="0"
                                                             :max="40" label="<?= \Yii::t('mall/share', '描述文字');?>"></el-input-number>
                                            <div style="margin-left: 10px">px</div>
                                        </div>
                                    </el-form-item>
                                    <el-form-item label="<?= \Yii::t('mall/share', '按钮文本');?>" prop="apply_btn_title">
                                        <el-input class="text-input" v-model="apply.apply_btn_title"></el-input>
                                    </el-form-item>
                                    <div flex="dir:left">
                                        <el-form-item label="<?= \Yii::t('mall/share', '填充颜色');?>" prop="apply_btn_background">
                                        ...
                                        <el-form-item label="<?= \Yii::t('mall/share', '文本颜色');?>" prop="level">
                                            <div flex="dir:left cross:center">
                        ...
                        <el-button :loading="btnLoading" type="primary" class="button-item" @click="onSubmit"><?= \Yii::t('mall/share', '保存');?>
                        </el-button>
                    </div>
                </div>
            </el-tab-pane>
            <el-tab-pane label="<?= \Yii::t('mall/share', '分销中心');?>" name="first">
                <div style="display: flex;">
                    <div class="mobile">
                        <div class="screen">
                            <div class="top-bar" flex="main:center cross:center">
                                <div><?= \Yii::t('mall/share', '分销中心');?></div>
                            </div>
                            <div class="content">
                                <div v-if="words">
                                    <div class="content-block head-block">
                                        <div flex="dir:left cross:center" style="padding-bottom:10px;border-bottom:1px solid #FFFFFF">
                                            ...
                                            <div style="margin-left: 20px;color: #fff;">
                                                <div><?= \Yii::t('mall/share', '用户昵称');?></div>
                                                <div style="margin-top:10px">{{words.parent_name.name}}：<?= \Yii::t('mall/share', '用户昵称');?></div>
                                            </div>
                                        </div>
                                    ...
                                    <div flex="dir:left box:mean cross:center" style="background-color: #fff;margin-bottom: 8px;height:80px">
                                        <div class="text-center" style="border-right:1px solid #e2e2e2">
                                            ...
                                            <div>1000<?= \Yii::t('mall/share', '元');?></div>
                                        </div>
                    ...
                    <div style="width: 100%;">
                        <div class="title"><?= \Yii::t('mall/share', '栏目');?></div>
                        <el-row class='form-body'>
                        ...
                        <div style="width: 100%;">
                            ...
                            <el-button :loading="btnLoading" type="primary" class="button-item" @click="onSubmit"><?= \Yii::t('mall/share', '保存');?></el-button>
                        </div>
                    </div>
                </div>
            </el-tab-pane>
            <el-tab-pane label="<?= \Yii::t('mall/share', '分销佣金');?>" name="two">
                <div style="display: flex;">
                    <div class="mobile">
                        <div class="screen">
                            <div class="top-bar" flex="main:center cross:center">
                                <div><?= \Yii::t('mall/share', '分销佣金');?></div>
                            </div>
                            <div class="content" style="font-size:13pt">
                                ...
                                <div flex="dir:left cross:center" style="margin:10px 0;padding:0 12px;height:48px;background:#FFFFFF">
                                    ...
                                    <div style="margin-left: auto;">0<?= \Yii::t('mall/share', '元');?></div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div flex="dir:left cross:center" style="background:#FFFFFF;color:#666;height:80px;padding:0 12px;font-size:13pt;border-top:1px solid #e2e2e2;border-bottom:1px solid #e2e2e2">
                                        ...
                                        <div style="padding-left:20px;color: #cdcdcd;font-size:19pt">
                                            <?= \Yii::t('mall/share', '请输入');?>{{words.cash_money.name}}
                                        </div>
                                    </div>
                                    <div style="padding:10px 12px;color:#666;font-size:12pt" flex="dir:top main:center">
                                        <div><?= \Yii::t('mall/share', '说明');?> {{words.cash_money.name}}<?= \Yii::t('mall/share', '必须不能大于');?>￥80</div>
                                    ...
                                    <div flex="dir:left cross:center" style="margin-bottom:10px;padding-left:8px;padding-bottom:10px;background:#FFFFFF">
                                        ...
                                        <div flex="dir:left cross:center" style="margin-left:10px;padding:0 16px;height:34px;border:1px solid #e2e2e2;border-radius:19px">
                                            ...
                                            <div><?= \Yii::t('mall/share', '支付宝');?></div>
                                        </div>
                                    </div>
                                    <div flex="dir:left cross:center" style="background:#FFFFFF;height:44px;padding:0 12px">
                                        <div style="min-width:84px"><?= \Yii::t('mall/share', '微信号');?></div>
                                        <div style="color:#cdcdcd"><?= \Yii::t('mall/share', '请填写正确的微信号');?></div>
                                    </div>
                                    <div flex="dir:left cross:center" style="background:#FFFFFF;height:44px;padding:0 12px">
                                        <div style="min-width:84px"><?= \Yii::t('mall/share', '账号');?></div>
                                        <div style="color:#cdcdcd"><?= \Yii::t('mall/share', '请输入正确的账号');?></div>
                                    </div>
                                    <div flex="main:center" style="margin:20px auto;color:#fff;">
                                        <div flex="main:center" style="background-color:#ff4544;width:351px;border-radius:40px;height:40px;line-height:40px;">
                                            <?= \Yii::t('mall/share', '提交申请');?>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <el-tab-pane label="<?= \Yii::t('mall/share', '分销商');?>" name="four">
                <div style="display: flex;">
                    <div class="mobile">
                        <div class="screen">
                            <div class="top-bar" flex="main:center cross:center">
                                <div><?= \Yii::t('mall/share', '我的团队');?></div>
                            </div>
                            <div class="content">
                                ...
                                <div v-for="v in [1,2]" flex="dir:top" style="margin-bottom:10px">
                                    <div flex="dir:left cross:center" style="background:#FFFFFF;padding:10px;height:80px;">
                                        ...
                                        <div flex="dir:top main:center" style="width:100%;margin-left:12px;">
                                            <div flex="dir:left cross:center">
                                                <div style="font-size:13pt;"><?= \Yii::t('mall/share', '张三');?></div>
                                                <div style="margin-left:auto"><?= \Yii::t('mall/share', '推广20人');?></div>
                                            </div>
                                            <div style="color:#666666;padding-top:8px;"><?= \Yii::t('mall/share', '注册时间');?>2012-01-12</div>
                                        </div>
                                    </div>
                                    <div flex="dir:left cross:center" style="color:#666666;background:#FFFFFF;border-top:1px solid #e2e2e2;padding:0 12px;height:40px">
                                        <div><?= \Yii::t('mall/share', '消费200');?></div>
                                        <div style="margin-left:auto">2<?= \Yii::t('mall/share', '个订单');?></div>
                                    </div>
                                </div>
                                <div flex="dir:left main:center cross:center" style="margin:16px 0;color:#999999">
                                    <div flex="cross:center">
                                        ...
                                        <div style="margin:0 10px"><?= \Yii::t('mall/share', '没有更多了');?></div>
                                        <div style="height:1px;width:84px;background:#999999"></div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- 栏目编辑 -->
        <el-dialog title="<?= \Yii::t('mall/share', '栏目编辑');?>" :visible.sync="dialogMenus" width="30%">
            <el-form @submit.native.prevent :model="menusForm" label-width="80px" :rules="menusFormRules" ref="menusForm">
                <el-form-item label="<?= \Yii::t('mall/share', '名称');?>" prop="name">
                    <el-input v-model="menusForm.name"></el-input>
                </el-form-item>
                <el-form-item label="<?= \Yii::t('mall/share', '图标');?>" prop="icon">
                    <app-attachment :multiple="false" :max="1" @selected="menusPicUrl">
                        <el-tooltip class="item" effect="dark" content="<?= \Yii::t('mall/share', '建议尺寸');?>: 60*60" placement="top">
                            <el-button size="mini"><?= \Yii::t('mall/share', '选择文件');?></el-button>
                        </el-tooltip>
                    </app-attachment>
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="dialogMenus = false"><?= \Yii::t('mall/share', '取消');?></el-button>
                <el-button size="small" type="primary" @click="menusSubmit"><?= \Yii::t('mall/share', '提交');?></el-button>
            </div>
        </el-dialog>
    </el-card>
</div>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                menusFormRules: {
                    name: [
                        { required: true, message: '<?= \Yii::t('mall/share', '名称不能为空');?>', trigger: 'blur' },
                    ],
                    icon: [
                        { required: true, message: '<?= \Yii::t('mall/share', '图标不能为空');?>', trigger: 'blur' },
                    ],
                },
                //文字修改
                wordsForm: [],
