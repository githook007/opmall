...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)"><?= \Yii::t('mall/step_statistic', '步数挑战');?></app-header>
        </div>
        <div class="table-body" style="display:flex;justify-content: space-between;align-items: center;padding-right: 20px">
            <app-search
                    ...
                    placeholder="<?= \Yii::t('mall/step_statistic', '请输入活动名称搜索');?>"
        ...
        <div class="table-body" style="padding: 20px">
            <el-table v-loading="loading" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                <el-table-column width="160" prop="begin_at" label="<?= \Yii::t('mall/step_statistic', '活动日期');?>">
                </el-table-column>
                <el-table-column width="400" prop="title" label="<?= \Yii::t('mall/step_statistic', '活动名称');?>">
                </el-table-column>
                <el-table-column prop="step_num" label="<?= \Yii::t('mall/step_statistic', '挑战步数');?>">
                </el-table-column>
                <el-table-column prop="participate_num" label="<?= \Yii::t('mall/step_statistic', '报名人数');?>">
                </el-table-column>
                <el-table-column prop="success_num" label="<?= \Yii::t('mall/step_statistic', '挑战成功人数');?>">
                </el-table-column>
                <el-table-column prop="currency" label="<?= \Yii::t('mall/step_statistic', '奖金池总数');?>">
                </el-table-column>
                <el-table-column prop="put_currency" label="<?= \Yii::t('mall/step_statistic', '报名活力币消耗');?>">
                </el-table-column>
            </el-table>
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                url: 'mall/step-statistics/index',
                loading: false,
                // 今天
                today: '',
                // 七天前
