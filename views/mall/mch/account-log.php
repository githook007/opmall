    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <el-table :data="form" border style="width: 100%" v-loading="listLoading">
                ...
                <el-table-column label="<?= \Yii::t('mall/mch', '金额元');?>" width="150">
                ...
                <el-table-column prop="desc" label="<?= \Yii::t('mall/mch', '说明');?>"></el-table-column>
                <el-table-column prop="created_at" width="180" label="<?= \Yii::t('mall/mch', '创建时间');?>"></el-table-column>
            </el-table>
