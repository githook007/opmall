...
<div id="app" v-cloak>
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header"><?= \Yii::t('mall/mch', '基础设置');?></div>
        <el-form v-if="is_show" class="form-body" ref="form" :model="form" :rules="rule" label-width="160px" size="small">
            <el-row>
                <el-col :span="24">
                    ...
                    <el-form-item label="<?= \Yii::t('mall/mch', '客服外链开关');?>">
                        <el-switch
                    ...
                    <el-form-item label="<?= \Yii::t('mall/mch', '外链客服链接类型');?>" prop="web_service_type" v-if="form.is_web_service == '1'">
                        <el-radio v-model="form.web_service_type" :label="1"><?= \Yii::t('mall/mch', '其它客服');?>
                        </el-radio>
                        <el-radio v-model="form.web_service_type" :label="2"><?= \Yii::t('mall/mch', '企业微信客服');?>
                        </el-radio>
                    </el-form-item>
                    <el-form-item v-if="form.is_web_service == '1' && form.web_service_type == 2" label="<?= \Yii::t('mall/mch', '企业微信id');?>" prop="enterprise_wechat_id">
                        <el-input v-model="form.enterprise_wechat_id"></el-input>
                    </el-form-item>
                    <el-form-item label="<?= \Yii::t('mall/mch', '客服外链');?>" v-if="form.is_web_service == '1'"
                    ...
                    <el-form-item v-if="form.is_web_service == '1'">
                        <app-attachment :multiple="false" :max="1" v-model="form.web_service_pic">
                            <el-tooltip effect="dark"
                                        ...
                                        placement="top">
                                <el-button size="mini"><?= \Yii::t('mall/mch', '选择图标');?></el-button>
                            </el-tooltip>
                        </app-attachment>
        ...
        <el-button class="button-item" :loading="btnLoading" type="primary" @click="store('form')" size="small"><?= \Yii::t('mall/mch', '保存');?></el-button>
</div>
<script>
    const app = new Vue({
        el: '#app',
