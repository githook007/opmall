    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
            ...
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <span style="color: #409EFF;cursor: pointer"
                          @click="$navigate({r:'mall/data-statistics/index'})"><?= \Yii::t('mall/notice', '数据概况');?></span>
                </el-breadcrumb-item>
                <el-breadcrumb-item><?= \Yii::t('mall/notice', '公告');?></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div v-loading="listLoading">
            ...
            <div class="table-body" style="margin-top: 25px">
                <div class="notice-label"><?= \Yii::t('mall/notice', '历史记录');?></div>
                <div v-loading="hLoading">
                    <div v-for="(history, key) in list" :key="key" flex="dir:left cross:center"
                        ...
                        <el-button type="text" style="margin-left: 12px" @click="openDialog(history)"><?= \Yii::t('mall/notice', '查看详情');?></el-button>
        ...
        <el-dialog :visible.sync="dialogVisible" width="1240px" top="20vh">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button size="small" type="primary" @click="dialogVisible = false"><?= \Yii::t('mall/notice', '知道了');?></el-button>
            </span>
        </el-dialog>
    </el-card>
</div>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                options: {
                    '': '',
                    'update': '<?= \Yii::t('mall/notice', '更新公告');?>',
                    'important': '<?= \Yii::t('mall/notice', '重要通知');?>',
                    'urgent': '<?= \Yii::t('mall/notice', '紧急维护');?>',
                }
            };
        },
        computed: {
