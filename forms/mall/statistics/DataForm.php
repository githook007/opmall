...
//            ->leftJoin(['u' => User::tableName()], 'o.user_id = u.id')
    ...
    public function common_menus()
    {
        ...
        $commonMenus = [
            [
                'name' => \Yii::t('common', '添加商品'),
                'route' => 'mall/goods/edit',
                'pic_url' => 'statics/img/mall/statistic/function_icon.png'
            ],
            [
                'name' => \Yii::t('common', '店铺装修'),
        ...
        // TODO 常用功能  <@jayi>
        $menusCommon = MenusCommon::find()->where(['mall_id' => \Yii::$app->mall->id])->asArray()->orderBy('updated_at desc')->all();
        foreach ($menusCommon as $k => $v){
            $commonMenus[$k] = [
                'name' => $v['name'],
                'route' => $v['url'],
                'pic_url' => $v['icon'],
