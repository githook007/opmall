...
class MailSettingForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['send_mail', 'send_pwd', 'send_name', 'send_platform'], 'string'],
    ...
    public function save()
    {
        ...
        if ($this->status == 1) {
            if (!($this->send_platform && $this->send_mail && $this->send_pwd && $this->send_name && $this->receive_mail)) {
                return [
                    'code' => 1,
                    'msg' => '请填写信息'
                ];
        ...
        $this->send_platform = $this->send_platform ?: 'smtp.qq.com';
