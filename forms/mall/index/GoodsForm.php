...
class GoodsForm extends Model
{
    ...
    public $goods_coupon_usage_scenario;

    public function rules()
    {
        return [
            [['good_negotiable'], 'safe'],
            [['show_contact_type', 'is_remind_sell_time', 'goods_coupon_usage_scenario'], 'integer'],
    ...
    {
        $mall = new Mall();
        $setting = $mall->getMallSetting(array_keys($this->attributes));
        return [
            'code' => 0,
            'data' => [
                'detail' => $setting
