...
class LiveEditForm extends Model
{
    ...
    {
        return [
            [['name', 'cover_img', 'start_time', 'end_time', 'anchor_name', 'anchor_wechat', 'share_img', 'feeds_img', 'type', 'screen_type', 'close_like', 'close_goods', 'close_comment'], 'required'],
            [['name', 'cover_img', 'start_time', 'end_time', 'anchor_name', 'anchor_wechat', 'share_img', 'feeds_img'], 'string'],
    ...
    public function save()
    {
        ...
        try {
            ...
            $feedsImgId = (new CommonUpload())->uploadImage($accessToken, $this->feeds_img, 0.097);
            // 接口每天上限调用10000次
