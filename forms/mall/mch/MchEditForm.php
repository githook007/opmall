...
class MchEditForm extends Model
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $store->longitude = !empty($this->latitude_longitude[1]) ? $this->latitude_longitude[1] : '';
            $store->latitude = !empty($this->latitude_longitude[0]) ? $this->latitude_longitude[0] : '';
