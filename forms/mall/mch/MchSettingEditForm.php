...
class MchSettingEditForm extends Model
{
    ...
    public $enterprise_wechat_id; // @czs

    public function rules()
    {
        return [
            [['id', 'is_share', 'is_sms', 'is_mail', 'is_print', 'is_territorial_limitation', 'is_web_service', 'web_service_type'], 'integer'],
            [['is_share', 'is_sms', 'is_mail', 'is_print', 'is_territorial_limitation', 'send_type'], 'required'],
            [['web_service_url', 'web_service_pic', 'enterprise_wechat_id'], 'string']
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            $model->web_service_type = $this->web_service_type; // @czs
            $model->enterprise_wechat_id = $this->enterprise_wechat_id;
            $res = $model->save();
