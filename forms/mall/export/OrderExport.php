            ...
            try {
                ...
                if ($sign) {
                    ...
                    foreach ($item->detail as $index => $detailItem) {
                        ...
                        $costPrice = isset($goodsInfo['goods_attr']['cost_price']) ? $goodsInfo['goods_attr']['cost_price'] : $detailItem->goods->goodsWarehouse->cost_price;
                        $newArr['cost_price'] = (float)($costPrice * $detailItem->num);
                        $newArr['original_price'] = isset($goodsInfo['goods_attr']['original_price']) ? (float)$goodsInfo['goods_attr']['original_price']: 0;
                        $newArr['price'] = $detailItem->goods->price ?? 0;

                        $newArr['attr'] = rtrim($attr, ",");
