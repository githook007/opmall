...
class GeoTransUtil
{
    ...
    */
     ...
     * @return float [int|float]         [返回千米或公里值]
     * @version  1.0.0
     * @datetime 2017-10-23T09:33:58+0800
     * @author   Devil
     * @blog     http://gong.gg/
     */
    public static function get_distance($lng1, $lat1, $lng2, $lat2, int $len_type = 1, int $decimal = 2)
    {
     ...
     * @param $lng
     * @param $lat
     * @return array|int[] [array]                        [转换后的进维度]
     * @version  1.0.0
