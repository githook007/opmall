...
class DiyQuickNavForm extends Model
{
    public function getQuickNav()
    {
        ...
        // @czs
        if($mall['setting']['is_web_service'] == 1 && $mall['setting']['web_service_type'] == 1){
            $quickNav['web']['opened'] = 1;
        }else{
            $quickNav['web']['opened'] = 0;
        }
        $quickNav['web']['picUrl'] = $mall['setting']['web_service_pic'];
        $quickNav['web']['url'] = $mall['setting']['web_service_url'];
        if($mall['setting']['is_web_service'] == 1 && $mall['setting']['web_service_type'] == 2){
            $quickNav['qiwei']['opened'] = 1;
        }else{
            $quickNav['qiwei']['opened'] = 0;
        }
        $quickNav['qiwei']['picUrl'] = $mall['setting']['web_service_pic'];
        $quickNav['qiwei']['url'] = $mall['setting']['web_service_url'];
        $quickNav['qiwei']['id'] = $mall['setting']['enterprise_wechat_id'];
