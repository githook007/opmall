...
class CommonGoods extends Model
{
    ...
    public function getGoodsDetail($id, $hasGoodsWarehouse = true)
    {
        ...
        $detail['video_channel'] = \yii\helpers\BaseJson::decode($goods->video_channel) ?: new \stdClass();
        ...
        $detail['freight'] = $postageRule ?: ['id' => 0, 'name' => '默认运费'];
        ...
        $detail['shipping'] = $freeDeliveryRule ?: ['id' => 0, 'name' => '默认包邮规则'];
        ...
        $detail['param_content'] = \yii\helpers\BaseJson::decode($detail['param_content']) ?: [];
    ...
    public function getDistrictPrice($attr)
    {
        $minPrice = 0;
        $maxPrice = 0;
