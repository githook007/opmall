...
if (!function_exists('price_format')) {
    ...
    /**
     * @param $val
     * @param string $returnType float|string
     * @param int $decimals
     * @return float|string
     */
...
if (!function_exists('is_we7')) {
    ...
    function is_we7()
    {
        ...
        if (@file_exists($moduleFile)) {
            if (mb_stripos(__DIR__, 'addons') !== false && mb_stripos(__DIR__, 'op') !== false) {
                return true;
            }
            return false;
        } else {
    ...
    function is_we7_offline()
    {
        ...
        if (file_exists(__DIR__ . '/../module.php')) {
            if (mb_stripos(__DIR__, 'addons') !== false) {
                if (mb_stripos(__DIR__, 'op_offline') !== false) {
                    return true;
                }
            }
            return false;
...
if (!function_exists('cmd_exe')) {
    ...
    function cmd_exe($command, $input = null, $file = ''){
        ...
        $cmd = "cd ".\Yii::$app->basePath." && echo 'suc'";
        $cmd .= " && php yii {$command}";
